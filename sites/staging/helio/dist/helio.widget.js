"use strict";var HelioWidgetModule=(()=>{var he=Object.defineProperty,at=Object.defineProperties,ct=Object.getOwnPropertyDescriptor,lt=Object.getOwnPropertyDescriptors,dt=Object.getOwnPropertyNames,Oe=Object.getOwnPropertySymbols;var Te=Object.prototype.hasOwnProperty,pt=Object.prototype.propertyIsEnumerable;var Ae=(e,o,t)=>o in e?he(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,me=(e,o)=>{for(var t in o||(o={}))Te.call(o,t)&&Ae(e,t,o[t]);if(Oe)for(var t of Oe(o))pt.call(o,t)&&Ae(e,t,o[t]);return e},ue=(e,o)=>at(e,lt(o));var ht=(e,o)=>{for(var t in o)he(e,t,{get:o[t],enumerable:!0})},mt=(e,o,t,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of dt(o))!Te.call(e,n)&&n!==t&&he(e,n,{get:()=>o[n],enumerable:!(s=ct(o,n))||s.enumerable});return e};var ut=e=>mt(he({},"__esModule",{value:!0}),e);var No={};ht(No,{HelioWidget:()=>it});var xe={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},Xe={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},gt={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},$e={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},wt={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},xt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function ft(e){if(!e)return"Update time unavailable";try{let o=Math.round((Date.now()-new Date(e).getTime())/6e4);if(o<1)return"Updated just now";if(o<60)return`Updated ${o} min ago`;let t=Math.floor(o/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(o){return"Updated recently"}}function $t(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function ge(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e}}function fe(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e.slice(11,16)}}function ze(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function O(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function g(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Ne={G:["aurora","storm_risk"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},bt=2400;function Ke(){var e,o;try{let t=(o=(e=globalThis.location)==null?void 0:e.hostname)!=null?o:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function vt(e){let o=[],t=null;for(let s of e){let n=document.getElementById(s);n instanceof HTMLElement?(t||(t=n),o.push(n)):Ke()&&console.warn(`[Helio] Hero chip nav: missing element #${s}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let s of o)s.classList.add("section-flash"),window.setTimeout(()=>s.classList.remove("section-flash"),bt)}function Be(e){let o=e.trim();return o.toUpperCase().startsWith("X:")?o.slice(2).trim()||"\u2014":o||"\u2014"}function Se(e,o){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==o)return 0;let s=parseInt(t.slice(1),10);return!isFinite(s)||s<0?0:Math.min(5,s)}function Me(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function yt(e){var c,r,i;let o=e.trim().toUpperCase();if(o==="\u2014"||o===""||o==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=$e[o])!=null?c:"#a0b4b8",s={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},n={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(r=s[o])!=null?r:"#1e2830",borderColor:(i=n[o])!=null?i:"#3a4c52"}}function kt(e,o){var c,r,i,a,l,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",s={g:(c=o==null?void 0:o.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Be(t)},n=(r=e.hero)==null?void 0:r.scales;return n?{g:(i=n.g)!=null?i:s.g,r:(a=n.r)!=null?a:s.r,s:(l=n.s)!=null?l:s.s,x:Be((d=n.x)!=null?d:s.x)}:s}var _t=`
...
`,Pe=!1;function St(){if(Pe)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=_t,document.head.appendChild(e),Pe=!0}function Mt(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.length,n=o/s,c=e.map((r,i)=>{let a=Math.max(2,Math.min(t,r.kp/9*t)),l=t-a,d=i*n,p=r.kp>=6?"#e05c5c":r.kp>=5?"#e0a84a":r.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${l.toFixed(1)}" width="${(n-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${r.kp.toFixed(1)} \xB7 ${g(fe(r.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function De(e,o,t,s,n){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,r=Math.min(...e),i=Math.max(...e),a=i-r||1,l=u=>s-2-(u-r)/a*(s-4),d=e.map((u,h)=>`${(h/(e.length-1)*c).toFixed(1)},${l(u).toFixed(1)}`).join(" "),p="";if(n&&r<0&&i>0){let u=l(0);p=`<line x1="0" y1="${u.toFixed(1)}" x2="${c}" y2="${u.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let m=e.map((u,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${s}" fill="transparent"><title>${g(o[h]||"")} \xB7 ${u.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${s}" style="width:100%;height:${s}px;display:block" preserveAspectRatio="none">
    ${p}
    <polyline points="${d}" fill="none" stroke="${t}" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/>
    ${m}
  </svg>`}function Ct(e){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.map(d=>Math.max(-9,Math.min(-3,Math.log10(d.flux)))),n=Math.min(...s),r=Math.max(...s)-n||1,i=d=>t-2-(d-n)/r*(t-4),a=s.map((d,p)=>`${(p/(s.length-1)*o).toFixed(1)},${i(d).toFixed(1)}`).join(" "),l=e.map((d,p)=>{let m=p/(s.length-1)*o,u=d.flux>=1e-4?"X":d.flux>=1e-5?"M":d.flux>=1e-6?"C":d.flux>=1e-7?"B":"A";return`<rect x="${(m-4).toFixed(1)}" y="0" width="8" height="${t}" fill="transparent"><title>${g(fe(d.t_utc))} \xB7 ${u}-class (${d.flux.toExponential(2)})</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">
  ...
  </div>`}function Lt(e){var i,a;let o=(i=e.metrics.xray_class)!=null?i:"A",t=e.metrics.xray_flux_wm2,s=t!=null?t.toExponential(2)+" W/m\xB2":"\u2014",n=[{label:"A",color:"#888"},{label:"B",color:"#5cce8c"},{label:"C",color:"#aad47a"},{label:"M",color:"#e0a84a"},{label:"X",color:"#e05c5c"}],c=n.map(l=>{let d=l.label===o,p=d?'<div class="hw-xray-scale-marker"></div>':"";return`<div class="hw-xray-scale-band" style="background:${l.color}${d?"cc":"44"}">${p}</div>`}).join(""),r=n.map(l=>`<div class="hw-xray-scale-label" style="color:${l.label===o?"#c8d8dc":"#607880"}">${l.label}</div>`).join("");return`<div class="hw-kpi-popover">
    ${le("X-Ray \xB7 Current")}
    <div style="margin-bottom:8px">
      <div class="hw-xray-scale">${c}</div>
      <div class="hw-xray-scale-labels">${r}</div>
    </div>
    <div class="hw-kpi-hint">Class: <b style="color:${(a=$e[o])!=null?a:"#a0b4b8"}">${g(o)}-class</b> \xB7 ${g(s)}</div>
    <div class="hw-kpi-hint" style="margin-top:4px">Trend history: \u25B6 HISTORY</div>
  </div>`}function Ft(e){let a='<rect x="0" y="16" width="200" height="6" rx="3" fill="#1e2c30"/>',l=[-10,-5,5,10].map(C=>{let _=100+C/20*100;return`<line x1="${_.toFixed(1)}" y1="16" x2="${_.toFixed(1)}" y2="22" stroke="#2a3c42" stroke-width="1"/>`}).join(""),d='<line x1="100" y1="14" x2="100" y2="24" stroke="#3a4c52" stroke-width="1.5"/>';if(e==null)return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">${a}${l}${d}</svg>`;let p=e<=-10?"#e05c5c":e<=-5?"#e0a84a":e<0?"#d4b84a":e>=5?"#5cce8c":"#7acca8",m=Math.max(-20,Math.min(20,e)),u=100+m/20*100,h=3,w=m<0?u-h:100-h,v=Math.max(2*h,Math.abs(u-100)+2*h),$=`<rect x="${w.toFixed(1)}" y="16" width="${v.toFixed(1)}" height="6" rx="${h}" fill="${p}" opacity="0.82"/>`,x=5,f=15,b=f-x*1.1,y=`<polygon points="${u.toFixed(1)},${f.toFixed(1)} ${(u-x).toFixed(1)},${b.toFixed(1)} ${(u+x).toFixed(1)},${b.toFixed(1)}" fill="${p}"/>`,S=`<line x1="${u.toFixed(1)}" y1="${f.toFixed(1)}" x2="${u.toFixed(1)}" y2="${19 .toFixed(1)}" stroke="${p}" stroke-width="1" opacity="0.6"/>`,H=`<text x="${u.toFixed(1)}" y="31" text-anchor="middle" font-size="8" fill="${p}" font-weight="600">${e>=0?"+":""}${e.toFixed(1)}</text>`;return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">
    ${a}${l}${d}${$}${y}${S}${H}
  </svg>`}function Et(e){let o=e.metrics.imf_bz_nt,t=e.metrics.imf_bt_nt,s=o!=null?o<=-10?"#e05c5c":o<=-5?"#e0a84a":o>=5?"#5cce8c":"#a0b4b8":"#607880",n=o!=null?(o>=0?"+":"")+o.toFixed(1)+" nT":"\u2014",c=t!=null?t.toFixed(1)+" nT":"\u2014",r=be(e),i=o!=null&&o<-5?{msg:"Southward IMF \xB7 Aurora favorable",color:"#5cce8c"}:o!=null&&o<0?{msg:"Weakly southward \xB7 Conditions may improve",color:"#d4cc5c"}:{msg:"Northward IMF \xB7 Stable magnetosphere",color:"#96a8b8"};return`<div class="hw-kpi-popover">
    ...
    <div class="hw-kpi-stat-row">
      <div class="hw-kpi-stat">
        ...
        <span class="hw-kpi-stat-value" style="color:${s}">${g(n)}</span>
      </div>
      <div class="hw-kpi-stat">
    ...
    <div class="hw-kpi-hint" style="color:${i.color};font-weight:600;margin-bottom:0">${g(i.msg)}</div>
      ...
      ${H}
    </svg>`}else{let $=e.state==="storm"?16:e.state==="active"?26:38,x=155-$,f=e.state==="storm"?22:e.state==="active"?30:40,b=120-f,y=240,S=[`M ${x},60`,`C ${x-4},42 150,${f} 155,${f}`,`C 173,${f} ${y-5},${f+18} ${y},60`,`C ${y-5},${b-18} 173,${b} 155,${b}`,`C 150,${b} ${x-4},78 ${x},60`,"Z"].join(" "),k=`M ${x+2},60 C ${x+2},${60-$*.4} 152,54 150,60 C 152,66 ${x+2},${60+$*.4} ${x+2},60 Z`,H=r>700?"#e05c5c":r>500?"#e0a84a":r>350?"#d4c840":"#5cce8c",C=r>700?.4:r>500?.65:r>350?1.1:1.8,_=r>500?[10,24,40,57,74,90,106]:r>350?[14,34,57,82,104]:[20,50,82,108],L=16,z=22,Y=x-6,j=Math.ceil((Y-z)/L)+2,X=Array.from({length:j},(A,E)=>z-L+E*L),N=12,P=8,W=X.flatMap(A=>_.map(E=>`<path d="M ${A},${E} L ${A+N},${E} M ${A+P},${E-3} L ${A+N},${E} L ${A+P},${E+3}" stroke="${H}cc" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`)).join(""),M=`<g class="hw-wg-full" style="animation-duration:${C}s">${W}</g>`,R=o==null?"":o>0?'<path d="M 155,64 L 155,56 M 153,58 L 155,56 L 157,58" stroke="#5cce8c" stroke-width="1.3" fill="none" stroke-linecap="round"/>':'<path d="M 155,56 L 155,64 M 153,62 L 155,64 L 157,62" stroke="#e05c5c" stroke-width="1.3" fill="none" stroke-linecap="round"/>',V=o==null?"":`<text x="163" y="62" font-size="6" fill="${o>0?"#5cce8c":"#e05c5c"}" font-family="monospace">Bz${o>0?"\u2191":"\u2193"}</text>`;return ve("magnetosphere",{magnetInfo:e,bz:o,windKms:t,uid:n})}}function ve(e,o={}){var M,R,V,A,E,ee;let c=(M=o.uid)!=null?M:"hse",r=0,i=160,a=800,l=17,d=a-l,p=o.magnetInfo,m=(R=p==null?void 0:p.state)!=null?R:"stable",u=(V=p==null?void 0:p.color)!=null?V:"#e0a84a",w=a-(m==="storm"?55:m==="active"?80:110),v=m==="storm"?58:m==="active"?76:95,$=1120,x=20,f=[`M ${w},130`,`C ${w-8},${130-v*.55} ${a-18},${130-v} ${a},${130-v}`,`C ${a+120},${130-v} ${$-180},${130-x} ${$},${130-x}`,`L ${$},${130+x}`,`C ${$-180},${130+x} ${a+120},${130+v} ${a},${130+v}`,`C ${a-18},${130+v} ${w-8},${130+v*.55} ${w},130`,"Z"].join(" "),b=e==="magnetosphere",y=b?m==="storm"?"0.12":"0.08":"0.04",S=b?"0.75":"0.28",k=`<g id="${c}-base-sun">
    ...
    <path d="${f}" fill="${u}" fill-opacity="${y}"
    ...
    <line x1="${i}" y1="130" x2="${w}" y2="130"
  ...
  </g>`,z="";if(e==="magnetosphere"){let T=(A=o.windKms)!=null?A:0,D=T>500,B=T<350,F=(D?.5:B?1.4:.9)*1.3,K=T>700?"#e05c5c":T>500?"#e0a84a":T>350?"#d4c840":"#5cce8c",oe=i+8,te=w-14,I=8,G=6,U=(te-oe)/(I-1),se=260/(G+1),Z=38,ne=24,ye=2,ke=Array.from({length:I},(re,ie)=>{let q=oe+ie*U,pe=Array.from({length:G},(Fe,ae)=>{let Q=se*(ae+1);return`<path d="M ${q.toFixed(1)},${Q.toFixed(1)} L ${(q+Z).toFixed(1)},${Q.toFixed(1)} M ${(q+ne).toFixed(1)},${(Q-6).toFixed(1)} L ${(q+Z).toFixed(1)},${Q.toFixed(1)} L ${(q+ne).toFixed(1)},${(Q+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:ye},(Fe,ae)=>{let Q=-((I-ie)/I*F)-ae*F/ye;return`<g style="opacity:.12;animation:hw-arrow-chase ${F}s linear ${Q.toFixed(3)}s infinite">${pe}</g>`}).join("")}).join(""),J=(E=o.bz)!=null?E:null,de=J==null?"":(()=>{let re=J>0?"#5cce8c":"#e05c5c";return`${J>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
        ...
        fill="${re}" font-family="monospace">Bz${J>0?"\u2191":"\u2193"}</text>`})();z=`${ke}${de}`}let Y=`<g id="${c}-overlay-solar-wind">${z}</g>`,j="";if(e==="coronal_hole"&&o.hssState){let T=o.hssState,D=(ee=T.speed)!=null?ee:0,B=D>=420,F=T.color,K=B?"0.85":"0.25",oe=D>=500?"0.18":B?"0.10":"0.04",te=i+8,I=d-16,G=60,U=`${te},130 ${I},${130-G} ${I},${130+G}`,se=I+6,Z=`${se},120 ${se+18},130 ${se},140`;j=`
    <polygon points="${U}" fill="${F}" opacity="${oe}"/>
    <line x1="${te}" y1="130" x2="${I-5}" y2="130"
          stroke="${F}" stroke-width="3.5" stroke-dasharray="10 6"
          stroke-linecap="round" opacity="${K}"/>
    <polygon points="${Z}" fill="${F}" opacity="${B?"0.9":"0.25"}"/>`}let X=`<g id="${c}-overlay-coronal-hole">${j}</g>`,N="";if(e==="cme_cone"&&o.cmeState){let T=o.cmeState,D=i,B=d-10,F=B-D,K=U=>Math.tan(U*Math.PI/180),oe=Math.round(K(9)*F),te=Math.round(K(6)*F),I=Math.round(K(3)*F),G=U=>`${D},130 ${B},${130-U} ${B},${130+U}`;if(T.status!=="quiet"){let U=T.status==="impact"?"#e05c5c":"#d4cc5c";N=`
    <polygon points="${G(oe)}" fill="#253238" opacity="0.85"/>
    <polygon points="${G(te)}"   fill="#d4cc5c" opacity="0.14"/>
    ...
    <line x1="${D+14}" y1="130" x2="${d-14}" y2="130"
          stroke="#1e2c30" stroke-dasharray="7 5" stroke-width="2"/>`}let P=`<g id="${c}-overlay-cme-cone">${N}</g>`,W=`<g id="${c}-overlay-labels">
  ...
  </div>`}function qe(e,o,t){if(!e.length)return null;let s=(t%360+360)%360,n=-1,c=1/0,r=Math.cos(o*Math.PI/180);for(let i of e){let a=i.lat-o,l=(i.lon-s+180+360)%360-180,d=a*a+l*r*(l*r);d<c&&(c=d,n=i.prob)}return n>=0?n:null}function Qe(e){return`<svg viewBox="0 0 100 100" width="100%" height="100%"
    style="position:absolute;top:0;left:0;pointer-events:none">${['<text x="50" y="4"   font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">N</text>','<text x="96"  y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">W</text>','<text x="50" y="97"  font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">S</text>','<text x="4"   y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">E</text>'].join("")}</svg>`}function At(e,o){let t=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,s=null;o&&e.lat!=null&&e.lon!=null&&(s=qe(o.entries,e.lat,e.lon));let n=e.lat!=null&&e.lon!=null,c=s!=null?s>=30?"#5cce8c":s>=10?"#d4cc5c":"#9ab4bc":"#607880",r=s!=null?`${s}%`:o?"n/a":"\u2026",i=n?`
  ...
  </div>`}function Tt(e,o,t,s){switch(o){case"solar_wind":return Ht(e);case"xray":return Lt(e);case"imf_bz":return Et(e);case"aurora":return At(t,s);case"magnetosphere":return It(e);default:return""}}function zt(e,o){if(e.length<2)return"\u2192";let t=e[e.length-1],s=Math.max(0,e.length-4),n=e[s];if(!isFinite(t)||!isFinite(n))return"\u2192";let c=t-n;return c>o?"\u2191":c<-o?"\u2193":"\u2192"}var Nt={quiet:"171",active:"195",elevated:"284",storm:"304"};function Bt(e,o){var s,n,c;if(o==null)return(n=(s=e.summary)==null?void 0:s.status)!=null?n:"quiet";let t=parseInt(((c=o.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":o.kp>=4?"active":"quiet"}function Pt(e,o){var l,d;let t=(l=Nt[e])!=null?l:"171",s=`/assets/gifs/current_eit_${t}.gif`,n=no(s,o),c=io,r=(d=xe[e])!=null?d:xe.quiet,i=`${r.accent}44`,a=`0 0 10px ${r.accent}55,0 0 24px ${r.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
  ...
  </div>`}function Dt(e,o,t,s,n){var f,b,y;let{summary:c,metrics:r}=e,i=(f=xe[c.status])!=null?f:xe.quiet,a=t!=null?t.kp.toFixed(1):r.kp_latest!=null?r.kp_latest.toFixed(1):"\u2014",l=kt(e,t),p=[{key:"G",text:l.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:l.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:l.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${l.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(S=>{let k;return S.key==="G"?k=Me(Se(l.g,"G")):S.key==="R"?k=Me(Se(l.r,"R")):S.key==="S"?k=Me(Se(l.s,"S")):k=yt(l.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${k.color};background:${k.background};border-color:${k.borderColor}`}" data-hero-chip="${S.key}" title="${O(S.title)}" aria-label="${O(S.aria)}">${g(S.text)}</button>`}).join(""),m=zt(((b=r.kp_history_1h)!=null?b:[]).map(S=>S.kp),.5),u=(y=r.kp_latest)!=null?y:0,h=u>=5,w=h?`linear-gradient(160deg, #0d2a1a 0%, ${i.bg}22 75%)`:`${i.bg}18`,v=Bt(e,t),x=h?`
    ...
    <div class="hw-hero" style="background:${w}">
      <div class="hw-hero-main">
        <div class="hw-kp-col">
          ...
          <span class="hw-status-badge" style="background:${i.accent}22;color:${i.accent};display:block;text-align:center">${g(c.label)}</span>
      ...
      ${x}
    </div>`}function Gt(e){var d,p,m,u;let{metrics:o}=e,t=(d=o.kp_history_1h)!=null?d:[],s=(p=o.wind_history_1h)!=null?p:[],n=(m=o.bz_history_1h)!=null?m:[],c=(u=o.xray_history_1h)!=null?u:[],r=Mt(t),i=De(s.map(h=>{var w;return(w=h.kms)!=null?w:0}).filter(h=>h>0),s.map(h=>fe(h.t_utc)),"#5cce8c",28,!1),a=De(n.map(h=>h.bz),n.map(h=>fe(h.t_utc)),"#d4cc5c",28,!0),l=Ct(c);return`
    ...
    </div>`}function Yt(e){let o=ft(e.updated_utc);return`
    <div class="hw-header">
      <span class="hw-header-title">Space Weather</span>
      <span class="hw-freshness">${g(o)}</span>
    </div>`}function jt(e){return e.map((o,t)=>t===0?(o+e[1])/2:t===e.length-1?(e[t-1]+o)/2:(e[t-1]+o+e[t+1])/3)}function Wt(e){return e>=9?"G5":e>=8?"G4":e>=7?"G3":e>=6?"G2":e>=5?"G1":"G0"}function Ut(e){return e>=5?"good":e>=3?"possible":"none"}function Ve(e){return e>=9?40:e>=8?45:e>=7?50:e>=6?55:e>=5?60:null}function Xt(e){let o=e>=7?"high":e>=5?"moderate":e>=3?"low":"none",t=Ve(e),s=o==="none"?"No aurora expected at mid-latitudes":t!=null?`Aurora possible equatorward of ~${t}\xB0 lat`:"Minor aurora possible at high latitudes",n=e>=7?"moderate":e>=5?"low":"none",c=n==="none"?"No significant HF degradation expected":n==="low"?"Minor HF degradation at high latitudes":"Moderate HF degradation, possible blackouts at high latitudes",r=e>=8?"high":e>=6?"moderate":e>=4?"low":"none";return[{kind:"aurora",level:o,label:"Aurora",summary:s},{kind:"radio",level:n,label:"HF Radio",summary:c},{kind:"solar_activity",level:r,label:"Solar Activity",summary:r==="none"?"Quiet geomagnetic conditions expected":r==="low"?"Active geomagnetic conditions possible":r==="moderate"?"Minor to moderate storm conditions":"Major geomagnetic storm conditions"}]}function Kt(e,o){var p;if(o<=0)return null;let t=(p=e.metrics.kp_forecast_3h)!=null?p:[];if(!t.length)return null;let s=Date.now()+o*36e5,n=t[0],c=1/0;for(let m of t){let u=Math.abs(new Date(m.t_utc).getTime()-s);u<c&&(c=u,n=m)}let r=n.kp,i=Wt(r),a=Ut(r),l=Ve(r),d=Xt(r);return{offsetH:o,kp:r,gScale:i,auroraLabel:a,auroraMinLat:l,impacts:d}}function qt(e,o,t,s){var W;let{forecast:n,metrics:c}=e,{kp_max_next_24h:r,kp_max_at_utc:i,trend:a}=n,l=((W=c.kp_forecast_3h)!=null?W:[]).slice(0,16),d=l.length,p=d*3,m=p>0?`${(o/p*100).toFixed(0)}%`:"0%",u=o>0?`\u23F1 +${Math.round(o)}h`:"Timeline",h="Kp forecast unavailable";if(r!=null){let M=ge(i),R=a==="rising"?"rising":a==="falling"?"falling":"steady";h=`Peak Kp ${r.toFixed(1)} next 24h${M?` at ${M}`:""} \xB7 ${R}`}let w=l.length?ge(l[0].t_utc):null,v=w?`Forecast \xB7 Next step ${w}`:"Forecast";if(!l.length)return`
    <div class="hw-forecast">
      ...
      ${s?`<div class="hw-forecast-text">${g(h)}</div>`:""}
    </div>`;let $=320,x=38,f=14,b=x+f,y=$/d,S=M=>x-Math.max(2,Math.min(x-2,M/9*(x-2))),k="",H=l.map(M=>M.kp),C=jt(H);l.forEach((M,R)=>{let V=S(M.kp),A=x-V,E=R*y,ee=E+y/2,T=M.kp>=6?"#e05c5c":M.kp>=5?"#e0a84a":M.kp>=4?"#d4cc5c":"#5cce8c",D=`Kp ${M.kp.toFixed(1)} \xB7 ${ge(M.t_utc)}`;if(k+=`<rect x="${E.toFixed(1)}" y="${V.toFixed(1)}" width="${(y-1.5).toFixed(1)}" height="${A.toFixed(1)}" fill="${T}" fill-opacity="0.85" rx="1.5"/>`,k+=`<rect x="${E.toFixed(1)}" y="0" width="${y.toFixed(1)}" height="${x}" fill="transparent"><title>${O(D)}</title></rect>`,d<=8||R%2===0){let F=new Date(M.t_utc).getHours();k+=`<text x="${ee.toFixed(1)}" y="${(b-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${F.toString().padStart(2,"0")}</text>`}});let L=`<polyline points="${l.map((M,R)=>{let V=R*y+y/2,A=S(C[R]);return`${V.toFixed(1)},${A.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,z="";if(o>0&&d>0){let M=Math.min($-1,o/(d*3)*$);z=`
      <line x1="${M.toFixed(1)}" y1="0" x2="${M.toFixed(1)}" y2="${x}" stroke="rgba(255,255,255,0.75)" stroke-width="1.5" stroke-dasharray="3,2"/>
      <polygon points="${M.toFixed(1)},${x} ${(M-4).toFixed(1)},${(x-7).toFixed(1)} ${(M+4).toFixed(1)},${(x-7).toFixed(1)}" fill="rgba(255,255,255,0.75)"/>`}let Y=Math.round(p/4),j=Math.round(p/2),X=Math.round(p*3/4),N=`
    ...
    <div class="hw-forecast">
      ...
      ${N}`:""}
    </div>`}function Qt(e){let o=/([NS])(\d+)([EW])(\d+)/i.exec(e);return o?{lat:(o[1].toUpperCase()==="N"?1:-1)*parseInt(o[2],10),lon:(o[3].toUpperCase()==="E"?1:-1)*parseInt(o[4],10)}:null}var Ze=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function Vt(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function Zt(e,o,t){let s=o/2,n=s*.87,c=o*.03,r=o*.009,i=e.map(a=>{var $,x;let l=Qt(a.location);if(!l||Math.abs(l.lon)>88||a.location.includes("*"))return"";let d=Vt(a);if(!t.has(d))return"";let p=Ze.find(f=>f.id===d).color,m=l.lat*Math.PI/180,u=l.lon*Math.PI/180,h=(s+n*Math.cos(m)*Math.sin(u)).toFixed(1),w=(s-n*Math.sin(m)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
    ...
    <div class="hw-radio-meta">X-ray: <b style="color:${(p=$e[s])!=null?p:"#a0b4b8"}">${g(s)}-class</b> \xB7 ${g(c)}</div>
  </div>`}var lo={0:"Quiet",1:"Minor Storm",2:"Moderate Storm",3:"Strong Storm",4:"Severe Storm",5:"Extreme Storm"};function po(e){return e>=9?5:e>=8?4:e>=7?3:e>=6?2:e>=5?1:0}function ce(e,o){if(e<o-.7)return 0;if(e>o+1)return .9;let t=(e-(o-.7))/1.7;return Math.round(Math.pow(Math.max(0,t),.7)*90)/100}function ho(e){var l,d,p;let o=parseInt(((l=e.scales.g_scale)!=null?l:"G0").replace(/\D/g,""),10),t=Math.max(0,Math.min(5,Number.isFinite(o)?o:0)),s=(d=e.metrics.kp_forecast_3h)!=null?d:[],n=Date.now(),c=n+24*60*60*1e3,r=s.filter(m=>{let u=new Date(m.t_utc).getTime();return u>=n-3*60*60*1e3&&u<=c}),i=r.length===0?0:Math.max(...r.map(m=>m.kp)),a={G1:ce(i,5),G2:ce(i,6),G3:ce(i,7),G4:ce(i,8),G5:ce(i,9),max_expected:po(i)};return{now:{g_level:t,label:(p=lo[t])!=null?p:"Quiet"},forecast_24h:a}}function mo(e){if(!e||typeof e!="object")return null;let o=e,t=o.now,s=o.forecast_24h;if(!t||!s)return null;let n=typeof t.g_level=="number"?t.g_level:parseInt(String(t.g_level),10),c=typeof t.label=="string"?t.label:"Quiet";if(!Number.isFinite(n))return null;let r=l=>{let d=typeof l=="number"?l:parseFloat(String(l));return Number.isFinite(d)?Math.max(0,Math.min(1,d)):0},i=s.max_expected,a=typeof i=="number"&&Number.isFinite(i)?Math.max(0,Math.min(5,Math.round(i))):0;return{now:{g_level:Math.max(0,Math.min(5,Math.round(n))),label:c},forecast_24h:{G1:r(s.G1),G2:r(s.G2),G3:r(s.G3),G4:r(s.G4),G5:r(s.G5),max_expected:a}}}function et(e){let o=ho(e),t=mo(e.storm_risk);if(!t)return o;let s=e.storm_risk,n=s&&typeof s.forecast_24h=="object"&&s.forecast_24h!==null?s.forecast_24h:void 0,c=n==null?void 0:n.max_expected;return typeof c=="number"&&Number.isFinite(c)?t:ue(me({},t),{forecast_24h:ue(me({},t.forecast_24h),{max_expected:o.forecast_24h.max_expected})})}function uo(e){return e>=4?"#e05c5c":e>=3?"#e0a84a":e>=1?"#d4cc5c":"#607880"}var Ge={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function go(e){var l,d,p;let o=(l=e.metrics.kp_latest)!=null?l:0,t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,n=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,c=o>=5||n>=1,r=(p=e.metrics.kp_history_1h)!=null?p:[],i=0;if(r.length>=2&&(i=r[r.length-1].kp-r[r.length-2].kp),!c)return{active:!1,phase:"quiet",kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s};let a;return i>.3&&(t==null||t<-5)?a="rising":i<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s}}function wo(e){if(!e.active)return"";let o=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=o.findIndex(i=>i.key===e.phase),s=Ge[e.phase],n=o[t].label,c=o.map((i,a)=>{let l=a===t,d=a<t,p=Ge[i.key],m=l?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",u=l?" hw-spi-dot-active":"",h=l?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",w=a<o.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
  ...
  </div>`}function Ye(e,o,t){let s=Math.max(0,Math.min(5,Math.round(e))),n=(t==null?void 0:t.showDialCode)!==!1,c=70,r=76,i=48,l=i-9,d=Math.PI,p=y=>d*(1-y/5),m=p(s),u=(y,S)=>({x:c+S*Math.cos(y),y:r-S*Math.sin(y)}),h=(y,S,k)=>{let H=u(y,i),C=u(S,i),_=u(y,l),L=u(S,l);return`<path d="M ${_.x.toFixed(2)} ${_.y.toFixed(2)} L ${H.x.toFixed(2)} ${H.y.toFixed(2)} A ${i} ${i} 0 0 1 ${C.x.toFixed(2)} ${C.y.toFixed(2)} L ${L.x.toFixed(2)} ${L.y.toFixed(2)} A ${l} ${l} 0 0 0 ${_.x.toFixed(2)} ${_.y.toFixed(2)} Z" fill="${k}"/>`},w=y=>{let S=p(y),k=u(S,i+1),H=u(S,i-5);return`<line x1="${k.x.toFixed(2)}" y1="${k.y.toFixed(2)}" x2="${H.x.toFixed(2)}" y2="${H.y.toFixed(2)}" stroke="#2a3a40" stroke-width="1" stroke-linecap="round"/>`},v=u(m,i-2),$=`<line x1="${c}" y1="${r}" x2="${v.x.toFixed(2)}" y2="${v.y.toFixed(2)}" stroke="#c8d6dc" stroke-width="2" stroke-linecap="round"/>`,x=`<circle cx="${c}" cy="${r}" r="3.5" fill="#3a4c52" stroke="#1e2c30" stroke-width="1"/>`,f=h(p(0),p(2),"#3d8f62")+h(p(2),p(4),"#b8982a")+h(p(4),p(5),"#b04048"),b=[0,1,2,3,4,5].map(w).join("");return`<div class="hw-storm-risk-gauge" role="img" aria-label="${O(o)} G${s}">
    <svg viewBox="0 0 140 88" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="140" height="88" fill="none"/>
      <path d="M ${u(d,i).x.toFixed(2)} ${u(d,i).y.toFixed(2)} A ${i} ${i} 0 0 1 ${u(0,i).x.toFixed(2)} ${u(0,i).y.toFixed(2)}" fill="none" stroke="#1a2428" stroke-width="2" stroke-linecap="round"/>
      ${f}
      ${b}
      ${$}
      ${x}
  ...
  </div>`}var we={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},tt={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function fo(e){var C;let o=we,t=(C=tt[o.phase])!=null?C:"#96a8b8",s=o.phase.charAt(0).toUpperCase()+o.phase.slice(1),n=280,c=52,r=10,i=c-6,a=c-18,l=.5,d=.19,p=_=>Math.exp(-Math.pow((_-l)/d,2)/2),m=_=>r+_*(n-2*r),u=_=>i-p(_)*a,h=80,w=[];for(let _=0;_<=h;_++){let L=_/h;w.push(`${_===0?"M":"L"}${m(L).toFixed(1)},${u(L).toFixed(1)}`)}let v=Math.round(o.progress_0_1*h),$=[];for(let _=0;_<=v;_++){let L=_/h;$.push(`${_===0?"M":"L"}${m(L).toFixed(1)},${u(L).toFixed(1)}`)}let x=m(o.progress_0_1),f=[`M${r},${i}`,...$.slice(1),`L${x.toFixed(1)},${i} Z`],b=u(o.progress_0_1),y=5,S=`M${x.toFixed(1)},${b.toFixed(1)} L${(x-y).toFixed(1)},${(b-y*1.8).toFixed(1)} L${(x+y).toFixed(1)},${(b-y*1.8).toFixed(1)} Z`,k=i+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
    <div class="hw-sc-name">${g(o.cycle_name)}</div>
    ...
    <div class="hw-sc-footer">Phase: <b style="color:${t}">${g(s)}</b>${o.subtitle?` \xB7 ${g(o.subtitle)}`:""}</div>
  </div>`}function ot(e){var a,l,d,p,m;let o=(l=(a=e.coronal_hole)==null?void 0:a.estimated_speed_kms)!=null?l:e.metrics.solar_wind_kms,t=(d=e.coronal_hole)==null?void 0:d.status,s=o!=null?o:0,n=t!=null?t:s>=600?"strong":s>=500?"active":s>=420?"watch":"quiet",c={strong:"#e05c5c",active:"#e0a84a",watch:"#d4cc5c",quiet:"#5cce8c"},r={strong:"Strong",active:"Active",watch:"Watch",quiet:"None"},i={strong:"Strong high-speed stream",active:"High-speed stream active",watch:"Elevated solar wind",quiet:"Background solar wind"};return{status:n,color:c[n],label:r[n],desc:(m=(p=e.coronal_hole)==null?void 0:p.note)!=null?m:i[n],speed:o}}function $o(e,o){var l;let t=ot(e),s=(l=t.speed)!=null?l:0,n=t.speed!=null?`${Math.round(t.speed)} km/s`:"\u2014",c=o?" hw-impact-tip-open":"",r=s>=420,i=ve("coronal_hole",{hssState:t,uid:"hss"}),a=r?'<div class="hw-hss-meta" style="font-size:.72em">Elevated speed may indicate Earth-facing coronal hole stream</div>':'<div class="hw-hss-meta" style="font-size:.72em">Background solar wind \xB7 no HSS detected</div>';return`<div class="hw-impact-tip${c}">
    ${i}
    <div class="hw-hss-meta">Solar wind: <b style="color:${t.color}">${g(n)}</b> \xB7 ${g(t.desc)}</div>
    ${a}
  </div>`}function st(e){var n,c;let o=(n=e.scales.g_scale)!=null?n:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let r=(c=e.metrics.kp_forecast_3h)!=null?c:[],i=Date.now(),a=r.filter(l=>new Date(l.t_utc).getTime()<=i+3*60*60*1e3).sort((l,d)=>new Date(d.t_utc).getTime()-new Date(l.t_utc).getTime());a.length>0&&(s=a[0].kp)}return t>=2||s!=null&&s>=6?{level:2,color:"#e05c5c",label:"High",kp:s,gScale:o}:t>=1||s!=null&&s>=4?{level:1,color:"#d4cc5c",label:"Moderate",kp:s,gScale:o}:{level:0,color:"#5cce8c",label:"Low",kp:s,gScale:o}}function bo(e,o){let t=st(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(a=>{let l=a.l===t.level,d=l?`${a.color}2e`:"#1b2a2e",p=l?a.color:"#3d5058",m=l?`1px solid ${a.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${d};color:${p};border:${m}">${a.label}</div>`}).join(""),r=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Near-normal thermospheric density",1:"Elevated drag \u2014 minor orbit correction may be needed",2:"Strong thermospheric expansion \u2014 significant drag increase"};return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-satdrag-meta">${r} \xB7 ${g(t.gScale)} \xB7 ${i[t.level]}</div>
  </div>`}function nt(e){var l,d,p;let o=(l=e.scales.g_scale)!=null?l:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let m=(d=e.metrics.kp_forecast_3h)!=null?d:[],u=Date.now(),h=m.filter(w=>new Date(w.t_utc).getTime()<=u+3*60*60*1e3).sort((w,v)=>new Date(v.t_utc).getTime()-new Date(w.t_utc).getTime());h.length>0&&(s=h[0].kp)}let n=0;t>=2||s!=null&&s>=6?n=2:(t>=1||s!=null&&s>=4)&&(n=1);let c=parseInt(((p=e.scales.r_scale)!=null?p:"R0").slice(1),10),r=c>=2&&n<2;c>=2&&(n=Math.min(2,n+1));let i={0:"#5cce8c",1:"#d4cc5c",2:"#e05c5c"},a={0:"Low",1:"Moderate",2:"High"};return{level:n,color:i[n],label:a[n],kp:s,gScale:o,boostedByFlare:r}}function vo(e,o){var l;let t=nt(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(d=>{let p=d.l===t.level,m=p?`${d.color}2e`:"#1b2a2e",u=p?d.color:"#3d5058",h=p?`1px solid ${d.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${m};color:${u};border:${h}">${d.label}</div>`}).join(""),r=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Stable ionosphere \xB7 normal positioning accuracy",1:"Possible signal delay or scintillation",2:"Significant positioning errors \xB7 possible signal loss"},a=t.boostedByFlare?`<div class="hw-gnss-meta" style="font-size:.72em">Risk elevated by solar flare activity (R${parseInt(((l=e.scales.r_scale)!=null?l:"R0").slice(1),10)})</div>`:"";return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-gnss-meta">${r} \xB7 ${g(t.gScale)} \xB7 ${i[t.level]}</div>
    ${a}
  </div>`}function rt(e){var l,d;let o=(l=e.alerts_all)!=null?l:[],t=o.find(p=>p.kind==="cme_impact"),s=o.find(p=>p.kind==="cme_watch"),n=t!=null?t:s;if(!n)return{status:"quiet",color:"#5cce8c",label:"None",speed_kms:null,issued_utc:null,arrival_utc:null};let c=((d=n.raw_body)!=null?d:"").match(/Estimated Velocity[:\s]+(\d+)\s*km\/s/i),r=c?parseInt(c[1],10):null,i=null;if(r&&n.t_utc){let p=1496e5/r*1e3;i=new Date(new Date(n.t_utc).getTime()+p).toISOString().replace(".000Z","Z")}let a=t?"impact":"watch";return{status:a,color:a==="impact"?"#e05c5c":"#d4cc5c",label:a==="impact"?"Active":"Watch",speed_kms:r,issued_utc:n.t_utc,arrival_utc:i}}function yo(e,o){let t=rt(e),s=o?" hw-impact-tip-open":"",n="\u2014";if(t.arrival_utc){let a=new Date(t.arrival_utc),l=a.toLocaleString("en-US",{month:"short",timeZone:"UTC"}),d=a.getUTCDate(),p=String(a.getUTCHours()).padStart(2,"0"),m=String(a.getUTCMinutes()).padStart(2,"0");n=`~${l}\xA0${d}\xA0${p}:${m}\u202FUTC`}let c=t.speed_kms?`${t.speed_kms}\u202Fkm/s`:"\u2014",r=t.status!=="quiet"?`Velocity: <b style="color:#b4c6cc">${g(c)}</b>&ensp;Arrival: <b style="color:#b4c6cc">${g(n)}</b>`:"No Earth-directed CME in forecast window",i=ve("cme_cone",{cmeState:t,uid:"cme"});return`<div class="hw-impact-tip${s}">
    ${i}
    <div class="hw-cme-footer">${r}</div>
  </div>`}function Ce(e,o,t,s,n,c,r,i,a){let l=c.has(e),d=l?" hw-impact-open":"",p=l?" hw-impact-tip-open":"";return`<div class="hw-impact-row${d}" id="${e}" data-impact-row="${e}">
      <span class="hw-impact-caret">\u25B6</span>
      <span class="hw-impact-kind" style="color:${n}">${t}<span style="color:#b4c6cc">${g(o)}</span></span>
      <span class="hw-impact-badge" style="background:${n}22;color:${n}">${g(s)}</span>
      <div class="hw-impact-tip${p}">${Tt(r,e,i,a)}</div>
    </div>`}function ko(e,o){let t=e.find(c=>c.kind==="aurora");if(t)return t;let s=o.aurora_hint;return{kind:"aurora",level:s.aurora_label==="good"?"moderate":s.aurora_label==="possible"?"low":"none",label:"Aurora",summary:s.summary}}function _o(e,o,t,s){var x,f;let n=(x=Xe[e.level])!=null?x:"#666",c=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),r=(f=Le[e.kind])!=null?f:Je,i=e.level==="none"?"#606870":n,a=o.has("aurora"),l=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,m=null;t&&s.lat!=null&&s.lon!=null&&(m=qe(t.entries,s.lat,s.lon));let u=s.lat!=null&&s.lon!=null,h=m!=null?m>=30?"#5cce8c":m>=10?"#d4cc5c":"#9ab4bc":"#607880",w=m!=null?`${m}%`:t?"n/a":"\u2026",v=u?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
      <span>${s.locationName?g(s.locationName)+" \xB7 ":""}${s.lat.toFixed(1)}\xB0${s.lat>=0?"N":"S"} ${Math.abs(s.lon).toFixed(1)}\xB0${s.lon>=0?"E":"W"}</span>
    ...
    <span class="hw-impact-caret">\u25B6</span>
    <span class="hw-impact-kind" style="color:${i}">${r}<span style="color:#b4c6cc">${g(e.label)}</span></span>
    <span class="hw-impact-badge" style="background:${n}22;color:${n}">${g(c)}</span>
    ${$}
  </div>`}function je(e,o,t,s,n,c){var w,v;let r=(w=Xe[e.level])!=null?w:"#666",i=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Le[e.kind])!=null?v:Je,l=e.level==="none"?"#606870":r,d=e.kind==="solar_activity"?t:c,p=d?" hw-impact-open":"",m;if(e.kind==="solar_activity"){let $=t?" hw-solar-open":"",x=Ze.map(f=>{let b=s.has(f.id),y=b?f.color+"22":"transparent",S=b?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${y};opacity:${S}">${f.label}</button>`}).join("");m=`<div class="hw-solar-tip${$}">
      ...
      </div>`}else m=co(n,d);let u=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${O(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${u}>
    <span class="hw-impact-caret">\u25B6</span>
    <span class="hw-impact-kind" style="color:${l}">${a}<span style="color:#b4c6cc">${g(e.label)}</span></span>
    <span class="hw-impact-badge" style="background:${r}22;color:${r}">${g(i)}</span>
    ${m}
  </div>`}function So(e,o,t,s,n,c,r,i,a){var Q,Ee,Re,Ie;let l=(Ee=(Q=o==null?void 0:o.impacts)!=null?Q:e.observer_impacts)!=null?Ee:[],d=ko(l,e),p=_o(d,r,i,a),m=l.find(_e=>_e.kind==="radio"),u=l.find(_e=>_e.kind==="solar_activity"),h=m?je(m,t,n,c,e,r.has("radio")):"",w=u?je(u,t,n,c,e,!1):"",x=`
    <div class="hw-section-row" data-impacts-toggle>
      <span class="hw-section-caret">${s?"\u25BC":"\u25B6"}</span>
      <span class="hw-section-label" style="margin-bottom:0">Indicators (${oo})${o?'<span style="font-size:.65em;color:#7a9870;font-weight:normal;text-transform:none;letter-spacing:0"> \xB7 simulated</span>':""}</span>
    </div>`,{metrics:f}=e,b=f.xray_class,y=b?(Re=$e[b])!=null?Re:"#a0b4b8":"#607880",S=b?`${b}-class`:"\u2014",k=f.imf_bz_nt,H=k!=null?k<=-10?"#e05c5c":k<=-5?"#e0a84a":k>=5?"#5cce8c":"#a0b4b8":"#607880",C=k!=null?(k>=0?"+":"")+k.toFixed(1)+" nT":"\u2014",_=f.solar_wind_kms,L=_!=null?`${Math.round(_)} km/s`:"\u2014",z=_!=null?_>700?"#e05c5c":_>500?"#e0a84a":_>400?"#d4cc5c":"#5cce8c":"#607880",Y=Ce("xray","X-Ray",Jt,S,y,r,e,a,i),j=Ce("imf_bz","IMF Bz",eo,C,H,r,e,a,i),X=Ce("solar_wind","Solar Wind",to,L,z,r,e,a,i),N='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',P=r.has("geomag_storm"),W=et(e),M=uo(W.now.g_level),R=`G${W.now.g_level}`,A=`<div class="hw-impact-row${P?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      <span class="hw-impact-kind" style="color:${M}"><svg viewBox="0 0 13 13" width="13" height="13" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.3"><path d="M6.5 2 L6.5 5"/><path d="M6.5 5 Q2 5 2 8.5 Q2 11 6.5 11 Q11 11 11 8.5 Q11 5 6.5 5"/><path d="M4.5 7.5 Q6.5 6 8.5 7.5"/></svg><span style="color:#b4c6cc">Storm Risk</span></span>
      <span class="hw-impact-badge" style="background:${M}22;color:${M}">${R}</span>
      ${xo(e,P)}
    </div>`,E=r.has("solar_cycle"),ee=(Ie=tt[we.phase])!=null?Ie:"#96a8b8",T=we.phase.charAt(0).toUpperCase()+we.phase.slice(1),B=`<div class="hw-impact-row${E?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      <span class="hw-impact-badge" style="background:${ee}22;color:${ee}">${T}</span>
      ${fo(E)}
    </div>`,F=ot(e),K=r.has("hss"),te=`<div class="hw-impact-row${K?" hw-impact-open":""}" data-impact-row="hss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${$o(e,K)}
    </div>`,I=st(e),G=r.has("sat_drag"),se=`<div class="hw-impact-row${G?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${bo(e,G)}
    </div>`,Z=nt(e),ne=r.has("gnss"),ke=`<div class="hw-impact-row${ne?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${vo(e,ne)}
    </div>`,J=rt(e),de=r.has("cme_cone"),ie=`<div class="hw-impact-row${de?" hw-impact-open":""}" data-impact-row="cme_cone">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      <span class="hw-impact-badge" style="background:${J.color}22;color:${J.color}">${g(J.label)}</span>
      ${yo(e,de)}
...
${t.join(" \xB7 ")}`}function Eo(e,o,t){var a;let s=e.is_active?Ho:(a=Co[e.level])!=null?a:"#445c64",n=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",r=e.source==="NASA_DONKI"?"DONKI":"SWPC",i=n?`<div class="hw-tl-detail">${g(e.description)}${g(Fo(e))}</div>`:"";return`
    <div class="hw-tl-item" data-timeline-key="${O(e.event_time)}">
      ...
      <div class="hw-tl-body">
        ...
        <div class="hw-tl-title${e.is_active?" hw-tl-active":""}">
          ${Lo(e.event_type)} ${g(e.event_title)}
        </div>
        ${i}
      </div>
    </div>`}function Ro(e,o,t,s){var $,x;let n=($=e.timeline)!=null?$:[],c=Date.now(),r=new Date(c).toISOString().slice(0,10),i=new Date(c-864e5).toISOString().slice(0,10),a=new Date(c-1728e5).toISOString().slice(0,10),l=new Set([r,i,a]),d=n.filter(f=>{var b;return l.has(((b=f.event_time)!=null?b:"").slice(0,10))}).slice().reverse(),p=d.length,m=t?"\u25BC":"\u25B6",u=p>0?`Solar Activity Timeline (${p})`:"Solar Activity Timeline",h=`
    ...
    </div>`;if(!t||p===0)return`<div class="hw-timeline">${h}</div>`;let w=new Map;for(let f of d){let b=((x=f.event_time)!=null?x:"").slice(0,10);w.has(b)||w.set(b,[]),w.get(b).push(f)}let v=[...w.entries()].map(([f,b])=>{let S=new Date(f+"T12:00:00Z").toLocaleDateString("en-US",{month:"short",day:"numeric",timeZone:"UTC"}),k=s.has(f),H=k?"\u25B6":"\u25BC",C=k?`<span class="hw-tl-day-count">${b.length} events</span>`:"",_=`
      <div class="hw-tl-day-row" data-tl-day="${O(f)}">
        <span class="hw-section-caret">${H}</span>
        <span class="hw-tl-date">${S}</span>
        ${C}
      </div>`,L=k?"":b.map((z,Y)=>Eo(z,Y<b.length-1,o)).join("");return`<div class="hw-tl-group">${_}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Io(e,o,t){var l;let s=(l=e.alerts_all)!=null?l:[],n=s.length,c=o?"\u25BC":"\u25B6",r=n>0?`SWPC Alerts (${n})`:"SWPC Alerts",i=`
    ...
    </div>`;if(!o||n===0)return`<div class="hw-alerts">${i}${o&&n===0?'<div class="hw-empty-alerts">No significant recent SWPC alerts</div>':""}</div>`;let a=s.map(d=>Mo(d,d.dedupe_key===t)).join("");return`
    <div class="hw-alerts">
      ${i}
      ${a}
    </div>`}function Oo(e,o){var j,X,N;let t=e.cme_tracker;if(!t)return"";let s=(j=wt[t.impact_level])!=null?j:"#96a8b8",n=(X=xt[t.status])!=null?X:t.status,c=300,r=44,i=18,a=r/2,l=10,d=c-18,p=7,m=`<line x1="${i+l}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,u=`<circle cx="${i}" cy="${a}" r="${l}" fill="#f0c040" opacity="0.92"/>`,h=`
    <circle cx="${d}" cy="${a}" r="${p}" fill="#4a90c4" opacity="0.88"/>
    <circle cx="${d}" cy="${a}" r="2.5" fill="#fff" opacity="0.7"/>`,w=`<text x="${i}" y="${a+l+9}" text-anchor="middle" font-size="9" fill="#c8aa60">Sun</text>`,v=`<text x="${d}" y="${a+p+9}" text-anchor="middle" font-size="9" fill="#7ab0d4">Earth</text>`,$="";if(t.progress!=null){let P=i+l+4,W=d-p-4,M=P+t.progress*(W-P),R=5;t.status==="arrival_window"?$=`
        ...
        </g>`:$=`<circle cx="${M.toFixed(1)}" cy="${a}" r="${R}" fill="${s}" opacity="0.85"/>`}let x=`<svg class="hw-cme-svg" viewBox="0 0 ${c} ${r}" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
    ${m}
    ${u}${w}
    ${h}${v}
    ${$}
  </svg>`,f=ze(t.arrival_time_utc),b=ze(t.launch_time_utc),y=t.speed_kms!=null?`${Math.round(t.speed_kms)} km/s`:"\u2014",S=t.half_angle_deg!=null?`${t.half_angle_deg}\xB0`:"\u2014",k=(N=t.source_location)!=null?N:"\u2014",H=t.is_earth_direct?"Direct hit":"Glancing blow",C=t.progress!=null?`${Math.round(t.progress*100)}%`:"\u2014",_=`
    <div class="hw-cme-detail">
      <div class="hw-cme-stat-grid">
        ...
        <div class="hw-cme-stat">
          ...
          <span class="hw-cme-stat-value" style="color:${s}">${g(y)}</span>
        </div>
        <div class="hw-cme-stat">
          <span class="hw-cme-stat-label">Impact</span>
          <span class="hw-cme-stat-value" style="color:${s}">${g(t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1))}</span>
        </div>
        <div class="hw-cme-stat">
        ...
        <div class="hw-cme-stat">
          ...
          <span class="hw-cme-stat-value">${g(C)}</span>
        </div>
      </div>
      <div class="hw-cme-note">Half-angle: ${g(S)} \xB7 Source: ${g(k)} \xB7 ${g(H)} \xB7 Model: Enlil (NASA DONKI)</div>
    </div>`,L=o?"\u25BC":"\u25B6",z=t.impact_level==="unknown"?"Unrated":t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1),Y=o?`${x}${_}`:"";return`
    <div class="hw-cme">
      <div class="hw-cme-row" data-cme-toggle>
        ...
        <span class="hw-cme-badge" style="background:${s}22;color:${s};margin-left:auto">${g(n)}</span>
        <span class="hw-cme-badge" style="background:${s}15;color:${s};margin-left:4px">${g(z)} impact</span>
      </div>
      ${Y}
    </div>`}function Ao(e,o,t,s,n,c,r,i,a,l,d,p,m,u,h,w,v,$){var H;let x=Kt(e,s),f=(H=e.metrics.kp_history_1h)!=null?H:[],b=f.length?ge(f[f.length-1].t_utc):null,y=b?`Recent history \xB7 Last step ${b}`:"Recent history",S=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    <span class="hw-section-caret">${t?"\u25BC":"\u25B6"}</span>
    <span class="hw-section-label" style="margin-bottom:0">${O(y)}</span>
  </div></div>`,k=t?Gt(e):"";return`
    <div class="hw-root">
      ${Yt(e)}
      ${Dt(e,t,x,v,$)}
      ${So(e,x,m,l,u,h,w,$,v)}
      ...
      ${Ro(e,r,i,a)}
      ${Io(e,n,c)}
    </div>`}function To(e){return`<div class="hw-root">
