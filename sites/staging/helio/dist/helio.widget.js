"use strict";var HelioWidgetModule=(()=>{var de=Object.defineProperty,nt=Object.defineProperties,rt=Object.getOwnPropertyDescriptor,it=Object.getOwnPropertyDescriptors,at=Object.getOwnPropertyNames,He=Object.getOwnPropertySymbols;var Ee=Object.prototype.hasOwnProperty,ct=Object.prototype.propertyIsEnumerable;var Le=(e,o,t)=>o in e?de(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,pe=(e,o)=>{for(var t in o||(o={}))Ee.call(o,t)&&Le(e,t,o[t]);if(He)for(var t of He(o))ct.call(o,t)&&Le(e,t,o[t]);return e},he=(e,o)=>nt(e,it(o));var lt=(e,o)=>{for(var t in o)de(e,t,{get:o[t],enumerable:!0})},dt=(e,o,t,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let r of at(o))!Ee.call(e,r)&&r!==t&&de(e,r,{get:()=>o[r],enumerable:!(s=rt(o,r))||s.enumerable});return e};var pt=e=>dt(de({},"__esModule",{value:!0}),e);var Oo={};lt(Oo,{HelioWidget:()=>tt});var ue={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},Ge={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},ht={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},fe={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},mt={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},gt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function ut(e){if(!e)return"Update time unavailable";try{let o=Math.round((Date.now()-new Date(e).getTime())/6e4);if(o<1)return"Updated just now";if(o<60)return`Updated ${o} min ago`;let t=Math.floor(o/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(o){return"Updated recently"}}function wt(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function me(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e}}function we(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e.slice(11,16)}}function Fe(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function O(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function w(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Ie={G:["magnetosphere"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},xt=2400;function je(){var e,o;try{let t=(o=(e=globalThis.location)==null?void 0:e.hostname)!=null?o:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function ft(e){let o=[],t=null;for(let s of e){let r=document.getElementById(s);r instanceof HTMLElement?(t||(t=r),o.push(r)):je()&&console.warn(`[Helio] Hero chip nav: missing element #${s}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let s of o)s.classList.add("section-flash"),window.setTimeout(()=>s.classList.remove("section-flash"),xt)}function Re(e){let o=e.trim();return o.toUpperCase().startsWith("X:")?o.slice(2).trim()||"\u2014":o||"\u2014"}function ye(e,o){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==o)return 0;let s=parseInt(t.slice(1),10);return!isFinite(s)||s<0?0:Math.min(5,s)}function ke(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function $t(e){var c,n,i;let o=e.trim().toUpperCase();if(o==="\u2014"||o===""||o==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=fe[o])!=null?c:"#a0b4b8",s={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},r={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(n=s[o])!=null?n:"#1e2830",borderColor:(i=r[o])!=null?i:"#3a4c52"}}function bt(e,o){var c,n,i,a,l,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",s={g:(c=o==null?void 0:o.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Re(t)},r=(n=e.hero)==null?void 0:n.scales;return r?{g:(i=r.g)!=null?i:s.g,r:(a=r.r)!=null?a:s.r,s:(l=r.s)!=null?l:s.s,x:Re((d=r.x)!=null?d:s.x)}:s}var vt=`
...
`,Ae=!1;function yt(){if(Ae)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=vt,document.head.appendChild(e),Ae=!0}function kt(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.length,r=o/s,c=e.map((n,i)=>{let a=Math.max(2,Math.min(t,n.kp/9*t)),l=t-a,d=i*r,p=n.kp>=6?"#e05c5c":n.kp>=5?"#e0a84a":n.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${l.toFixed(1)}" width="${(r-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${n.kp.toFixed(1)} \xB7 ${w(we(n.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function Oe(e,o,t,s,r){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,n=Math.min(...e),i=Math.max(...e),a=i-n||1,l=m=>s-2-(m-n)/a*(s-4),d=e.map((m,h)=>`${(h/(e.length-1)*c).toFixed(1)},${l(m).toFixed(1)}`).join(" "),p="";if(r&&n<0&&i>0){let m=l(0);p=`<line x1="0" y1="${m.toFixed(1)}" x2="${c}" y2="${m.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let g=e.map((m,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${s}" fill="transparent"><title>${w(o[h]||"")} \xB7 ${m.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${s}" style="width:100%;height:${s}px;display:block" preserveAspectRatio="none">
    ${p}
    <polyline points="${d}" fill="none" stroke="${t}" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/>
    ${g}
  </svg>`}function _t(e){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.map(d=>Math.max(-9,Math.min(-3,Math.log10(d.flux)))),r=Math.min(...s),n=Math.max(...s)-r||1,i=d=>t-2-(d-r)/n*(t-4),a=s.map((d,p)=>`${(p/(s.length-1)*o).toFixed(1)},${i(d).toFixed(1)}`).join(" "),l=e.map((d,p)=>{let g=p/(s.length-1)*o,m=d.flux>=1e-4?"X":d.flux>=1e-5?"M":d.flux>=1e-6?"C":d.flux>=1e-7?"B":"A";return`<rect x="${(g-4).toFixed(1)}" y="0" width="8" height="${t}" fill="transparent"><title>${w(we(d.t_utc))} \xB7 ${m}-class (${d.flux.toExponential(2)})</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">
  ...
  </div>`}function St(e){var l;let o=(l=e.metrics.wind_history_1h)!=null?l:[],t=o[o.length-1],s=e.metrics.solar_wind_kms,r=s!=null?`${Math.round(s)} km/s`:"\u2014",c=s!=null?s>=700?"#e05c5c":s>=500?"#e0a84a":s>=400?"#d4cc5c":"#5cce8c":"#607880",n=(t==null?void 0:t.density)!=null?`${t.density.toFixed(2)} cm\u207B\xB3`:"\u2014",i=(t==null?void 0:t.temp_kk)!=null?`${t.temp_kk.toFixed(0)} kK`:"\u2014",a=(t==null?void 0:t.pressure_npa)!=null?`${t.pressure_npa.toFixed(2)} nPa`:"\u2014";return`<div class="hw-kpi-popover">
    ${ce("Solar Wind \xB7 Current")}
    <div class="hw-kpi-stat-row">
      <div class="hw-kpi-stat">
        <span class="hw-kpi-stat-label">Speed</span>
        <span class="hw-kpi-stat-value" style="color:${c}">${w(r)}</span>
      </div>
      <div class="hw-kpi-stat">
        <span class="hw-kpi-stat-label">Density</span>
        <span class="hw-kpi-stat-value">${w(n)}</span>
      </div>
      <div class="hw-kpi-stat">
    ...
    <div class="hw-kpi-stat-row">
      <div class="hw-kpi-stat">
        ...
        <span class="hw-kpi-stat-value" style="color:${s}">${w(r)}</span>
      </div>
      <div class="hw-kpi-stat">
      ...
      <div class="hw-kpi-stat">
        ...
        <span class="hw-kpi-stat-value" style="color:${n.color};font-weight:600">${w(n.coupling)}</span>
      </div>
    </div>
    <div class="hw-kpi-hint" style="color:${i.color};font-weight:600;margin-bottom:0">${w(i.msg)}</div>
  </div>`}function Me(e){var a,l;let o=e.metrics.imf_bz_nt,t=(a=e.metrics.kp_latest)!=null?a:0,s=(l=e.metrics.solar_wind_kms)!=null?l:0,r,c,n;if(o!=null&&o<-5||t>=6)r="storm",c="#e05c5c",n="Storm conditions";else if(o!=null&&o<0||t>=4||s>=400){let d=o!=null&&o<0;r="active",c="#e0a84a",n=d?"Active coupling":"Elevated"}else r="stable",c="#5cce8c",n="Stable";let i;return o==null?i="Unknown":o>2?i="Closed":o>0?i="Minimal":o>-5?i="Moderate":o>-10?i="Strong":i="Very strong",{state:r,color:c,label:n,coupling:i}}function Lt(e,o,t,s){let r=s?"mc":"mf",c=e.color,n=t!=null?t:0,i=n>500,a=n<350,l=i?.9:a?1.8:1.3;if(s){let h=45-(e.state==="storm"?11:e.state==="active"?16:21),x=e.state==="storm"?12:e.state==="active"?10:8,v=50-x,$=76,u=[`M ${h},25`,`C ${h-2},15 41,${x} 45,${x}`,`C 53,${x} ${$-8},${x+4} ${$},20`,`C ${$+1},23 ${$+1},27 ${$},30`,`C ${$-8},${v-4} 53,${v} 45,${v}`,`C 41,${v} ${h-2},35 ${h},25`,"Z"].join(" "),f=i?3:2,b=[14,25,36],y=C=>`<path d="M 0,${C} L ${i?8:6},${C} M ${i?6:4},${C-2} L ${i?8:6},${C} L ${i?6:4},${C+2}" stroke="${c}bb" stroke-width="${i?1.4:1}" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`,S=b.map(C=>y(C)).join(""),k=Array.from({length:f},(C,_)=>`<g class="hw-wg" style="animation-duration:${l}s;animation-delay:${(l/f*_).toFixed(2)}s">${S}</g>`).join(""),M=o==null?"":o>0?`<path d="M 45,27 L 45,23 M ${45-1.5},${25-.5} L 45,23 L ${45+1.5},${25-.5}" stroke="#5cce8c" stroke-width="1" fill="none" stroke-linecap="round"/>`:`<path d="M 45,23 L 45,27 M ${45-1.5},${25+.5} L 45,27 L ${45+1.5},${25+.5}" stroke="#e05c5c" stroke-width="1" fill="none" stroke-linecap="round"/>`;return`<svg viewBox="0 0 80 50" style="width:78px;height:49px;display:block" xmlns="http://www.w3.org/2000/svg">
      <defs><clipPath id="${r}-wclip"><rect x="0" y="0" width="26" height="50"/></clipPath></defs>
      <circle cx="2" cy="25" r="5" fill="#f0c040" opacity=".7"/>
      <g clip-path="url(#${r}-wclip)">${k}</g>
      <path d="${u}" fill="${c}14" stroke="${c}b0" stroke-width="0.9"/>
      <circle cx="45" cy="25" r="${4.5}" fill="#2a4a6a" stroke="#4a7090" stroke-width="0.8"/>
      ${M}
    </svg>`}else{let $=e.state==="storm"?16:e.state==="active"?26:38,u=155-$,f=e.state==="storm"?22:e.state==="active"?30:40,b=120-f,y=240,S=[`M ${u},60`,`C ${u-4},42 150,${f} 155,${f}`,`C 173,${f} ${y-5},${f+18} ${y},60`,`C ${y-5},${b-18} 173,${b} 155,${b}`,`C 150,${b} ${u-4},78 ${u},60`,"Z"].join(" "),k=`M ${u+2},60 C ${u+2},${60-$*.4} 152,54 150,60 C 152,66 ${u+2},${60+$*.4} ${u+2},60 Z`,M=n>700?"#e05c5c":n>500?"#e0a84a":n>350?"#d4c840":"#5cce8c",C=n>700?.4:n>500?.65:n>350?1.1:1.8,_=n>500?[10,24,40,57,74,90,106]:n>350?[14,34,57,82,104]:[20,50,82,108],L=16,I=22,N=u-6,P=Math.ceil((N-I)/L)+2,X=Array.from({length:P},(T,F)=>I-L+F*L),B=12,G=8,W=X.flatMap(T=>_.map(F=>`<path d="M ${T},${F} L ${T+B},${F} M ${T+G},${F-3} L ${T+B},${F} L ${T+G},${F+3}" stroke="${M}cc" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`)).join(""),H=`<g class="hw-wg-full" style="animation-duration:${C}s">${W}</g>`,R=o==null?"":o>0?'<path d="M 155,64 L 155,56 M 153,58 L 155,56 L 157,58" stroke="#5cce8c" stroke-width="1.3" fill="none" stroke-linecap="round"/>':'<path d="M 155,56 L 155,64 M 153,62 L 155,64 L 157,62" stroke="#e05c5c" stroke-width="1.3" fill="none" stroke-linecap="round"/>',q=o==null?"":`<text x="163" y="62" font-size="6" fill="${o>0?"#5cce8c":"#e05c5c"}" font-family="monospace">Bz${o>0?"\u2191":"\u2193"}</text>`;return Ye("magnetosphere",{magnetInfo:e,bz:o,windKms:t,uid:r})}}function Ye(e,o={}){var H,R,q,T,F,Z;let c=(H=o.uid)!=null?H:"hse",n=0,i=160,a=800,l=17,d=a-l,p=o.magnetInfo,g=(R=p==null?void 0:p.state)!=null?R:"stable",m=(q=p==null?void 0:p.color)!=null?q:"#e0a84a",x=a-(g==="storm"?55:g==="active"?80:110),v=g==="storm"?58:g==="active"?76:95,$=1120,u=20,f=[`M ${x},130`,`C ${x-8},${130-v*.55} ${a-18},${130-v} ${a},${130-v}`,`C ${a+120},${130-v} ${$-180},${130-u} ${$},${130-u}`,`L ${$},${130+u}`,`C ${$-180},${130+u} ${a+120},${130+v} ${a},${130+v}`,`C ${a-18},${130+v} ${x-8},${130+v*.55} ${x},130`,"Z"].join(" "),b=e==="magnetosphere",y=b?g==="storm"?"0.12":"0.08":"0.04",S=b?"0.75":"0.28",k=`<g id="${c}-base-sun">
    <circle cx="${n}" cy="130" r="${i+18}" fill="none"
            stroke="#f0c040" stroke-width="2.5" opacity="0.12"/>
    <circle cx="${n}" cy="130" r="${i}" fill="#f0c040" opacity="0.88"/>
  </g>`,M=`
    ...
    <line x1="${i}" y1="130" x2="${x}" y2="130"
  ...
  </g>`,I="";if(e==="magnetosphere"){let z=(T=o.windKms)!=null?T:0,j=z>500,D=z<350,E=(j?.5:D?1.4:.9)*1.3,K=z>700?"#e05c5c":z>500?"#e0a84a":z>350?"#d4c840":"#5cce8c",ee=i+8,J=x-14,A=8,Y=6,U=(J-ee)/(A-1),te=260/(Y+1),Q=38,ie=24,$e=2,be=Array.from({length:A},(se,re)=>{let V=ee+re*U,ot=Array.from({length:Y},(st,ve)=>{let ne=te*(ve+1);return`<path d="M ${V.toFixed(1)},${ne.toFixed(1)} L ${(V+Q).toFixed(1)},${ne.toFixed(1)} M ${(V+ie).toFixed(1)},${(ne-6).toFixed(1)} L ${(V+Q).toFixed(1)},${ne.toFixed(1)} L ${(V+ie).toFixed(1)},${(ne+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:$e},(st,ve)=>{let ne=-((A-re)/A*E)-ve*E/$e;return`<g style="opacity:.12;animation:hw-arrow-chase ${E}s linear ${ne.toFixed(3)}s infinite">${ot}</g>`}).join("")}).join(""),oe=(F=o.bz)!=null?F:null,le=oe==null?"":(()=>{let se=oe>0?"#5cce8c":"#e05c5c";return`${oe>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
        ...
        fill="${se}" font-family="monospace">Bz${oe>0?"\u2191":"\u2193"}</text>`})();I=`${be}${le}`}let N=`<g id="${c}-overlay-solar-wind">${I}</g>`,P="";if(e==="coronal_hole"&&o.hssState){let z=o.hssState,j=(Z=z.speed)!=null?Z:0,D=j>=420,E=z.color,K=D?"0.85":"0.25",ee=j>=500?"0.18":D?"0.10":"0.04",J=i+8,A=d-16,Y=60,U=`${J},130 ${A},${130-Y} ${A},${130+Y}`,te=A+6,Q=`${te},120 ${te+18},130 ${te},140`;P=`
    <polygon points="${U}" fill="${E}" opacity="${ee}"/>
    <line x1="${J}" y1="130" x2="${A-5}" y2="130"
          stroke="${E}" stroke-width="3.5" stroke-dasharray="10 6"
          stroke-linecap="round" opacity="${K}"/>
    <polygon points="${Q}" fill="${E}" opacity="${D?"0.9":"0.25"}"/>`}let X=`<g id="${c}-overlay-coronal-hole">${P}</g>`,B="";if(e==="cme_cone"&&o.cmeState){let z=o.cmeState,j=i,D=d-10,E=D-j,K=U=>Math.tan(U*Math.PI/180),ee=Math.round(K(9)*E),J=Math.round(K(6)*E),A=Math.round(K(3)*E),Y=U=>`${j},130 ${D},${130-U} ${D},${130+U}`;if(z.status!=="quiet"){let U=z.status==="impact"?"#e05c5c":"#d4cc5c";B=`
    <polygon points="${Y(ee)}" fill="#253238" opacity="0.85"/>
    <polygon points="${Y(J)}"   fill="#d4cc5c" opacity="0.14"/>
    ...
    ${C}
    ${W}
  </svg>`}function Et(e){let o=Me(e),t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,r=t!=null&&t<-5?"Southward IMF Bz is strongly coupling energy into the magnetosphere. Geomagnetic storm conditions likely.":t!=null&&t<0?"Southward IMF Bz is partially opening the magnetosphere. Enhanced aurora activity possible.":"Northward IMF Bz keeps the magnetosphere closed. Solar wind energy transfer is minimal.";return`<div class="hw-kpi-popover">
    ${ce("Magnetosphere")}
    <div class="hw-spark-wrap" style="border-radius:3px;overflow:hidden">${Lt(o,t,s,!1)}</div>
    <div class="hw-kpi-hint" style="margin-bottom:0">${w(r)}</div>
  </div>`}function Ft(e,o){if(!o)return"";let t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,r=t!=null&&t<-5?"Southward IMF Bz is strongly coupling energy into the magnetosphere. Geomagnetic storm conditions likely.":t!=null&&t<0?"Southward IMF Bz is partially opening the magnetosphere. Enhanced aurora activity possible.":"Northward IMF Bz keeps the magnetosphere closed. Solar wind energy transfer is minimal.";return`<div class="hw-impact-tip hw-impact-tip-open">
    <div style="border-radius:3px;overflow:hidden;margin-bottom:2px">${Ye("magnetosphere",{windKms:s!=null?s:void 0,bz:t!=null?t:void 0})}</div>
    ${xo(e)}
    <div class="hw-kpi-hint" style="margin-top:6px;margin-bottom:0">${w(r)}</div>
  </div>`}function We(e,o,t){if(!e.length)return null;let s=(t%360+360)%360,r=-1,c=1/0,n=Math.cos(o*Math.PI/180);for(let i of e){let a=i.lat-o,l=(i.lon-s+180+360)%360-180,d=a*a+l*n*(l*n);d<c&&(c=d,r=i.prob)}return r>=0?r:null}function Ue(e){return`<svg viewBox="0 0 100 100" width="100%" height="100%"
    style="position:absolute;top:0;left:0;pointer-events:none">${['<text x="50" y="4"   font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">N</text>','<text x="96"  y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">W</text>','<text x="50" y="97"  font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">S</text>','<text x="4"   y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">E</text>'].join("")}</svg>`}function It(e,o){let t=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,s=null;o&&e.lat!=null&&e.lon!=null&&(s=We(o.entries,e.lat,e.lon));let r=e.lat!=null&&e.lon!=null,c=s!=null?s>=30?"#5cce8c":s>=10?"#d4cc5c":"#9ab4bc":"#607880",n=s!=null?`${s}%`:o?"n/a":"\u2026",i=r?`
    <div class="hw-aurora-obs-panel">
      ...
      <span class="hw-aurora-prob" style="color:${c}">Aurora: ${n}</span>
  ...
  </div>`}function Rt(e,o,t,s){switch(o){case"solar_wind":return St(e);case"xray":return Mt(e);case"imf_bz":return Ht(e);case"aurora":return It(t,s);case"magnetosphere":return Et(e);default:return""}}function At(e,o){if(e.length<2)return"\u2192";let t=e[e.length-1],s=Math.max(0,e.length-4),r=e[s];if(!isFinite(t)||!isFinite(r))return"\u2192";let c=t-r;return c>o?"\u2191":c<-o?"\u2193":"\u2192"}var Ot={quiet:"171",active:"195",elevated:"284",storm:"304"};function Tt(e,o){var s,r,c;if(o==null)return(r=(s=e.summary)==null?void 0:s.status)!=null?r:"quiet";let t=parseInt(((c=o.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":o.kp>=4?"active":"quiet"}function zt(e,o){var l,d;let t=(l=Ot[e])!=null?l:"171",s=`/assets/gifs/current_eit_${t}.gif`,r=to(s,o),c=so,n=(d=ue[e])!=null?d:ue.quiet,i=`${n.accent}44`,a=`0 0 10px ${n.accent}55,0 0 24px ${n.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
    <div class="hw-solar-mini-inner" style="border-color:${i};box-shadow:${a}">
      <img class="hw-solar-mini-img" src="${O(r)}" alt="Sun EIT ${O(t)}"
        onerror="if(this.src!=='${O(c)}')this.src='${O(c)}'" />
    </div>
  </div>`}function Nt(e,o,t,s,r){var f,b,y;let{summary:c,metrics:n}=e,i=(f=ue[c.status])!=null?f:ue.quiet,a=t!=null?t.kp.toFixed(1):n.kp_latest!=null?n.kp_latest.toFixed(1):"\u2014",l=bt(e,t),p=[{key:"G",text:l.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:l.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:l.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${l.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(S=>{let k;return S.key==="G"?k=ke(ye(l.g,"G")):S.key==="R"?k=ke(ye(l.r,"R")):S.key==="S"?k=ke(ye(l.s,"S")):k=$t(l.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${k.color};background:${k.background};border-color:${k.borderColor}`}" data-hero-chip="${S.key}" title="${O(S.title)}" aria-label="${O(S.aria)}">${w(S.text)}</button>`}).join(""),g=At(((b=n.kp_history_1h)!=null?b:[]).map(S=>S.kp),.5),m=(y=n.kp_latest)!=null?y:0,h=m>=5,x=h?`linear-gradient(160deg, #0d2a1a 0%, ${i.bg}22 75%)`:`${i.bg}18`,v=Tt(e,t),u=h?`
    ...
    <div class="hw-hero" style="background:${x}">
      ...
      ${u}
    </div>`}function Pt(e){var d,p,g,m;let{metrics:o}=e,t=(d=o.kp_history_1h)!=null?d:[],s=(p=o.wind_history_1h)!=null?p:[],r=(g=o.bz_history_1h)!=null?g:[],c=(m=o.xray_history_1h)!=null?m:[],n=kt(t),i=Oe(s.map(h=>{var x;return(x=h.kms)!=null?x:0}).filter(h=>h>0),s.map(h=>we(h.t_utc)),"#5cce8c",28,!1),a=Oe(r.map(h=>h.bz),r.map(h=>we(h.t_utc)),"#d4cc5c",28,!0),l=_t(c);return`
    ...
    </div>`}function Bt(e){let o=ut(e.updated_utc);return`
    <div class="hw-header">
      <span class="hw-header-title">Space Weather</span>
      <span class="hw-freshness">${w(o)}</span>
    </div>`}function Dt(e){return e.map((o,t)=>t===0?(o+e[1])/2:t===e.length-1?(e[t-1]+o)/2:(e[t-1]+o+e[t+1])/3)}function Gt(e){return e>=9?"G5":e>=8?"G4":e>=7?"G3":e>=6?"G2":e>=5?"G1":"G0"}function jt(e){return e>=5?"good":e>=3?"possible":"none"}function Xe(e){return e>=9?40:e>=8?45:e>=7?50:e>=6?55:e>=5?60:null}function Yt(e){let o=e>=7?"high":e>=5?"moderate":e>=3?"low":"none",t=Xe(e),s=o==="none"?"No aurora expected at mid-latitudes":t!=null?`Aurora possible equatorward of ~${t}\xB0 lat`:"Minor aurora possible at high latitudes",r=e>=7?"moderate":e>=5?"low":"none",c=r==="none"?"No significant HF degradation expected":r==="low"?"Minor HF degradation at high latitudes":"Moderate HF degradation, possible blackouts at high latitudes",n=e>=8?"high":e>=6?"moderate":e>=4?"low":"none";return[{kind:"aurora",level:o,label:"Aurora",summary:s},{kind:"radio",level:r,label:"HF Radio",summary:c},{kind:"solar_activity",level:n,label:"Solar Activity",summary:n==="none"?"Quiet geomagnetic conditions expected":n==="low"?"Active geomagnetic conditions possible":n==="moderate"?"Minor to moderate storm conditions":"Major geomagnetic storm conditions"}]}function Wt(e,o){var p;if(o<=0)return null;let t=(p=e.metrics.kp_forecast_3h)!=null?p:[];if(!t.length)return null;let s=Date.now()+o*36e5,r=t[0],c=1/0;for(let g of t){let m=Math.abs(new Date(g.t_utc).getTime()-s);m<c&&(c=m,r=g)}let n=r.kp,i=Gt(n),a=jt(n),l=Xe(n),d=Yt(n);return{offsetH:o,kp:n,gScale:i,auroraLabel:a,auroraMinLat:l,impacts:d}}function Ut(e,o,t,s){var W;let{forecast:r,metrics:c}=e,{kp_max_next_24h:n,kp_max_at_utc:i,trend:a}=r,l=((W=c.kp_forecast_3h)!=null?W:[]).slice(0,16),d=l.length,p=d*3,g=p>0?`${(o/p*100).toFixed(0)}%`:"0%",m=o>0?`\u23F1 +${Math.round(o)}h`:"Timeline",h="Kp forecast unavailable";if(n!=null){let H=me(i),R=a==="rising"?"rising":a==="falling"?"falling":"steady";h=`Peak Kp ${n.toFixed(1)} next 24h${H?` at ${H}`:""} \xB7 ${R}`}let x=l.length?me(l[0].t_utc):null,v=x?`Forecast \xB7 Next step ${x}`:"Forecast";if(!l.length)return`
    ...
    </div>`;let $=320,u=38,f=14,b=u+f,y=$/d,S=H=>u-Math.max(2,Math.min(u-2,H/9*(u-2))),k="",M=l.map(H=>H.kp),C=Dt(M);l.forEach((H,R)=>{let q=S(H.kp),T=u-q,F=R*y,Z=F+y/2,z=H.kp>=6?"#e05c5c":H.kp>=5?"#e0a84a":H.kp>=4?"#d4cc5c":"#5cce8c",j=`Kp ${H.kp.toFixed(1)} \xB7 ${me(H.t_utc)}`;if(k+=`<rect x="${F.toFixed(1)}" y="${q.toFixed(1)}" width="${(y-1.5).toFixed(1)}" height="${T.toFixed(1)}" fill="${z}" fill-opacity="0.85" rx="1.5"/>`,k+=`<rect x="${F.toFixed(1)}" y="0" width="${y.toFixed(1)}" height="${u}" fill="transparent"><title>${O(j)}</title></rect>`,d<=8||R%2===0){let E=new Date(H.t_utc).getHours();k+=`<text x="${Z.toFixed(1)}" y="${(b-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${E.toString().padStart(2,"0")}</text>`}});let L=`<polyline points="${l.map((H,R)=>{let q=R*y+y/2,T=S(C[R]);return`${q.toFixed(1)},${T.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,I="";if(o>0&&d>0){let H=Math.min($-1,o/(d*3)*$);I=`
    ...
    <div class="hw-forecast">
      ...
      ${B}`:""}
    </div>`}function Xt(e){let o=/([NS])(\d+)([EW])(\d+)/i.exec(e);return o?{lat:(o[1].toUpperCase()==="N"?1:-1)*parseInt(o[2],10),lon:(o[3].toUpperCase()==="E"?1:-1)*parseInt(o[4],10)}:null}var Ke=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function Kt(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function qt(e,o,t){let s=o/2,r=s*.87,c=o*.03,n=o*.009,i=e.map(a=>{var $,u;let l=Xt(a.location);if(!l||Math.abs(l.lon)>88||a.location.includes("*"))return"";let d=Kt(a);if(!t.has(d))return"";let p=Ke.find(f=>f.id===d).color,g=l.lat*Math.PI/180,m=l.lon*Math.PI/180,h=(s+r*Math.cos(g)*Math.sin(m)).toFixed(1),x=(s-r*Math.sin(g)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
      <title>${w(v)}</title>
      <circle cx="${h}" cy="${x}" r="${(c+n+1).toFixed(1)}" fill="none" stroke="#000000" stroke-width="${(n*2.5).toFixed(1)}" opacity="0.45"/>
      <circle cx="${h}" cy="${x}" r="${c.toFixed(1)}" fill="none" stroke="${p}" stroke-width="${n.toFixed(1)}"/>
    </g>`}).join("");return`<svg width="${o}" height="${o}" viewBox="0 0 ${o} ${o}"
    style="position:absolute;top:0;left:0;border-radius:50%;pointer-events:none">${i}</svg>`}var Ce={aurora:'<svg viewBox="0 0 12 12" width="12" height="12" aria-hidden="true" style="flex-shrink:0"><path d="M6 1L6.8 5.2L11 6L6.8 6.8L6 11L5.2 6.8L1 6L5.2 5.2Z" fill="currentColor" opacity=".85"/></svg>',radio:'<svg viewBox="0 0 12 12" width="12" height="12" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.35" style="flex-shrink:0"><path d="M3.8 9.8 a3.1 3.1 0 0 1 4.4 0"/><path d="M1.5 7.4 A6 6 0 0 1 10.5 7.4"/><circle cx="6" cy="11.2" r="1" fill="currentColor" stroke="none"/></svg>',solar_activity:'<svg viewBox="0 0 12 12" width="12" height="12" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.25" style="flex-shrink:0"><circle cx="6" cy="6" r="2" fill="currentColor" stroke="none"/><path d="M6 1v1.5M6 9.5V11M1 6h1.5M9.5 6H11M2.6 2.6l1.1 1.1M8.3 8.3l1.1 1.1M9.4 2.6l-1.1 1.1M3.7 8.3l-1.1 1.1"/></svg>'},qe='<svg viewBox="0 0 12 12" width="12" height="12" aria-hidden="true" style="flex-shrink:0"><circle cx="6" cy="6" r="2.5" fill="currentColor" opacity=".7"/></svg>',Qt=Ce.solar_activity,Vt='<svg viewBox="0 0 12 12" width="12" height="12" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.2" style="flex-shrink:0"><path d="M2 6 Q2 2.5 6 2.5 Q10 2.5 10 6 Q10 9.5 6 9.5 Q2 9.5 2 6"/><ellipse cx="6" cy="6" rx="2.2" ry="1.9"/><circle cx="6" cy="6" r="0.65" fill="currentColor" stroke="none"/></svg>',Zt='<svg viewBox="0 0 12 12" width="12" height="12" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.2" style="flex-shrink:0"><circle cx="3.2" cy="6" r="2.2"/><line x1="5.8" y1="6" x2="11" y2="6"/><polyline points="9.2,4.3 11,6 9.2,7.7" fill="currentColor" stroke="none"/></svg>',Jt=14,eo="https://staging.nebulacast.app";function to(e,o){return!e||/^https?:\/\//.test(e)||e.startsWith("//")?e:(o!=null?o:eo).replace(/\/$/,"")+(e.startsWith("/")?e:"/"+e)}var oo="https://soho.nascom.nasa.gov/data/realtime/hmi_igr/512/latest.jpg",so="https://soho.nascom.nasa.gov/data/realtime/hmi_igr/512/latest.jpg",no=240;function ro(e,o){var l,d,p;let t=parseInt(((l=e.scales.r_scale)!=null?l:"R0").slice(1),10),s=(d=e.metrics.xray_class)!=null?d:"A",r=e.metrics.xray_flux_wm2,c=r!=null?r.toExponential(2)+" W/m\xB2":"\u2014",i=[{r:0,color:"#5cce8c",desc:"Quiet"},{r:1,color:"#d4cc5c",desc:"Minor"},{r:2,color:"#e0a84a",desc:"Moderate"},{r:3,color:"#e05c5c",desc:"Strong"},{r:4,color:"#c0407a",desc:"Severe"},{r:5,color:"#8c3cc0",desc:"Extreme"}].map(g=>{let m=g.r===t,h=g.r<=t,x=h?g.color:"#1e2c30",v=m?"1":h?"0.5":"1",$=m?g.color:h?g.color+"99":"#566068",u=m?g.color:h?g.color+"88":"#566068";return`<div class="hw-radio-block">
  ...
  </div>`}var io={0:"Quiet",1:"Minor Storm",2:"Moderate Storm",3:"Strong Storm",4:"Severe Storm",5:"Extreme Storm"};function ao(e){return e>=9?5:e>=8?4:e>=7?3:e>=6?2:e>=5?1:0}function ae(e,o){if(e<o-.7)return 0;if(e>o+1)return .9;let t=(e-(o-.7))/1.7;return Math.round(Math.pow(Math.max(0,t),.7)*90)/100}function co(e){var l,d,p;let o=parseInt(((l=e.scales.g_scale)!=null?l:"G0").replace(/\D/g,""),10),t=Math.max(0,Math.min(5,Number.isFinite(o)?o:0)),s=(d=e.metrics.kp_forecast_3h)!=null?d:[],r=Date.now(),c=r+24*60*60*1e3,n=s.filter(g=>{let m=new Date(g.t_utc).getTime();return m>=r-3*60*60*1e3&&m<=c}),i=n.length===0?0:Math.max(...n.map(g=>g.kp)),a={G1:ae(i,5),G2:ae(i,6),G3:ae(i,7),G4:ae(i,8),G5:ae(i,9),max_expected:ao(i)};return{now:{g_level:t,label:(p=io[t])!=null?p:"Quiet"},forecast_24h:a}}function lo(e){if(!e||typeof e!="object")return null;let o=e,t=o.now,s=o.forecast_24h;if(!t||!s)return null;let r=typeof t.g_level=="number"?t.g_level:parseInt(String(t.g_level),10),c=typeof t.label=="string"?t.label:"Quiet";if(!Number.isFinite(r))return null;let n=l=>{let d=typeof l=="number"?l:parseFloat(String(l));return Number.isFinite(d)?Math.max(0,Math.min(1,d)):0},i=s.max_expected,a=typeof i=="number"&&Number.isFinite(i)?Math.max(0,Math.min(5,Math.round(i))):0;return{now:{g_level:Math.max(0,Math.min(5,Math.round(r))),label:c},forecast_24h:{G1:n(s.G1),G2:n(s.G2),G3:n(s.G3),G4:n(s.G4),G5:n(s.G5),max_expected:a}}}function Qe(e){let o=co(e),t=lo(e.storm_risk);if(!t)return o;let s=e.storm_risk,r=s&&typeof s.forecast_24h=="object"&&s.forecast_24h!==null?s.forecast_24h:void 0,c=r==null?void 0:r.max_expected;return typeof c=="number"&&Number.isFinite(c)?t:he(pe({},t),{forecast_24h:he(pe({},t.forecast_24h),{max_expected:o.forecast_24h.max_expected})})}function po(e){return e>=4?"#e05c5c":e>=3?"#e0a84a":e>=1?"#d4cc5c":"#607880"}var Te={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function ho(e){var l,d,p;let o=(l=e.metrics.kp_latest)!=null?l:0,t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,r=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,c=o>=5||r>=1,n=(p=e.metrics.kp_history_1h)!=null?p:[],i=0;if(n.length>=2&&(i=n[n.length-1].kp-n[n.length-2].kp),!c)return{active:!1,phase:"quiet",kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s};let a;return i>.3&&(t==null||t<-5)?a="rising":i<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s}}function mo(e){if(!e.active)return"";let o=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=o.findIndex(i=>i.key===e.phase),s=Te[e.phase],r=o[t].label,c=o.map((i,a)=>{let l=a===t,d=a<t,p=Te[i.key],g=l?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",m=l?" hw-spi-dot-active":"",h=l?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",x=a<o.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
        <div class="hw-spi-dot${m}" style="${g}"></div>
        <div class="hw-spi-txt" style="${h}">${i.label}</div>
      </div>${x}`}).join(""),n=[`Kp ${e.kp_current.toFixed(1)}`];return e.bz_nt!=null&&n.push(`Bz ${e.bz_nt>0?"+":""}${e.bz_nt.toFixed(1)} nT`),e.solar_wind_kms!=null&&n.push(`Wind ${Math.round(e.solar_wind_kms)} km/s`),`<div class="hw-spi-wrap">
    <div class="hw-spi-hdr">Geomagnetic Storm \xB7 <span style="color:${s};font-weight:700">${r}</span></div>
    <div class="hw-spi-track">${c}</div>
    <div class="hw-spi-params">${n.join(" \xB7 ")}</div>
  </div>`}function ze(e,o,t){let s=Math.max(0,Math.min(5,Math.round(e))),r=(t==null?void 0:t.showDialCode)!==!1,c=70,n=76,i=48,l=i-9,d=Math.PI,p=y=>d*(1-y/5),g=p(s),m=(y,S)=>({x:c+S*Math.cos(y),y:n-S*Math.sin(y)}),h=(y,S,k)=>{let M=m(y,i),C=m(S,i),_=m(y,l),L=m(S,l);return`<path d="M ${_.x.toFixed(2)} ${_.y.toFixed(2)} L ${M.x.toFixed(2)} ${M.y.toFixed(2)} A ${i} ${i} 0 0 1 ${C.x.toFixed(2)} ${C.y.toFixed(2)} L ${L.x.toFixed(2)} ${L.y.toFixed(2)} A ${l} ${l} 0 0 0 ${_.x.toFixed(2)} ${_.y.toFixed(2)} Z" fill="${k}"/>`},x=y=>{let S=p(y),k=m(S,i+1),M=m(S,i-5);return`<line x1="${k.x.toFixed(2)}" y1="${k.y.toFixed(2)}" x2="${M.x.toFixed(2)}" y2="${M.y.toFixed(2)}" stroke="#2a3a40" stroke-width="1" stroke-linecap="round"/>`},v=m(g,i-2),$=`<line x1="${c}" y1="${n}" x2="${v.x.toFixed(2)}" y2="${v.y.toFixed(2)}" stroke="#c8d6dc" stroke-width="2" stroke-linecap="round"/>`,u=`<circle cx="${c}" cy="${n}" r="3.5" fill="#3a4c52" stroke="#1e2c30" stroke-width="1"/>`,f=h(p(0),p(2),"#3d8f62")+h(p(2),p(4),"#b8982a")+h(p(4),p(5),"#b04048"),b=[0,1,2,3,4,5].map(x).join("");return`<div class="hw-storm-risk-gauge" role="img" aria-label="${O(o)} G${s}">
    <svg viewBox="0 0 140 88" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      ${$}
      ${u}
      ${r?`<text x="${c}" y="84" text-anchor="middle" fill="#8a9ca8" font-size="11" font-family="inherit" font-weight="600">G${s}</text>`:""}
    </svg>
  </div>`}function go(e,o){let t=Qe(e),s=ho(e),r=t.forecast_24h,c=Math.max(0,Math.min(5,Math.round(r.max_expected))),n=`<div class="hw-storm-risk-now-gauge">${ze(t.now.g_level,"Current observed geomagnetic storm level",{showDialCode:!0})}</div>`,i=`<div class="hw-storm-risk-fc-gauge">${ze(c,"Max expected geomagnetic level in next 24 hours",{showDialCode:!1})}</div>`,a=`
    ...
    <div class="hw-storm-risk-grid">
      ...
      <div class="hw-storm-risk-now-gauge-cell">${n}</div>
  ...
  </div>`}var ge={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},Ve={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function uo(e){var C;let o=ge,t=(C=Ve[o.phase])!=null?C:"#96a8b8",s=o.phase.charAt(0).toUpperCase()+o.phase.slice(1),r=280,c=52,n=10,i=c-6,a=c-18,l=.5,d=.19,p=_=>Math.exp(-Math.pow((_-l)/d,2)/2),g=_=>n+_*(r-2*n),m=_=>i-p(_)*a,h=80,x=[];for(let _=0;_<=h;_++){let L=_/h;x.push(`${_===0?"M":"L"}${g(L).toFixed(1)},${m(L).toFixed(1)}`)}let v=Math.round(o.progress_0_1*h),$=[];for(let _=0;_<=v;_++){let L=_/h;$.push(`${_===0?"M":"L"}${g(L).toFixed(1)},${m(L).toFixed(1)}`)}let u=g(o.progress_0_1),f=[`M${n},${i}`,...$.slice(1),`L${u.toFixed(1)},${i} Z`],b=m(o.progress_0_1),y=5,S=`M${u.toFixed(1)},${b.toFixed(1)} L${(u-y).toFixed(1)},${(b-y*1.8).toFixed(1)} L${(u+y).toFixed(1)},${(b-y*1.8).toFixed(1)} Z`,k=i+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
    <div class="hw-sc-name">${w(o.cycle_name)}</div>
    <svg width="100%" height="${c+14}" viewBox="0 0 ${r} ${c+14}" class="hw-sc-svg" preserveAspectRatio="none">
      ...
      <line x1="${n}" y1="${i}" x2="${r-n}" y2="${i}" stroke="#1e2c30" stroke-width="1" vector-effect="non-scaling-stroke"/>
      <path d="${S}" fill="${t}"/>
      <text x="${n+2}" y="${k}" class="hw-sc-axlabel" text-anchor="start">min</text>
      <text x="${g(.5).toFixed(1)}" y="${k}" class="hw-sc-axlabel" text-anchor="middle">max</text>
      <text x="${(r-n-2).toFixed(1)}" y="${k}" class="hw-sc-axlabel" text-anchor="end">min</text>
    </svg>
    <div class="hw-sc-footer">Phase: <b style="color:${t}">${w(s)}</b>${o.subtitle?` \xB7 ${w(o.subtitle)}`:""}</div>
  </div>`}var xe={none:"#3a5060",low:"#5cce8c",moderate:"#d4cc5c",strong:"#e0a84a",severe:"#e05c5c"},Ze={none:"none",low:"0 0 5px #5cce8c55",moderate:"0 0 5px #d4cc5c55",strong:"0 0 6px #e0a84a77",severe:"0 0 7px #e05c5c99"};function wo(e){var b,y,S,k;let o=(b=e.metrics.xray_class)!=null?b:"A",t=e.observer_impacts.find(M=>M.kind==="solar_activity"),s=(y=t==null?void 0:t.level)!=null?y:"none",r=e.coronal_hole,c=(S=r==null?void 0:r.status)!=null?S:"quiet",n=[];o==="X"?(n.push("Solar flare: X-class"),n.push("Elevated X-ray activity")):o==="M"?(n.push("Solar flare: M-class"),n.push("Elevated X-ray activity")):o==="C"&&n.push("Minor C-class flare activity"),(c==="strong"||c==="active")&&(n.push(`Coronal hole: ${c==="strong"?"Strong":"Active"}`),(r==null?void 0:r.estimated_speed_kms)!=null&&n.push(`Fast solar wind: ~${Math.round(r.estimated_speed_kms)} km/s`)),n.length===0&&n.push("No significant solar source activity");let i,a;o==="X"||s==="high"?(i="Strong",a="strong"):o==="M"||s==="moderate"||c==="strong"?(i="Active",a="moderate"):o==="C"||s==="low"||c==="active"?(i="Elevated",a="low"):(i="Quiet",a="none");let l=e.cme_tracker,d=e.metrics.solar_wind_kms,p=[],g="Clear",m="none";if(l){let M=l.status,C=l.impact_level;if(M==="arrived"||M==="arrival_window")g="Impacting",m=C==="high"?"strong":"moderate",p.push("CME impact underway"),l.speed_kms!=null&&p.push(`Speed: ~${Math.round(l.speed_kms)} km/s`);else if(M==="inbound"||M==="detected"){if(g="Incoming",m=C==="high"?"moderate":"low",p.push("Earth-directed CME detected"),l.arrival_time_utc){let _=new Date(l.arrival_time_utc),L=_.getUTCDate().toString().padStart(2,"0"),I=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][_.getUTCMonth()],N=_.getUTCHours().toString().padStart(2,"0"),P=_.getUTCMinutes().toString().padStart(2,"0");p.push(`ETA: ${L} ${I} ${N}:${P} UTC`)}p.push(`Expected impact: ${C.charAt(0).toUpperCase()+C.slice(1)}`)}}p.length===0&&(d!=null&&d>500?(g="Active",m="low",p.push(`High-speed solar wind: ${Math.round(d)} km/s`),p.push("No Earth-directed CME tracked")):p.push("No Earth-directed events"));let h=parseInt(((k=e.scales.g_scale)!=null?k:"G0").slice(1),10),x=e.metrics.kp_latest,v=x!=null?`Kp ${x.toFixed(1)}`:"Kp \u2014",$=[`G${h}`],u,f;return h>=4?(u="Severe",f="severe",$.push("Severe geomagnetic storm")):h===3?(u="Storm",f="strong",$.push("Strong geomagnetic storm")):h===2?(u="Storm",f="moderate",$.push("Moderate geomagnetic storm")):h===1?(u="Active",f="low",$.push("Minor geomagnetic storm")):(u="Quiet",f="none",$.push("Quiet conditions")),$.push(v),{sun:{state:i,severity:a,label:i,messages:n},space:{state:g,severity:m,label:g,messages:p},earth:{state:u,severity:f,label:u,messages:$}}}function Ne(e,o){var c,n;let t=(c=xe[e.severity])!=null?c:xe.none,s=(n=Ze[e.severity])!=null?n:"none",r=e.messages.slice(0,3).map(i=>`<span class="hw-chain-msg">${w(i)}</span>`).join("");return`<div class="hw-chain-col">
    <div class="hw-chain-head">${w(o)}</div>
    <span class="hw-chain-lamp" style="background:${t};box-shadow:${s}"></span>
    <div class="hw-chain-state" style="color:${t}">${w(e.label)}</div>
    <div class="hw-chain-msgs">${r}</div>
  </div>`}function xo(e){var i,a,l;let o=(i=e.chain_panel)!=null?i:wo(e),t='<div class="hw-chain-arrow">\u203A</div>',s=(a=xe[o.earth.severity])!=null?a:xe.none,r=(l=Ze[o.earth.severity])!=null?l:"none",c=o.earth.messages.slice(0,3).map(d=>`<span class="hw-chain-msg">${w(d)}</span>`).join(""),n=`<div class="hw-chain-col hw-chain-col-earth" data-chain-col="earth" title="Click to expand Aurora &amp; Storm Risk">
    <div class="hw-chain-head">Earth</div>
    <span class="hw-chain-lamp" style="background:${s};box-shadow:${r}"></span>
    <div class="hw-chain-state" style="color:${s}">${w(o.earth.label)}</div>
    <div class="hw-chain-msgs">${c}</div>
    ...
    ${t}
    ${n}
  </div>`}function Je(e){var r,c;let o=(r=e.scales.g_scale)!=null?r:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let n=(c=e.metrics.kp_forecast_3h)!=null?c:[],i=Date.now(),a=n.filter(l=>new Date(l.t_utc).getTime()<=i+3*60*60*1e3).sort((l,d)=>new Date(d.t_utc).getTime()-new Date(l.t_utc).getTime());a.length>0&&(s=a[0].kp)}return t>=2||s!=null&&s>=6?{level:2,color:"#e05c5c",label:"High",kp:s,gScale:o}:t>=1||s!=null&&s>=4?{level:1,color:"#d4cc5c",label:"Moderate",kp:s,gScale:o}:{level:0,color:"#5cce8c",label:"Low",kp:s,gScale:o}}function fo(e,o){let t=Je(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(a=>{let l=a.l===t.level,d=l?`${a.color}2e`:"#1b2a2e",p=l?a.color:"#3d5058",g=l?`1px solid ${a.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${d};color:${p};border:${g}">${a.label}</div>`}).join(""),n=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Near-normal thermospheric density",1:"Elevated drag \u2014 minor orbit correction may be needed",2:"Strong thermospheric expansion \u2014 significant drag increase"};return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-satdrag-meta">${n} \xB7 ${w(t.gScale)} \xB7 ${i[t.level]}</div>
  </div>`}function et(e){var l,d,p;let o=(l=e.scales.g_scale)!=null?l:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let g=(d=e.metrics.kp_forecast_3h)!=null?d:[],m=Date.now(),h=g.filter(x=>new Date(x.t_utc).getTime()<=m+3*60*60*1e3).sort((x,v)=>new Date(v.t_utc).getTime()-new Date(x.t_utc).getTime());h.length>0&&(s=h[0].kp)}let r=0;t>=2||s!=null&&s>=6?r=2:(t>=1||s!=null&&s>=4)&&(r=1);let c=parseInt(((p=e.scales.r_scale)!=null?p:"R0").slice(1),10),n=c>=2&&r<2;c>=2&&(r=Math.min(2,r+1));let i={0:"#5cce8c",1:"#d4cc5c",2:"#e05c5c"},a={0:"Low",1:"Moderate",2:"High"};return{level:r,color:i[r],label:a[r],kp:s,gScale:o,boostedByFlare:n}}function $o(e,o){var l;let t=et(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(d=>{let p=d.l===t.level,g=p?`${d.color}2e`:"#1b2a2e",m=p?d.color:"#3d5058",h=p?`1px solid ${d.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${g};color:${m};border:${h}">${d.label}</div>`}).join(""),n=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Stable ionosphere \xB7 normal positioning accuracy",1:"Possible signal delay or scintillation",2:"Significant positioning errors \xB7 possible signal loss"},a=t.boostedByFlare?`<div class="hw-gnss-meta" style="font-size:.72em">Risk elevated by solar flare activity (R${parseInt(((l=e.scales.r_scale)!=null?l:"R0").slice(1),10)})</div>`:"";return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-gnss-meta">${n} \xB7 ${w(t.gScale)} \xB7 ${i[t.level]}</div>
    ${a}
  </div>`}function _e(e,o,t,s,r,c,n,i,a){let l=c.has(e),d=l?" hw-impact-open":"",p=l?" hw-impact-tip-open":"";return`<div class="hw-impact-row${d}" id="${e}" data-impact-row="${e}">
      <span class="hw-impact-caret">\u25B6</span>
      <span class="hw-impact-kind" style="color:${r}">${t}<span style="color:#b4c6cc">${w(o)}</span></span>
      <span class="hw-impact-badge" style="background:${r}22;color:${r}">${w(s)}</span>
      <div class="hw-impact-tip${p}">${Rt(n,e,i,a)}</div>
    </div>`}function bo(e,o){let t=e.find(c=>c.kind==="aurora");if(t)return t;let s=o.aurora_hint;return{kind:"aurora",level:s.aurora_label==="good"?"moderate":s.aurora_label==="possible"?"low":"none",label:"Aurora",summary:s.summary}}function vo(e,o,t,s){var u,f;let r=(u=Ge[e.level])!=null?u:"#666",c=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),n=(f=Ce[e.kind])!=null?f:qe,i=e.level==="none"?"#606870":r,a=o.has("aurora"),l=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,g=null;t&&s.lat!=null&&s.lon!=null&&(g=We(t.entries,s.lat,s.lon));let m=s.lat!=null&&s.lon!=null,h=g!=null?g>=30?"#5cce8c":g>=10?"#d4cc5c":"#9ab4bc":"#607880",x=g!=null?`${g}%`:t?"n/a":"\u2026",v=m?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
    ...
    <span class="hw-impact-caret">\u25B6</span>
    <span class="hw-impact-kind" style="color:${i}">${n}<span style="color:#b4c6cc">${w(e.label)}</span></span>
    <span class="hw-impact-badge" style="background:${r}22;color:${r}">${w(c)}</span>
    ${$}
  </div>`}function Pe(e,o,t,s,r,c){var x,v;let n=(x=Ge[e.level])!=null?x:"#666",i=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Ce[e.kind])!=null?v:qe,l=e.level==="none"?"#606870":n,d=e.kind==="solar_activity"?t:c,p=d?" hw-impact-open":"",g;if(e.kind==="solar_activity"){let $=t?" hw-solar-open":"",u=Ke.map(f=>{let b=s.has(f.id),y=b?f.color+"22":"transparent",S=b?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${y};opacity:${S}">${f.label}</button>`}).join("");g=`<div class="hw-solar-tip${$}">
        <div class="hw-solar-disk-wrap" id="solar">
          <img class="hw-solar-disk-img" src="${oo}" alt="Solar disk" loading="lazy" />
          ${o?qt(o,no,s):""}
        </div>
        <div class="hw-solar-layers">${u}</div>
        <span class="hw-solar-tip-text">${w(e.summary)}</span>
      </div>`}else g=ro(r,d);let m=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${O(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${m}>
    <span class="hw-impact-caret">\u25B6</span>
    <span class="hw-impact-kind" style="color:${l}">${a}<span style="color:#b4c6cc">${w(e.label)}</span></span>
    <span class="hw-impact-badge" style="background:${n}22;color:${n}">${w(i)}</span>
    ${g}
  </div>`}function yo(e,o,t,s,r,c,n,i,a){var oe,le,se,re;let l=(le=(oe=o==null?void 0:o.impacts)!=null?oe:e.observer_impacts)!=null?le:[],d=bo(l,e),p=vo(d,n,i,a),g=l.find(V=>V.kind==="radio"),m=l.find(V=>V.kind==="solar_activity"),h=g?Pe(g,t,r,c,e,n.has("radio")):"",x=m?Pe(m,t,r,c,e,!1):"",u=`
    <div class="hw-section-row" data-impacts-toggle>
      <span class="hw-section-caret">${s?"\u25BC":"\u25B6"}</span>
      <span class="hw-section-label" style="margin-bottom:0">Indicators (${Jt})${o?'<span style="font-size:.65em;color:#7a9870;font-weight:normal;text-transform:none;letter-spacing:0"> \xB7 simulated</span>':""}</span>
    </div>`,{metrics:f}=e,b=f.xray_class,y=b?(se=fe[b])!=null?se:"#a0b4b8":"#607880",S=b?`${b}-class`:"\u2014",k=f.imf_bz_nt,M=k!=null?k<=-10?"#e05c5c":k<=-5?"#e0a84a":k>=5?"#5cce8c":"#a0b4b8":"#607880",C=k!=null?(k>=0?"+":"")+k.toFixed(1)+" nT":"\u2014",_=f.solar_wind_kms,L=_!=null?`${Math.round(_)} km/s`:"\u2014",I=_!=null?_>700?"#e05c5c":_>500?"#e0a84a":_>400?"#d4cc5c":"#5cce8c":"#607880",N=_e("xray","X-Ray",Qt,S,y,n,e,a,i),P=_e("imf_bz","IMF Bz",Vt,C,M,n,e,a,i),X=_e("solar_wind","Solar Wind",Zt,L,I,n,e,a,i),B='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',G=n.has("geomag_storm"),W=Qe(e),H=po(W.now.g_level),R=`G${W.now.g_level}`,T=`<div class="hw-impact-row${G?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${go(e,G)}
    </div>`,F=n.has("solar_cycle"),Z=(re=Ve[ge.phase])!=null?re:"#96a8b8",z=ge.phase.charAt(0).toUpperCase()+ge.phase.slice(1),D=`<div class="hw-impact-row${F?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${uo(F)}
    </div>`,E=Je(e),K=n.has("sat_drag"),J=`<div class="hw-impact-row${K?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${fo(e,K)}
    </div>`,A=et(e),Y=n.has("gnss"),te=`<div class="hw-impact-row${Y?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${$o(e,Y)}
    </div>`,Q=Me(e),ie=n.has("magnetosphere"),be=`<div class="hw-impact-row${ie?" hw-impact-open":""}" data-impact-row="magnetosphere">
      <span class="hw-impact-caret">\u25B6</span>
    ...
    ${n}
  </div>`}var _o={info:"#445c64",watch:"#e0a84a",warning:"#e05c5c"},So="#4ae0a4";function Mo(e){let o=(t,s="")=>`<svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" ${s}>${t}</svg>`;switch(e){case"solar_flare":return o(`<circle cx="6.5" cy="6.5" r="2.5"/>
        ...
        <circle cx="6.5" cy="3.8" r=".6" fill="currentColor" stroke="none"/>`)}}function Co(e){var s;let o=(s=e.metadata)!=null?s:{},t=[];return o.source_code&&t.push(`Code: ${o.source_code}`),o.model&&t.push(`Model: ${String(o.model).toUpperCase()}`),t.length===0?"":`
${t.join(" \xB7 ")}`}function Ho(e,o,t){var a;let s=e.is_active?So:(a=_o[e.level])!=null?a:"#445c64",r=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",n=e.source==="NASA_DONKI"?"DONKI":"SWPC",i=r?`<div class="hw-tl-detail">${w(e.description)}${w(Co(e))}</div>`:"";return`
    <div class="hw-tl-item" data-timeline-key="${O(e.event_time)}">
      ...
      <div class="hw-tl-body">
        <div class="hw-tl-meta">
          ...
          <span class="hw-tl-src">${n}</span>
        </div>
        <div class="hw-tl-title${e.is_active?" hw-tl-active":""}">
          ${Mo(e.event_type)} ${w(e.event_title)}
        </div>
        ${i}
      </div>
    </div>`}function Lo(e,o,t,s){var $,u;let r=($=e.timeline)!=null?$:[],c=Date.now(),n=new Date(c).toISOString().slice(0,10),i=new Date(c-864e5).toISOString().slice(0,10),a=new Date(c-1728e5).toISOString().slice(0,10),l=new Set([n,i,a]),d=r.filter(f=>{var b;return l.has(((b=f.event_time)!=null?b:"").slice(0,10))}).slice().reverse(),p=d.length,g=t?"\u25BC":"\u25B6",m=p>0?`Solar Activity Timeline (${p})`:"Solar Activity Timeline",h=`
    <div class="hw-section-row" data-tl-section>
      ...
      <div class="hw-tl-day-row" data-tl-day="${O(f)}">
        ...
        ${C}
      </div>`,L=k?"":b.map((I,N)=>Ho(I,N<b.length-1,o)).join("");return`<div class="hw-tl-group">${_}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Eo(e,o,t){var l;let s=(l=e.alerts_all)!=null?l:[],r=s.length,c=o?"\u25BC":"\u25B6",n=r>0?`SWPC Alerts (${r})`:"SWPC Alerts",i=`
    <div class="hw-alerts-header">
      <div class="hw-section-row" data-alerts-toggle style="margin-bottom:0">
        ...
        <span class="hw-alerts-label">${n}</span>
      </div>
    </div>`;if(!o||r===0)return`<div class="hw-alerts">${i}${o&&r===0?'<div class="hw-empty-alerts">No significant recent SWPC alerts</div>':""}</div>`;let a=s.map(d=>ko(d,d.dedupe_key===t)).join("");return`
    <div class="hw-alerts">
      ${i}
      ${a}
    </div>`}function Fo(e,o){var P,X,B;let t=e.cme_tracker;if(!t)return"";let s=(P=mt[t.impact_level])!=null?P:"#96a8b8",r=(X=gt[t.status])!=null?X:t.status,c=300,n=44,i=18,a=n/2,l=10,d=c-18,p=7,g=`<line x1="${i+l}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,m=`<circle cx="${i}" cy="${a}" r="${l}" fill="#f0c040" opacity="0.92"/>`,h=`
    ...
    <circle cx="${d}" cy="${a}" r="2.5" fill="#fff" opacity="0.7"/>`,x=`<text x="${i}" y="${a+l+9}" text-anchor="middle" font-size="9" fill="#c8aa60">Sun</text>`,v=`<text x="${d}" y="${a+p+9}" text-anchor="middle" font-size="9" fill="#7ab0d4">Earth</text>`,$="";if(t.progress!=null){let G=i+l+4,W=d-p-4,H=G+t.progress*(W-G),R=5;t.status==="arrival_window"?$=`
        ...
        </g>`:$=`<circle cx="${H.toFixed(1)}" cy="${a}" r="${R}" fill="${s}" opacity="0.85"/>`}let u=`<svg class="hw-cme-svg" viewBox="0 0 ${c} ${n}" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
    ${g}
    ${m}${x}
    ${h}${v}
    ${$}
    ...
    <div class="hw-cme-detail">
      <div class="hw-cme-stat-grid">
        ...
        <div class="hw-cme-stat">
          ...
          <span class="hw-cme-stat-value">${w(r)}</span>
        </div>
        <div class="hw-cme-stat">
    ...
    </div>`,L=o?"\u25BC":"\u25B6",I=t.impact_level==="unknown"?"Unrated":t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1),N=o?`${u}${_}`:"";return`
    <div class="hw-cme">
      <div class="hw-cme-row" data-cme-toggle>
        ...
        <span class="hw-cme-badge" style="background:${s}22;color:${s};margin-left:auto">${w(r)}</span>
        <span class="hw-cme-badge" style="background:${s}15;color:${s};margin-left:4px">${w(I)} impact</span>
      </div>
      ${N}
    </div>`}function Io(e,o,t,s,r,c,n,i,a,l,d,p,g,m,h,x,v,$){var M;let u=Wt(e,s),f=(M=e.metrics.kp_history_1h)!=null?M:[],b=f.length?me(f[f.length-1].t_utc):null,y=b?`Recent history \xB7 Last step ${b}`:"Recent history",S=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    <span class="hw-section-caret">${t?"\u25BC":"\u25B6"}</span>
    <span class="hw-section-label" style="margin-bottom:0">${O(y)}</span>
  </div></div>`,k=t?Pt(e):"";return`
    <div class="hw-root">
      ${Bt(e)}
      ${Nt(e,t,u,v,$)}
      ${yo(e,u,g,l,m,h,x,$,v)}
      ...
      ${Lo(e,n,i,a)}
      ${Eo(e,r,c)}
    </div>`}function Ro(e){return`<div class="hw-root">
