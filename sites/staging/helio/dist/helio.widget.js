"use strict";var HelioWidgetModule=(()=>{var me=Object.defineProperty,ht=Object.defineProperties,mt=Object.getOwnPropertyDescriptor,ut=Object.getOwnPropertyDescriptors,gt=Object.getOwnPropertyNames,Oe=Object.getOwnPropertySymbols;var Te=Object.prototype.hasOwnProperty,wt=Object.prototype.propertyIsEnumerable;var Re=(e,s,t)=>s in e?me(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t,ze=(e,s)=>{for(var t in s||(s={}))Te.call(s,t)&&Re(e,t,s[t]);if(Oe)for(var t of Oe(s))wt.call(s,t)&&Re(e,t,s[t]);return e},Ne=(e,s)=>ht(e,ut(s));var xt=(e,s)=>{for(var t in s)me(e,t,{get:s[t],enumerable:!0})},ft=(e,s,t,o)=>{if(s&&typeof s=="object"||typeof s=="function")for(let n of gt(s))!Te.call(e,n)&&n!==t&&me(e,n,{get:()=>s[n],enumerable:!(o=mt(s,n))||o.enumerable});return e};var bt=e=>ft(me({},"__esModule",{value:!0}),e);var Ns={};xt(Ns,{HelioWidget:()=>ct});var we={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},Ke={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},$t={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},fe={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},vt={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},yt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function kt(e){if(!e)return"Update time unavailable";try{let s=Math.round((Date.now()-new Date(e).getTime())/6e4);if(s<1)return"Updated just now";if(s<60)return`Updated ${s} min ago`;let t=Math.floor(s/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(s){return"Updated recently"}}function _t(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(s){return e}}function ue(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(s){return e}}function xe(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(s){return e.slice(11,16)}}function Pe(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(s){return e}}function O(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Be={G:["aurora","storm_risk"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},St=2400;function qe(){var e,s;try{let t=(s=(e=globalThis.location)==null?void 0:e.hostname)!=null?s:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function Ct(e){let s=[],t=null;for(let o of e){let n=document.getElementById(o);n instanceof HTMLElement?(t||(t=n),s.push(n)):qe()&&console.warn(`[Helio] Hero chip nav: missing element #${o}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let o of s)o.classList.add("section-flash"),window.setTimeout(()=>o.classList.remove("section-flash"),St)}function De(e){let s=e.trim();return s.toUpperCase().startsWith("X:")?s.slice(2).trim()||"\u2014":s||"\u2014"}function ke(e,s){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==s)return 0;let o=parseInt(t.slice(1),10);return!isFinite(o)||o<0?0:Math.min(5,o)}function _e(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function Mt(e){var c,r,l;let s=e.trim().toUpperCase();if(s==="\u2014"||s===""||s==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=fe[s])!=null?c:"#a0b4b8",o={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},n={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(r=o[s])!=null?r:"#1e2830",borderColor:(l=n[s])!=null?l:"#3a4c52"}}function Lt(e,s){var c,r,l,a,i,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",o={g:(c=s==null?void 0:s.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:De(t)},n=(r=e.hero)==null?void 0:r.scales;return n?{g:(l=n.g)!=null?l:o.g,r:(a=n.r)!=null?a:o.r,s:(i=n.s)!=null?i:o.s,x:De((d=n.x)!=null?d:o.x)}:o}var Ht=`
...
`,Ye=!1;function Et(){if(Ye)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=Ht,document.head.appendChild(e),Ye=!0}function It(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let s=200,t=32,o=e.length,n=s/o,c=e.map((r,l)=>{let a=Math.max(2,Math.min(t,r.kp/9*t)),i=t-a,d=l*n,p=r.kp>=6?"#e05c5c":r.kp>=5?"#e0a84a":r.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${i.toFixed(1)}" width="${(n-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${r.kp.toFixed(1)} \xB7 ${u(xe(r.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${s} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function We(e,s,t,o,n){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,r=Math.min(...e),l=Math.max(...e),a=l-r||1,i=g=>o-2-(g-r)/a*(o-4),d=e.map((g,h)=>`${(h/(e.length-1)*c).toFixed(1)},${i(g).toFixed(1)}`).join(" "),p="";if(n&&r<0&&l>0){let g=i(0);p=`<line x1="0" y1="${g.toFixed(1)}" x2="${c}" y2="${g.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let m=e.map((g,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${o}" fill="transparent"><title>${u(s[h]||"")} \xB7 ${g.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${o}" style="width:100%;height:${o}px;display:block" preserveAspectRatio="none">
    ${p}
    ...
    ${i}
  </svg>`}function pe(e){return`<div class="hw-kpi-popover-title">
    <span>${e}</span>
    <button class="hw-kpi-popover-close hw-kpi-close" aria-label="Close">\u2715</button>
  </div>`}function Ft(e){var i;let s=(i=e.metrics.wind_history_1h)!=null?i:[],t=s[s.length-1],o=e.metrics.solar_wind_kms,n=o!=null?`${Math.round(o)} km/s`:"\u2014",c=o!=null?o>=700?"#e05c5c":o>=500?"#e0a84a":o>=400?"#d4cc5c":"#5cce8c":"#607880",r=(t==null?void 0:t.density)!=null?`${t.density.toFixed(2)} cm\u207B\xB3`:"\u2014",l=(t==null?void 0:t.temp_kk)!=null?`${t.temp_kk.toFixed(0)} kK`:"\u2014",a=(t==null?void 0:t.pressure_npa)!=null?`${t.pressure_npa.toFixed(2)} nPa`:"\u2014";return`<div class="hw-kpi-popover">
    ${pe("Solar Wind \xB7 Current")}
    ...
    <div class="hw-kpi-hint" style="margin-top:4px">Trend history: \u25B6 HISTORY</div>
  </div>`}function Rt(e){let a='<rect x="0" y="16" width="200" height="6" rx="3" fill="#1e2c30"/>',i=[-10,-5,5,10].map(_=>{let y=100+_/20*100;return`<line x1="${y.toFixed(1)}" y1="16" x2="${y.toFixed(1)}" y2="22" stroke="#2a3c42" stroke-width="1"/>`}).join(""),d='<line x1="100" y1="14" x2="100" y2="24" stroke="#3a4c52" stroke-width="1.5"/>';if(e==null)return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">${a}${i}${d}</svg>`;let p=e<=-10?"#e05c5c":e<=-5?"#e0a84a":e<0?"#d4b84a":e>=5?"#5cce8c":"#7acca8",m=Math.max(-20,Math.min(20,e)),g=100+m/20*100,h=3,w=m<0?g-h:100-h,v=Math.max(2*h,Math.abs(g-100)+2*h),b=`<rect x="${w.toFixed(1)}" y="16" width="${v.toFixed(1)}" height="6" rx="${h}" fill="${p}" opacity="0.82"/>`,x=5,f=15,$=f-x*1.1,S=`<polygon points="${g.toFixed(1)},${f.toFixed(1)} ${(g-x).toFixed(1)},${$.toFixed(1)} ${(g+x).toFixed(1)},${$.toFixed(1)}" fill="${p}"/>`,C=`<line x1="${g.toFixed(1)}" y1="${f.toFixed(1)}" x2="${g.toFixed(1)}" y2="${19 .toFixed(1)}" stroke="${p}" stroke-width="1" opacity="0.6"/>`,L=`<text x="${g.toFixed(1)}" y="31" text-anchor="middle" font-size="8" fill="${p}" font-weight="600">${e>=0?"+":""}${e.toFixed(1)}</text>`;return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">
    ${a}${i}${d}${b}${S}${C}${L}
  </svg>`}function Tt(e){var m;let s=e.metrics.imf_bz_nt,t=e.metrics.imf_bt_nt,o=e.metrics.solar_wind_kms,n=(m=e.metrics.pressure_npa)!=null?m:null,c=s!=null?s<=-10?"#e05c5c":s<=-5?"#e0a84a":s>=5?"#5cce8c":"#a0b4b8":"#607880",r=s!=null?(s>=0?"+":"")+s.toFixed(1)+" nT":"\u2014",l=t!=null?t.toFixed(1)+" nT":"\u2014",a=o!=null?`${Math.round(o)} km/s`:"\u2014",i=n!=null?`${n.toFixed(2)} nPa`:"\u2014",d=be(e),p=s!=null&&s<-5?{msg:"Southward IMF \xB7 Aurora favorable",color:"#5cce8c"}:s!=null&&s<0?{msg:"Weakly southward \xB7 Conditions may improve",color:"#d4cc5c"}:{msg:"Northward IMF \xB7 Stable magnetosphere",color:"#96a8b8"};return`<div class="hw-kpi-popover">
    ${pe("IMF Bz \xB7 Coupling")}
    ...
    <div style="font-size:.65em;color:#607880">Coupling: <span style="color:${d.color};font-weight:600">${u(d.coupling)}</span> \xB7 Trend history: \u25B6 Details</div>
  </div>`}function be(e){var a,i;let s=e.metrics.imf_bz_nt,t=(a=e.metrics.kp_latest)!=null?a:0,o=(i=e.metrics.solar_wind_kms)!=null?i:0,n,c,r;if(s!=null&&s<-5||t>=6)n="storm",c="#e05c5c",r="Storm conditions";else if(s!=null&&s<0||t>=4||o>=400){let d=s!=null&&s<0;n="active",c="#e0a84a",r=d?"Active coupling":"Elevated"}else n="stable",c="#5cce8c",r="Stable";let l;return s==null?l="Unknown":s>2?l="Closed":s>0?l="Minimal":s>-5?l="Moderate":s>-10?l="Strong":l="Very strong",{state:n,color:c,label:r,coupling:l}}function zt(e,s,t,o){let n=o?"mc":"mf",c=e.color,r=t!=null?t:0,l=r>500,a=r<350,i=l?.9:a?1.8:1.3;if(o){let h=45-(e.state==="storm"?11:e.state==="active"?16:21),w=e.state==="storm"?12:e.state==="active"?10:8,v=50-w,b=76,x=[`M ${h},25`,`C ${h-2},15 41,${w} 45,${w}`,`C 53,${w} ${b-8},${w+4} ${b},20`,`C ${b+1},23 ${b+1},27 ${b},30`,`C ${b-8},${v-4} 53,${v} 45,${v}`,`C 41,${v} ${h-2},35 ${h},25`,"Z"].join(" "),f=l?3:2,$=[14,25,36],S=_=>`<path d="M 0,${_} L ${l?8:6},${_} M ${l?6:4},${_-2} L ${l?8:6},${_} L ${l?6:4},${_+2}" stroke="${c}bb" stroke-width="${l?1.4:1}" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`,C=$.map(_=>S(_)).join(""),k=Array.from({length:f},(_,y)=>`<g class="hw-wg" style="animation-duration:${i}s;animation-delay:${(i/f*y).toFixed(2)}s">${C}</g>`).join(""),L=s==null?"":s>0?`<path d="M 45,27 L 45,23 M ${45-1.5},${25-.5} L 45,23 L ${45+1.5},${25-.5}" stroke="#5cce8c" stroke-width="1" fill="none" stroke-linecap="round"/>`:`<path d="M 45,23 L 45,27 M ${45-1.5},${25+.5} L 45,27 L ${45+1.5},${25+.5}" stroke="#e05c5c" stroke-width="1" fill="none" stroke-linecap="round"/>`;return`<svg viewBox="0 0 80 50" style="width:78px;height:49px;display:block" xmlns="http://www.w3.org/2000/svg">
      ...
      ${L}
    </svg>`}else{let b=e.state==="storm"?16:e.state==="active"?26:38,x=155-b,f=e.state==="storm"?22:e.state==="active"?30:40,$=120-f,S=240,C=[`M ${x},60`,`C ${x-4},42 150,${f} 155,${f}`,`C 173,${f} ${S-5},${f+18} ${S},60`,`C ${S-5},${$-18} 173,${$} 155,${$}`,`C 150,${$} ${x-4},78 ${x},60`,"Z"].join(" "),k=`M ${x+2},60 C ${x+2},${60-b*.4} 152,54 150,60 C 152,66 ${x+2},${60+b*.4} ${x+2},60 Z`,L=r>700?"#e05c5c":r>500?"#e0a84a":r>350?"#d4c840":"#5cce8c",_=r>700?.4:r>500?.65:r>350?1.1:1.8,y=r>500?[10,24,40,57,74,90,106]:r>350?[14,34,57,82,104]:[20,50,82,108],H=16,R=22,U=x-6,X=Math.ceil((U-R)/H)+2,K=Array.from({length:X},(T,A)=>R-H+A*H),N=12,Y=8,W=K.flatMap(T=>y.map(A=>`<path d="M ${T},${A} L ${T+N},${A} M ${T+Y},${A-3} L ${T+N},${A} L ${T+Y},${A+3}" stroke="${L}cc" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`)).join(""),M=`<g class="hw-wg-full" style="animation-duration:${_}s">${W}</g>`,E=s==null?"":s>0?'<path d="M 155,64 L 155,56 M 153,58 L 155,56 L 157,58" stroke="#5cce8c" stroke-width="1.3" fill="none" stroke-linecap="round"/>':'<path d="M 155,56 L 155,64 M 153,62 L 155,64 L 157,62" stroke="#e05c5c" stroke-width="1.3" fill="none" stroke-linecap="round"/>',q=s==null?"":`<text x="163" y="62" font-size="6" fill="${s>0?"#5cce8c":"#e05c5c"}" font-family="monospace">Bz${s>0?"\u2191":"\u2193"}</text>`;return $e("magnetosphere",{magnetInfo:e,bz:s,windKms:t,uid:n})}}function $e(e,s={}){var M,E,q,T,A,Z;let c=(M=s.uid)!=null?M:"hse",r=0,l=160,a=800,i=17,d=a-i,p=s.magnetInfo,m=(E=p==null?void 0:p.state)!=null?E:"stable",g=(q=p==null?void 0:p.color)!=null?q:"#e0a84a",w=a-(m==="storm"?55:m==="active"?80:110),v=m==="storm"?58:m==="active"?76:95,b=1120,x=20,f=[`M ${w},130`,`C ${w-8},${130-v*.55} ${a-18},${130-v} ${a},${130-v}`,`C ${a+120},${130-v} ${b-180},${130-x} ${b},${130-x}`,`L ${b},${130+x}`,`C ${b-180},${130+x} ${a+120},${130+v} ${a},${130+v}`,`C ${a-18},${130+v} ${w-8},${130+v*.55} ${w},130`,"Z"].join(" "),$=e==="magnetosphere",S=$?m==="storm"?"0.12":"0.08":"0.04",C=$?"0.75":"0.28",k=`<g id="${c}-base-sun">
    ...
    <line x1="${d}" y1="130" x2="${a+i}" y2="130"
          stroke="#4a8ab0" stroke-width="1.2" opacity="0.35"/>`,_=`<g id="${c}-base-earth">
    ...
    <line x1="${l}" y1="130" x2="${w}" y2="130"
  ...
  </g>`,R="";if(e==="magnetosphere"){let I=(T=s.windKms)!=null?T:0,P=I>500,j=I<350,F=(P?.5:j?1.4:.9)*1.3,G=I>700?"#e05c5c":I>500?"#e0a84a":I>350?"#d4c840":"#5cce8c",Q=l+8,J=w-14,B=8,z=6,D=(J-Q)/(B-1),oe=260/(z+1),ne=38,ee=24,ce=2,Le=Array.from({length:B},(se,de)=>{let re=Q+de*D,ve=Array.from({length:z},(ie,le)=>{let V=oe*(le+1);return`<path d="M ${re.toFixed(1)},${V.toFixed(1)} L ${(re+ne).toFixed(1)},${V.toFixed(1)} M ${(re+ee).toFixed(1)},${(V-6).toFixed(1)} L ${(re+ne).toFixed(1)},${V.toFixed(1)} L ${(re+ee).toFixed(1)},${(V+6).toFixed(1)}"
          stroke="${G}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:ce},(ie,le)=>{let V=-((B-de)/B*F)-le*F/ce;return`<g style="opacity:.12;animation:hw-arrow-chase ${F}s linear ${V.toFixed(3)}s infinite">${ve}</g>`}).join("")}).join(""),ae=(A=s.bz)!=null?A:null,te=ae==null?"":(()=>{let se=ae>0?"#5cce8c":"#e05c5c";return`${ae>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
        ...
        fill="${se}" font-family="monospace">Bz${ae>0?"\u2191":"\u2193"}</text>`})();R=`${Le}${te}`}let U=`<g id="${c}-overlay-solar-wind">${R}</g>`,X="";if(e==="coronal_hole"&&s.hssState){let I=s.hssState,P=(Z=I.speed)!=null?Z:0,j=P>=420,F=I.color,G=j?"0.85":"0.25",Q=P>=500?"0.18":j?"0.10":"0.04",J=l+8,B=d-16,z=60,D=`${J},130 ${B},${130-z} ${B},${130+z}`,oe=B+6,ne=`${oe},120 ${oe+18},130 ${oe},140`;X=`
    <polygon points="${D}" fill="${F}" opacity="${Q}"/>
    <line x1="${J}" y1="130" x2="${B-5}" y2="130"
          stroke="${F}" stroke-width="3.5" stroke-dasharray="10 6"
          stroke-linecap="round" opacity="${G}"/>
    <polygon points="${ne}" fill="${F}" opacity="${j?"0.9":"0.25"}"/>`}let K=`<g id="${c}-overlay-coronal-hole">${X}</g>`,N="";if(e==="cme_cone"&&s.cmeState){let I=s.cmeState,P=l,j=d-10,F=j-P,G=D=>Math.tan(D*Math.PI/180),Q=Math.round(G(9)*F),J=Math.round(G(6)*F),B=Math.round(G(3)*F),z=D=>`${P},130 ${j},${130-D} ${j},${130+D}`;if(I.status!=="quiet"){let D=I.status==="impact"?"#e05c5c":"#d4cc5c";N=`
    ...
    <line x1="${P+14}" y1="130" x2="${j-5}" y2="130"
    ...
    <line x1="${P+14}" y1="130" x2="${d-14}" y2="130"
          stroke="#1e2c30" stroke-dasharray="7 5" stroke-width="2"/>`}let Y=`<g id="${c}-overlay-cme-cone">${N}</g>`,W=`<g id="${c}-overlay-labels">
    ...
    <div class="hw-kpi-hint" style="margin-bottom:0">${u(g)}</div>
  </div>`}function Qe(e,s,t){if(!e.length)return null;let o=(t%360+360)%360,n=-1,c=1/0,r=Math.cos(s*Math.PI/180);for(let l of e){let a=l.lat-s,i=(l.lon-o+180+360)%360-180,d=a*a+i*r*(i*r);d<c&&(c=d,n=l.prob)}return n>=0?n:null}function Ve(e){return`<svg viewBox="0 0 100 100" width="100%" height="100%"
    style="position:absolute;top:0;left:0;pointer-events:none">${['<text x="50" y="4"   font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">N</text>','<text x="96"  y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">W</text>','<text x="50" y="97"  font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">S</text>','<text x="4"   y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">E</text>'].join("")}</svg>`}function Bt(e,s){let t=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,o=null;s&&e.lat!=null&&e.lon!=null&&(o=Qe(s.entries,e.lat,e.lon));let n=e.lat!=null&&e.lon!=null,c=o!=null?o>=30?"#5cce8c":o>=10?"#d4cc5c":"#9ab4bc":"#607880",r=o!=null?`${o}%`:s?"n/a":"\u2026",l=n?`
    ...
    ${pe("Aurora Oval \xB7 Northern Hemisphere")}
  ...
  </div>`}function Dt(e,s,t,o){switch(s){case"solar_wind":return Ft(e);case"xray":return Ot(e);case"imf_bz":return Tt(e);case"aurora":return Bt(t,o);case"magnetosphere":return Nt(e);default:return""}}function Yt(e,s){if(e.length<2)return"\u2192";let t=e[e.length-1],o=Math.max(0,e.length-4),n=e[o];if(!isFinite(t)||!isFinite(n))return"\u2192";let c=t-n;return c>s?"\u2191":c<-s?"\u2193":"\u2192"}var Wt={quiet:"171",active:"195",elevated:"284",storm:"304"};function jt(e,s){var o,n,c;if(s==null)return(n=(o=e.summary)==null?void 0:o.status)!=null?n:"quiet";let t=parseInt(((c=s.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":s.kp>=4?"active":"quiet"}function Gt(e,s){var i,d;let t=(i=Wt[e])!=null?i:"171",o=`/assets/gifs/current_eit_${t}.gif`,n=cs(o,s),c=ps,r=(d=we[e])!=null?d:we.quiet,l=`${r.accent}44`,a=`0 0 10px ${r.accent}55,0 0 24px ${r.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
  ...
  </div>`}function Ut(e,s,t,o,n){var f,$,S;let{summary:c,metrics:r}=e,l=(f=we[c.status])!=null?f:we.quiet,a=t!=null?t.kp.toFixed(1):r.kp_latest!=null?r.kp_latest.toFixed(1):"\u2014",i=Lt(e,t),p=[{key:"G",text:i.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:i.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:i.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${i.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(C=>{let k;return C.key==="G"?k=_e(ke(i.g,"G")):C.key==="R"?k=_e(ke(i.r,"R")):C.key==="S"?k=_e(ke(i.s,"S")):k=Mt(i.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${k.color};background:${k.background};border-color:${k.borderColor}`}" data-hero-chip="${C.key}" title="${O(C.title)}" aria-label="${O(C.aria)}">${u(C.text)}</button>`}).join(""),m=Yt((($=r.kp_history_1h)!=null?$:[]).map(C=>C.kp),.5),g=(S=r.kp_latest)!=null?S:0,h=g>=5,w=h?`linear-gradient(160deg, #0d2a1a 0%, ${l.bg}22 75%)`:`${l.bg}18`,v=jt(e,t),x=h?`
    ...
    <div class="hw-hero" style="background:${w}">
      <div class="hw-hero-main">
        <div class="hw-kp-col">
          ...
          <span class="hw-status-badge" style="background:${l.accent}22;color:${l.accent};display:block;text-align:center">${u(c.label)}</span>
      ...
      ${x}
    </div>`}function Xt(e){var d,p,m,g;let{metrics:s}=e,t=(d=s.kp_history_1h)!=null?d:[],o=(p=s.wind_history_1h)!=null?p:[],n=(m=s.bz_history_1h)!=null?m:[],c=(g=s.xray_history_1h)!=null?g:[],r=It(t),l=We(o.map(h=>{var w;return(w=h.kms)!=null?w:0}).filter(h=>h>0),o.map(h=>xe(h.t_utc)),"#5cce8c",28,!1),a=We(n.map(h=>h.bz),n.map(h=>xe(h.t_utc)),"#d4cc5c",28,!0),i=At(c);return`
    ...
    </div>`;let b=320,x=38,f=14,$=x+f,S=b/d,C=M=>x-Math.max(2,Math.min(x-2,M/9*(x-2))),k="",L=i.map(M=>M.kp),_=qt(L);i.forEach((M,E)=>{let q=C(M.kp),T=x-q,A=E*S,Z=A+S/2,I=M.kp>=6?"#e05c5c":M.kp>=5?"#e0a84a":M.kp>=4?"#d4cc5c":"#5cce8c",P=`Kp ${M.kp.toFixed(1)} \xB7 ${ue(M.t_utc)}`;if(k+=`<rect x="${A.toFixed(1)}" y="${q.toFixed(1)}" width="${(S-1.5).toFixed(1)}" height="${T.toFixed(1)}" fill="${I}" fill-opacity="0.85" rx="1.5"/>`,k+=`<rect x="${A.toFixed(1)}" y="0" width="${S.toFixed(1)}" height="${x}" fill="transparent"><title>${O(P)}</title></rect>`,d<=8||E%2===0){let F=new Date(M.t_utc).getHours();k+=`<text x="${Z.toFixed(1)}" y="${($-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${F.toString().padStart(2,"0")}</text>`}});let H=`<polyline points="${i.map((M,E)=>{let q=E*S+S/2,T=C(_[E]);return`${q.toFixed(1)},${T.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,R="";if(s>0&&d>0){let M=Math.min(b-1,s/(d*3)*b);R=`
      <line x1="${M.toFixed(1)}" y1="0" x2="${M.toFixed(1)}" y2="${x}" stroke="rgba(255,255,255,0.75)" stroke-width="1.5" stroke-dasharray="3,2"/>
      <polygon points="${M.toFixed(1)},${x} ${(M-4).toFixed(1)},${(x-7).toFixed(1)} ${(M+4).toFixed(1)},${(x-7).toFixed(1)}" fill="rgba(255,255,255,0.75)"/>`}let U=Math.round(p/4),X=Math.round(p/2),K=Math.round(p*3/4),N=`
    ...
    <div class="hw-forecast">
      ...
      ${N}`:""}
    </div>`}function ts(e){let s=/([NS])(\d+)([EW])(\d+)/i.exec(e);return s?{lat:(s[1].toUpperCase()==="N"?1:-1)*parseInt(s[2],10),lon:(s[3].toUpperCase()==="E"?1:-1)*parseInt(s[4],10)}:null}var Je=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function ss(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function os(e,s,t){let o=s/2,n=o*.87,c=s*.03,r=s*.009,l=e.map(a=>{var b,x;let i=ts(a.location);if(!i||Math.abs(i.lon)>88||a.location.includes("*"))return"";let d=ss(a);if(!t.has(d))return"";let p=Je.find(f=>f.id===d).color,m=i.lat*Math.PI/180,g=i.lon*Math.PI/180,h=(o+n*Math.cos(m)*Math.sin(g)).toFixed(1),w=(o-n*Math.sin(m)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
    ...
    <div class="hw-radio-meta">X-ray: <b style="color:${(p=fe[o])!=null?p:"#a0b4b8"}">${u(o)}-class</b> \xB7 ${u(c)}</div>
  </div>`}var tt={g1:"#d4cc5c",g2:"#e0a84a",g3:"#e05c5c"};function st(e){var l;let s=(l=e.metrics.kp_forecast_3h)!=null?l:[],t=Date.now(),o=t+24*60*60*1e3,n=s.filter(a=>{let i=new Date(a.t_utc).getTime();return i>=t-3*60*60*1e3&&i<=o});if(n.length===0)return{g1:0,g2:0,g3:0};let c=Math.max(...n.map(a=>a.kp)),r=a=>{if(c<a-.7)return 0;if(c>a+1)return 90;let i=(c-(a-.7))/1.7;return Math.round(Math.pow(Math.max(0,i),.7)*90)};return{g1:r(5),g2:r(6),g3:r(7)}}var je={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function us(e){var i,d,p;let s=(i=e.metrics.kp_latest)!=null?i:0,t=e.metrics.imf_bz_nt,o=e.metrics.solar_wind_kms,n=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,c=s>=5||n>=1,r=(p=e.metrics.kp_history_1h)!=null?p:[],l=0;if(r.length>=2&&(l=r[r.length-1].kp-r[r.length-2].kp),!c)return{active:!1,phase:"quiet",kp_current:s,kp_trend:l,bz_nt:t,solar_wind_kms:o};let a;return l>.3&&(t==null||t<-5)?a="rising":l<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:s,kp_trend:l,bz_nt:t,solar_wind_kms:o}}function gs(e){if(!e.active)return"";let s=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=s.findIndex(l=>l.key===e.phase),o=je[e.phase],n=s[t].label,c=s.map((l,a)=>{let i=a===t,d=a<t,p=je[l.key],m=i?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",g=i?" hw-spi-dot-active":"",h=i?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",w=a<s.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
  ...
  </div>`}function ws(e,s){let t=st(e),o=us(e),n=(()=>{var g;let i=(g=e.metrics.kp_forecast_3h)!=null?g:[],d=Date.now(),p=d+24*60*60*1e3,m=i.filter(h=>new Date(h.t_utc).getTime()<=p);return m.length?Math.max(...m.map(h=>h.kp)):null})(),r=[{key:"g1",label:"G1"},{key:"g2",label:"G2"},{key:"g3",label:"G3"}].map(({key:i,label:d})=>{let p=t[i],m=tt[i];return`<div class="hw-gstorm-row">
  ...
  </div>`}var ge={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},ot={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function xs(e){var _;let s=ge,t=(_=ot[s.phase])!=null?_:"#96a8b8",o=s.phase.charAt(0).toUpperCase()+s.phase.slice(1),n=280,c=52,r=10,l=c-6,a=c-18,i=.5,d=.19,p=y=>Math.exp(-Math.pow((y-i)/d,2)/2),m=y=>r+y*(n-2*r),g=y=>l-p(y)*a,h=80,w=[];for(let y=0;y<=h;y++){let H=y/h;w.push(`${y===0?"M":"L"}${m(H).toFixed(1)},${g(H).toFixed(1)}`)}let v=Math.round(s.progress_0_1*h),b=[];for(let y=0;y<=v;y++){let H=y/h;b.push(`${y===0?"M":"L"}${m(H).toFixed(1)},${g(H).toFixed(1)}`)}let x=m(s.progress_0_1),f=[`M${r},${l}`,...b.slice(1),`L${x.toFixed(1)},${l} Z`],$=g(s.progress_0_1),S=5,C=`M${x.toFixed(1)},${$.toFixed(1)} L${(x-S).toFixed(1)},${($-S*1.8).toFixed(1)} L${(x+S).toFixed(1)},${($-S*1.8).toFixed(1)} Z`,k=l+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
  ...
  </div>`}function nt(e){var a,i,d,p,m;let s=(i=(a=e.coronal_hole)==null?void 0:a.estimated_speed_kms)!=null?i:e.metrics.solar_wind_kms,t=(d=e.coronal_hole)==null?void 0:d.status,o=s!=null?s:0,n=t!=null?t:o>=600?"strong":o>=500?"active":o>=420?"watch":"quiet",c={strong:"#e05c5c",active:"#e0a84a",watch:"#d4cc5c",quiet:"#5cce8c"},r={strong:"Strong",active:"Active",watch:"Watch",quiet:"None"},l={strong:"Strong high-speed stream",active:"High-speed stream active",watch:"Elevated solar wind",quiet:"Background solar wind"};return{status:n,color:c[n],label:r[n],desc:(m=(p=e.coronal_hole)==null?void 0:p.note)!=null?m:l[n],speed:s}}function fs(e,s){var i;let t=nt(e),o=(i=t.speed)!=null?i:0,n=t.speed!=null?`${Math.round(t.speed)} km/s`:"\u2014",c=s?" hw-impact-tip-open":"",r=o>=420,l=$e("coronal_hole",{hssState:t,uid:"hss"}),a=r?'<div class="hw-hss-meta" style="font-size:.72em">Elevated speed may indicate Earth-facing coronal hole stream</div>':'<div class="hw-hss-meta" style="font-size:.72em">Background solar wind \xB7 no HSS detected</div>';return`<div class="hw-impact-tip${c}">
    ${l}
    <div class="hw-hss-meta">Solar wind: <b style="color:${t.color}">${u(n)}</b> \xB7 ${u(t.desc)}</div>
    ${a}
  </div>`}function at(e){var n,c;let s=(n=e.scales.g_scale)!=null?n:"G0",t=parseInt(s.slice(1),10),o=e.metrics.kp_latest;if(o==null){let r=(c=e.metrics.kp_forecast_3h)!=null?c:[],l=Date.now(),a=r.filter(i=>new Date(i.t_utc).getTime()<=l+3*60*60*1e3).sort((i,d)=>new Date(d.t_utc).getTime()-new Date(i.t_utc).getTime());a.length>0&&(o=a[0].kp)}return t>=2||o!=null&&o>=6?{level:2,color:"#e05c5c",label:"High",kp:o,gScale:s}:t>=1||o!=null&&o>=4?{level:1,color:"#d4cc5c",label:"Moderate",kp:o,gScale:s}:{level:0,color:"#5cce8c",label:"Low",kp:o,gScale:s}}function bs(e,s){let t=at(e),o=s?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c",width:33,desc:"Normal density"},{l:1,label:"Moderate",color:"#d4cc5c",width:64,desc:"Elevated density"},{l:2,label:"High",color:"#e05c5c",width:100,desc:"Strong expansion"}].map(a=>{let i=a.l===t.level,d=i?a.color:"#566068",p=i?"0.88":"0.16";return`<div class="hw-satdrag-rung">
  ...
  </div>`}function rt(e){var i,d,p;let s=(i=e.scales.g_scale)!=null?i:"G0",t=parseInt(s.slice(1),10),o=e.metrics.kp_latest;if(o==null){let m=(d=e.metrics.kp_forecast_3h)!=null?d:[],g=Date.now(),h=m.filter(w=>new Date(w.t_utc).getTime()<=g+3*60*60*1e3).sort((w,v)=>new Date(v.t_utc).getTime()-new Date(w.t_utc).getTime());h.length>0&&(o=h[0].kp)}let n=0;t>=2||o!=null&&o>=6?n=2:(t>=1||o!=null&&o>=4)&&(n=1);let c=parseInt(((p=e.scales.r_scale)!=null?p:"R0").slice(1),10),r=c>=2&&n<2;c>=2&&(n=Math.min(2,n+1));let l={0:"#5cce8c",1:"#d4cc5c",2:"#e05c5c"},a={0:"Low",1:"Moderate",2:"High"};return{level:n,color:l[n],label:a[n],kp:o,gScale:s,boostedByFlare:r}}function $s(e,s){var i;let t=rt(e),o=s?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c",width:33},{l:1,label:"Moderate",color:"#d4cc5c",width:64},{l:2,label:"High",color:"#e05c5c",width:100}].map(d=>{let p=d.l===t.level,m=p?d.color:"#566068",g=p?"0.88":"0.16";return`<div class="hw-gnss-rung">
    ...
    ${a}
  </div>`}function it(e){var n;let s=e.metrics.pressure_npa,t=s!=null?s:null,o=(n=e.metrics.density)!=null?n:null;return t==null?{pressure:null,color:"#607880",label:"\u2014",density:o}:t>=6?{pressure:t,color:"#e05c5c",label:"Extreme",density:o}:t>=4?{pressure:t,color:"#e0a84a",label:"Strong",density:o}:t>=2?{pressure:t,color:"#d4cc5c",label:"Elevated",density:o}:t>=1?{pressure:t,color:"#5cce8c",label:"Typical",density:o}:{pressure:t,color:"#7a9298",label:"Weak",density:o}}function vs(e,s){let t=it(e),o=s?" hw-impact-tip-open":"",n=t.pressure,c=200,r=6,l=10,a=r+l,i=a+4,d=i+11,p=a+9,m=d+4,h=[{x:0,w:50,color:"#5cce8c"},{x:50,w:50,color:"#d4cc5c"},{x:100,w:50,color:"#e0a84a"},{x:150,w:50,color:"#e05c5c"}].map(_=>`<rect x="${_.x}" y="${r}" width="${_.w}" height="${l}" fill="${_.color}" opacity="0.55" rx="0"/>`).join(""),w=[{x:0,label:"0",anchor:"start"},{x:50,label:"2",anchor:"middle"},{x:100,label:"4",anchor:"middle"},{x:150,label:"6",anchor:"middle"},{x:200,label:"8+",anchor:"end"}],v=w.map(_=>`<line x1="${_.x}" y1="${a}" x2="${_.x}" y2="${i}" stroke="#3a5058" stroke-width="1"/>`).join(""),b=w.map(_=>`<text x="${_.x}" y="${d}" class="hw-swdp-axlabel" text-anchor="${_.anchor}">${_.label}</text>`).join(""),x="";if(n!=null){let y=Math.min(Math.max(n,0),8)/8*c;x=`<polygon points="${`${y-5},${p} ${y+5},${p} ${y},${a}`}" fill="${t.color}" opacity="0.95"/>
    <line x1="${y}" y1="${r}" x2="${y}" y2="${a}" stroke="${t.color}" stroke-width="1.5" opacity="0.7"/>`}let f=`<rect x="0" y="${r}" width="${c}" height="${l}" fill="none" stroke="#2a3c42" stroke-width="0.8" rx="0"/>`,$=`<svg class="hw-swdp-gauge" viewBox="0 0 ${c} ${m}" preserveAspectRatio="none" aria-hidden="true">
    ${h}${f}${x}${v}${b}
    ...
    <div class="hw-cme-footer">${r}</div>
      ...
      <div class="hw-impact-tip${p}">${Dt(r,e,l,a)}</div>
    </div>`}function ks(e,s){let t=e.find(c=>c.kind==="aurora");if(t)return t;let o=s.aurora_hint;return{kind:"aurora",level:o.aurora_label==="good"?"moderate":o.aurora_label==="possible"?"low":"none",label:"Aurora",summary:o.summary}}function _s(e,s,t,o){var x,f;let n=(x=Ke[e.level])!=null?x:"#666",c=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),r=(f=Me[e.kind])!=null?f:et,l=e.level==="none"?"#606870":n,a=s.has("aurora"),i=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,m=null;t&&o.lat!=null&&o.lon!=null&&(m=Qe(t.entries,o.lat,o.lon));let g=o.lat!=null&&o.lon!=null,h=m!=null?m>=30?"#5cce8c":m>=10?"#d4cc5c":"#9ab4bc":"#607880",w=m!=null?`${m}%`:t?"n/a":"\u2026",v=g?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
    ...
    ${b}
  </div>`}function Ge(e,s,t,o,n,c){var w,v;let r=(w=Ke[e.level])!=null?w:"#666",l=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Me[e.kind])!=null?v:et,i=e.level==="none"?"#606870":r,d=e.kind==="solar_activity"?t:c,p=d?" hw-impact-open":"",m;if(e.kind==="solar_activity"){let b=t?" hw-solar-open":"",x=Je.map(f=>{let $=o.has(f.id),S=$?f.color+"22":"transparent",C=$?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${S};opacity:${C}">${f.label}</button>`}).join("");m=`<div class="hw-solar-tip${b}">
      ...
      </div>`}else m=ms(n,d);let g=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${O(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${g}>
    <span class="hw-impact-caret">\u25B6</span>
    <span class="hw-impact-kind" style="color:${i}">${a}<span style="color:#b4c6cc">${u(e.label)}</span></span>
    <span class="hw-impact-badge" style="background:${r}22;color:${r}">${u(l)}</span>
    ${m}
  </div>`}function Ss(e,s,t,o,n,c,r,l,a){var Ee,Ie,Ae,Fe;let i=(Ie=(Ee=s==null?void 0:s.impacts)!=null?Ee:e.observer_impacts)!=null?Ie:[],d=ks(i,e),p=_s(d,r,l,a),m=i.find(ye=>ye.kind==="radio"),g=i.find(ye=>ye.kind==="solar_activity"),h=m?Ge(m,t,n,c,e,r.has("radio")):"",w=g?Ge(g,t,n,c,e,!1):"",x=`
    <div class="hw-section-row" data-impacts-toggle>
    ...
    </div>`,{metrics:f}=e,$=f.xray_class,S=$?(Ae=fe[$])!=null?Ae:"#a0b4b8":"#607880",C=$?`${$}-class`:"\u2014",k=f.imf_bz_nt,L=k!=null?k<=-10?"#e05c5c":k<=-5?"#e0a84a":k>=5?"#5cce8c":"#a0b4b8":"#607880",_=k!=null?(k>=0?"+":"")+k.toFixed(1)+" nT":"\u2014",y=f.solar_wind_kms,H=y!=null?`${Math.round(y)} km/s`:"\u2014",R=y!=null?y>700?"#e05c5c":y>500?"#e0a84a":y>400?"#d4cc5c":"#5cce8c":"#607880",U=Se("xray","X-Ray",ns,C,S,r,e,a,l),X=Se("imf_bz","IMF Bz",as,_,L,r,e,a,l),K=Se("solar_wind","Solar Wind",rs,H,R,r,e,a,l),N='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',Y=r.has("geomag_storm"),W=st(e),M=W.g1,E=W.g1>=30?tt.g1:W.g1>0?"#7a9298":"#607880",q=M>0?`G1 ${M}%`:"None",A=`<div class="hw-impact-row${Y?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${ws(e,Y)}
    </div>`,Z=r.has("solar_cycle"),I=(Fe=ot[ge.phase])!=null?Fe:"#96a8b8",P=ge.phase.charAt(0).toUpperCase()+ge.phase.slice(1),F=`<div class="hw-impact-row${Z?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      <span class="hw-impact-kind" style="color:${I}"><svg viewBox="0 0 13 13" width="13" height="13" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.3"><path d="M1 9 Q3 4 6.5 4 Q10 4 12 9"/><circle cx="6.5" cy="4" r="1.3" fill="currentColor" stroke="none"/></svg><span style="color:#b4c6cc">Solar Cycle</span></span>
      <span class="hw-impact-badge" style="background:${I}22;color:${I}">${P}</span>
      ${xs(Z)}
    </div>`,G=nt(e),Q=r.has("hss"),B=`<div class="hw-impact-row${Q?" hw-impact-open":""}" data-impact-row="hss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      <span class="hw-impact-badge" style="background:${G.color}22;color:${G.color}">${G.label}</span>
      ${fs(e,Q)}
    </div>`,z=at(e),D=r.has("sat_drag"),ne=`<div class="hw-impact-row${D?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${bs(e,D)}
    </div>`,ee=rt(e),ce=r.has("gnss"),ae=`<div class="hw-impact-row${ce?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${$s(e,ce)}
    </div>`,te=it(e),se=r.has("sw_pressure"),de=te.pressure!=null?`${te.pressure.toFixed(2)} nPa`:"\u2014",ve=`<div class="hw-impact-row${se?" hw-impact-open":""}" data-impact-row="sw_pressure">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${vs(e,se)}
    </div>`,ie=lt(e),le=r.has("cme_cone"),dt=`<div class="hw-impact-row${le?" hw-impact-open":""}" data-impact-row="cme_cone">
      <span class="hw-impact-caret">\u25B6</span>
...
${t.join(" \xB7 ")}`}function Is(e,s,t){var a;let o=e.is_active?Ls:(a=Ms[e.level])!=null?a:"#445c64",n=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",r=e.source==="NASA_DONKI"?"DONKI":"SWPC",l=n?`<div class="hw-tl-detail">${u(e.description)}${u(Es(e))}</div>`:"";return`
    ...
    </div>`}function As(e,s,t,o){var b,x;let n=(b=e.timeline)!=null?b:[],c=Date.now(),r=new Date(c).toISOString().slice(0,10),l=new Date(c-864e5).toISOString().slice(0,10),a=new Date(c-1728e5).toISOString().slice(0,10),i=new Set([r,l,a]),d=n.filter(f=>{var $;return i.has((($=f.event_time)!=null?$:"").slice(0,10))}).slice().reverse(),p=d.length,m=t?"\u25BC":"\u25B6",g=p>0?`Solar Activity Timeline (${p})`:"Solar Activity Timeline",h=`
    ...
    </div>`;if(!t||p===0)return`<div class="hw-timeline">${h}</div>`;let w=new Map;for(let f of d){let $=((x=f.event_time)!=null?x:"").slice(0,10);w.has($)||w.set($,[]),w.get($).push(f)}let v=[...w.entries()].map(([f,$])=>{let C=new Date(f+"T12:00:00Z").toLocaleDateString("en-US",{month:"short",day:"numeric",timeZone:"UTC"}),k=o.has(f),L=k?"\u25B6":"\u25BC",_=k?`<span class="hw-tl-day-count">${$.length} events</span>`:"",y=`
      <div class="hw-tl-day-row" data-tl-day="${O(f)}">
        <span class="hw-section-caret">${L}</span>
        <span class="hw-tl-date">${C}</span>
        ${_}
      </div>`,H=k?"":$.map((R,U)=>Is(R,U<$.length-1,s)).join("");return`<div class="hw-tl-group">${y}${H}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Fs(e,s,t){var i;let o=(i=e.alerts_all)!=null?i:[],n=o.length,c=s?"\u25BC":"\u25B6",r=n>0?`SWPC Alerts (${n})`:"SWPC Alerts",l=`
    ...
    <div class="hw-alerts">
      ${l}
      ${a}
    </div>`}function Os(e,s){var X,K,N;let t=e.cme_tracker;if(!t)return"";let o=(X=vt[t.impact_level])!=null?X:"#96a8b8",n=(K=yt[t.status])!=null?K:t.status,c=300,r=44,l=18,a=r/2,i=10,d=c-18,p=7,m=`<line x1="${l+i}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,g=`<circle cx="${l}" cy="${a}" r="${i}" fill="#f0c040" opacity="0.92"/>`,h=`
    <circle cx="${d}" cy="${a}" r="${p}" fill="#4a90c4" opacity="0.88"/>
    <circle cx="${d}" cy="${a}" r="2.5" fill="#fff" opacity="0.7"/>`,w=`<text x="${l}" y="${a+i+9}" text-anchor="middle" font-size="9" fill="#c8aa60">Sun</text>`,v=`<text x="${d}" y="${a+p+9}" text-anchor="middle" font-size="9" fill="#7ab0d4">Earth</text>`,b="";if(t.progress!=null){let Y=l+i+4,W=d-p-4,M=Y+t.progress*(W-Y),E=5;t.status==="arrival_window"?b=`
        ...
        </g>`:b=`<circle cx="${M.toFixed(1)}" cy="${a}" r="${E}" fill="${o}" opacity="0.85"/>`}let x=`<svg class="hw-cme-svg" viewBox="0 0 ${c} ${r}" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
    ${m}
    ${g}${w}
    ${h}${v}
    ${b}
  </svg>`,f=Pe(t.arrival_time_utc),$=Pe(t.launch_time_utc),S=t.speed_kms!=null?`${Math.round(t.speed_kms)} km/s`:"\u2014",C=t.half_angle_deg!=null?`${t.half_angle_deg}\xB0`:"\u2014",k=(N=t.source_location)!=null?N:"\u2014",L=t.is_earth_direct?"Direct hit":"Glancing blow",_=t.progress!=null?`${Math.round(t.progress*100)}%`:"\u2014",y=`
    ...
    </div>`,H=s?"\u25BC":"\u25B6",R=t.impact_level==="unknown"?"Unrated":t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1),U=s?`${x}${y}`:"";return`
    <div class="hw-cme">
      ...
      ${U}
    </div>`}function Rs(e,s,t,o,n,c,r,l,a,i,d,p,m,g,h,w,v,b){var L;let x=Jt(e,o),f=(L=e.metrics.kp_history_1h)!=null?L:[],$=f.length?ue(f[f.length-1].t_utc):null,S=$?`Recent history \xB7 Last step ${$}`:"Recent history",C=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    <span class="hw-section-caret">${t?"\u25BC":"\u25B6"}</span>
    <span class="hw-section-label" style="margin-bottom:0">${O(S)}</span>
  </div></div>`,k=t?Xt(e):"";return`
    <div class="hw-root">
      ${Kt(e)}
      ${Ut(e,t,x,v,b)}
      ${Ss(e,x,m,i,g,h,w,b,v)}
      ${C}
      ${k}
      ${es(e,o,x,p)}
      ${Os(e,d)}
      ${As(e,r,l,a)}
      ${Fs(e,n,c)}
    </div>`}function Ts(e){return`<div class="hw-root">
