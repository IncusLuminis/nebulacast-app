"use strict";var HelioWidgetModule=(()=>{var he=Object.defineProperty,lt=Object.defineProperties,dt=Object.getOwnPropertyDescriptor,pt=Object.getOwnPropertyDescriptors,ht=Object.getOwnPropertyNames,Oe=Object.getOwnPropertySymbols;var ze=Object.prototype.hasOwnProperty,mt=Object.prototype.propertyIsEnumerable;var Te=(e,o,t)=>o in e?he(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,me=(e,o)=>{for(var t in o||(o={}))ze.call(o,t)&&Te(e,t,o[t]);if(Oe)for(var t of Oe(o))mt.call(o,t)&&Te(e,t,o[t]);return e},ge=(e,o)=>lt(e,pt(o));var gt=(e,o)=>{for(var t in o)he(e,t,{get:o[t],enumerable:!0})},ut=(e,o,t,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of ht(o))!ze.call(e,n)&&n!==t&&he(e,n,{get:()=>o[n],enumerable:!(s=dt(o,n))||s.enumerable});return e};var wt=e=>ut(he({},"__esModule",{value:!0}),e);var jo={};gt(jo,{HelioWidget:()=>ct});var xe={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},qe={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},xt={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},$e={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},ft={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},$t={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function bt(e){if(!e)return"Update time unavailable";try{let o=Math.round((Date.now()-new Date(e).getTime())/6e4);if(o<1)return"Updated just now";if(o<60)return`Updated ${o} min ago`;let t=Math.floor(o/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(o){return"Updated recently"}}function vt(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function ue(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e}}function fe(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e.slice(11,16)}}function Ne(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function O(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Be={G:["aurora","storm_risk"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},yt=2400;function Qe(){var e,o;try{let t=(o=(e=globalThis.location)==null?void 0:e.hostname)!=null?o:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function kt(e){let o=[],t=null;for(let s of e){let n=document.getElementById(s);n instanceof HTMLElement?(t||(t=n),o.push(n)):Qe()&&console.warn(`[Helio] Hero chip nav: missing element #${s}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let s of o)s.classList.add("section-flash"),window.setTimeout(()=>s.classList.remove("section-flash"),yt)}function Pe(e){let o=e.trim();return o.toUpperCase().startsWith("X:")?o.slice(2).trim()||"\u2014":o||"\u2014"}function Se(e,o){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==o)return 0;let s=parseInt(t.slice(1),10);return!isFinite(s)||s<0?0:Math.min(5,s)}function Me(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function _t(e){var c,r,i;let o=e.trim().toUpperCase();if(o==="\u2014"||o===""||o==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=$e[o])!=null?c:"#a0b4b8",s={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},n={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(r=s[o])!=null?r:"#1e2830",borderColor:(i=n[o])!=null?i:"#3a4c52"}}function St(e,o){var c,r,i,a,l,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",s={g:(c=o==null?void 0:o.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Pe(t)},n=(r=e.hero)==null?void 0:r.scales;return n?{g:(i=n.g)!=null?i:s.g,r:(a=n.r)!=null?a:s.r,s:(l=n.s)!=null?l:s.s,x:Pe((d=n.x)!=null?d:s.x)}:s}var Mt=`
...
`,De=!1;function Ct(){if(De)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=Mt,document.head.appendChild(e),De=!0}function Ht(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.length,n=o/s,c=e.map((r,i)=>{let a=Math.max(2,Math.min(t,r.kp/9*t)),l=t-a,d=i*n,p=r.kp>=6?"#e05c5c":r.kp>=5?"#e0a84a":r.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${l.toFixed(1)}" width="${(n-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${r.kp.toFixed(1)} \xB7 ${u(fe(r.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function Ge(e,o,t,s,n){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,r=Math.min(...e),i=Math.max(...e),a=i-r||1,l=g=>s-2-(g-r)/a*(s-4),d=e.map((g,h)=>`${(h/(e.length-1)*c).toFixed(1)},${l(g).toFixed(1)}`).join(" "),p="";if(n&&r<0&&i>0){let g=l(0);p=`<line x1="0" y1="${g.toFixed(1)}" x2="${c}" y2="${g.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let m=e.map((g,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${s}" fill="transparent"><title>${u(o[h]||"")} \xB7 ${g.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${s}" style="width:100%;height:${s}px;display:block" preserveAspectRatio="none">
    ${p}
    <polyline points="${d}" fill="none" stroke="${t}" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/>
    ${m}
  </svg>`}function Lt(e){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.map(d=>Math.max(-9,Math.min(-3,Math.log10(d.flux)))),n=Math.min(...s),r=Math.max(...s)-n||1,i=d=>t-2-(d-n)/r*(t-4),a=s.map((d,p)=>`${(p/(s.length-1)*o).toFixed(1)},${i(d).toFixed(1)}`).join(" "),l=e.map((d,p)=>{let m=p/(s.length-1)*o,g=d.flux>=1e-4?"X":d.flux>=1e-5?"M":d.flux>=1e-6?"C":d.flux>=1e-7?"B":"A";return`<rect x="${(m-4).toFixed(1)}" y="0" width="8" height="${t}" fill="transparent"><title>${u(fe(d.t_utc))} \xB7 ${g}-class (${d.flux.toExponential(2)})</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">
    ...
    <div class="hw-kpi-hint">Class: <b style="color:${(a=$e[o])!=null?a:"#a0b4b8"}">${u(o)}-class</b> \xB7 ${u(s)}</div>
    <div class="hw-kpi-hint" style="margin-top:4px">Trend history: \u25B6 HISTORY</div>
  </div>`}function Rt(e){let a='<rect x="0" y="16" width="200" height="6" rx="3" fill="#1e2c30"/>',l=[-10,-5,5,10].map(C=>{let _=100+C/20*100;return`<line x1="${_.toFixed(1)}" y1="16" x2="${_.toFixed(1)}" y2="22" stroke="#2a3c42" stroke-width="1"/>`}).join(""),d='<line x1="100" y1="14" x2="100" y2="24" stroke="#3a4c52" stroke-width="1.5"/>';if(e==null)return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">${a}${l}${d}</svg>`;let p=e<=-10?"#e05c5c":e<=-5?"#e0a84a":e<0?"#d4b84a":e>=5?"#5cce8c":"#7acca8",m=Math.max(-20,Math.min(20,e)),g=100+m/20*100,h=3,x=m<0?g-h:100-h,v=Math.max(2*h,Math.abs(g-100)+2*h),$=`<rect x="${x.toFixed(1)}" y="16" width="${v.toFixed(1)}" height="6" rx="${h}" fill="${p}" opacity="0.82"/>`,w=5,f=15,b=f-w*1.1,y=`<polygon points="${g.toFixed(1)},${f.toFixed(1)} ${(g-w).toFixed(1)},${b.toFixed(1)} ${(g+w).toFixed(1)},${b.toFixed(1)}" fill="${p}"/>`,S=`<line x1="${g.toFixed(1)}" y1="${f.toFixed(1)}" x2="${g.toFixed(1)}" y2="${19 .toFixed(1)}" stroke="${p}" stroke-width="1" opacity="0.6"/>`,M=`<text x="${g.toFixed(1)}" y="31" text-anchor="middle" font-size="8" fill="${p}" font-weight="600">${e>=0?"+":""}${e.toFixed(1)}</text>`;return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">
    ${a}${l}${d}${$}${y}${S}${M}
  </svg>`}function It(e){let o=e.metrics.imf_bz_nt,t=e.metrics.imf_bt_nt,s=o!=null?o<=-10?"#e05c5c":o<=-5?"#e0a84a":o>=5?"#5cce8c":"#a0b4b8":"#607880",n=o!=null?(o>=0?"+":"")+o.toFixed(1)+" nT":"\u2014",c=t!=null?t.toFixed(1)+" nT":"\u2014",r=be(e),i=o!=null&&o<-5?{msg:"Southward IMF \xB7 Aurora favorable",color:"#5cce8c"}:o!=null&&o<0?{msg:"Weakly southward \xB7 Conditions may improve",color:"#d4cc5c"}:{msg:"Northward IMF \xB7 Stable magnetosphere",color:"#96a8b8"};return`<div class="hw-kpi-popover">
    ...
    <div class="hw-kpi-stat-row">
      <div class="hw-kpi-stat">
        ...
        <span class="hw-kpi-stat-value" style="color:${s}">${u(n)}</span>
      </div>
      <div class="hw-kpi-stat">
      ...
      <div class="hw-kpi-stat">
        ...
        <span class="hw-kpi-stat-value" style="color:${r.color};font-weight:600">${u(r.coupling)}</span>
      </div>
    </div>
    <div class="hw-kpi-hint" style="color:${i.color};font-weight:600;margin-bottom:0">${u(i.msg)}</div>
  </div>`}function be(e){var a,l;let o=e.metrics.imf_bz_nt,t=(a=e.metrics.kp_latest)!=null?a:0,s=(l=e.metrics.solar_wind_kms)!=null?l:0,n,c,r;if(o!=null&&o<-5||t>=6)n="storm",c="#e05c5c",r="Storm conditions";else if(o!=null&&o<0||t>=4||s>=400){let d=o!=null&&o<0;n="active",c="#e0a84a",r=d?"Active coupling":"Elevated"}else n="stable",c="#5cce8c",r="Stable";let i;return o==null?i="Unknown":o>2?i="Closed":o>0?i="Minimal":o>-5?i="Moderate":o>-10?i="Strong":i="Very strong",{state:n,color:c,label:r,coupling:i}}function At(e,o,t,s){let n=s?"mc":"mf",c=e.color,r=t!=null?t:0,i=r>500,a=r<350,l=i?.9:a?1.8:1.3;if(s){let h=45-(e.state==="storm"?11:e.state==="active"?16:21),x=e.state==="storm"?12:e.state==="active"?10:8,v=50-x,$=76,w=[`M ${h},25`,`C ${h-2},15 41,${x} 45,${x}`,`C 53,${x} ${$-8},${x+4} ${$},20`,`C ${$+1},23 ${$+1},27 ${$},30`,`C ${$-8},${v-4} 53,${v} 45,${v}`,`C 41,${v} ${h-2},35 ${h},25`,"Z"].join(" "),f=i?3:2,b=[14,25,36],y=C=>`<path d="M 0,${C} L ${i?8:6},${C} M ${i?6:4},${C-2} L ${i?8:6},${C} L ${i?6:4},${C+2}" stroke="${c}bb" stroke-width="${i?1.4:1}" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`,S=b.map(C=>y(C)).join(""),k=Array.from({length:f},(C,_)=>`<g class="hw-wg" style="animation-duration:${l}s;animation-delay:${(l/f*_).toFixed(2)}s">${S}</g>`).join(""),M=o==null?"":o>0?`<path d="M 45,27 L 45,23 M ${45-1.5},${25-.5} L 45,23 L ${45+1.5},${25-.5}" stroke="#5cce8c" stroke-width="1" fill="none" stroke-linecap="round"/>`:`<path d="M 45,23 L 45,27 M ${45-1.5},${25+.5} L 45,27 L ${45+1.5},${25+.5}" stroke="#e05c5c" stroke-width="1" fill="none" stroke-linecap="round"/>`;return`<svg viewBox="0 0 80 50" style="width:78px;height:49px;display:block" xmlns="http://www.w3.org/2000/svg">
      ...
      ${M}
    </svg>`}else{let $=e.state==="storm"?16:e.state==="active"?26:38,w=155-$,f=e.state==="storm"?22:e.state==="active"?30:40,b=120-f,y=240,S=[`M ${w},60`,`C ${w-4},42 150,${f} 155,${f}`,`C 173,${f} ${y-5},${f+18} ${y},60`,`C ${y-5},${b-18} 173,${b} 155,${b}`,`C 150,${b} ${w-4},78 ${w},60`,"Z"].join(" "),k=`M ${w+2},60 C ${w+2},${60-$*.4} 152,54 150,60 C 152,66 ${w+2},${60+$*.4} ${w+2},60 Z`,M=r>700?"#e05c5c":r>500?"#e0a84a":r>350?"#d4c840":"#5cce8c",C=r>700?.4:r>500?.65:r>350?1.1:1.8,_=r>500?[10,24,40,57,74,90,106]:r>350?[14,34,57,82,104]:[20,50,82,108],L=16,R=22,N=w-6,B=Math.ceil((N-R)/L)+2,X=Array.from({length:B},(T,F)=>R-L+F*L),P=12,G=8,W=X.flatMap(T=>_.map(F=>`<path d="M ${T},${F} L ${T+P},${F} M ${T+G},${F-3} L ${T+P},${F} L ${T+G},${F+3}" stroke="${M}cc" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`)).join(""),H=`<g class="hw-wg-full" style="animation-duration:${C}s">${W}</g>`,I=o==null?"":o>0?'<path d="M 155,64 L 155,56 M 153,58 L 155,56 L 157,58" stroke="#5cce8c" stroke-width="1.3" fill="none" stroke-linecap="round"/>':'<path d="M 155,56 L 155,64 M 153,62 L 155,64 L 157,62" stroke="#e05c5c" stroke-width="1.3" fill="none" stroke-linecap="round"/>',V=o==null?"":`<text x="163" y="62" font-size="6" fill="${o>0?"#5cce8c":"#e05c5c"}" font-family="monospace">Bz${o>0?"\u2191":"\u2193"}</text>`;return ve("magnetosphere",{magnetInfo:e,bz:o,windKms:t,uid:n})}}function ve(e,o={}){var H,I,V,T,F,ee;let c=(H=o.uid)!=null?H:"hse",r=0,i=160,a=800,l=17,d=a-l,p=o.magnetInfo,m=(I=p==null?void 0:p.state)!=null?I:"stable",g=(V=p==null?void 0:p.color)!=null?V:"#e0a84a",x=a-(m==="storm"?55:m==="active"?80:110),v=m==="storm"?58:m==="active"?76:95,$=1120,w=20,f=[`M ${x},130`,`C ${x-8},${130-v*.55} ${a-18},${130-v} ${a},${130-v}`,`C ${a+120},${130-v} ${$-180},${130-w} ${$},${130-w}`,`L ${$},${130+w}`,`C ${$-180},${130+w} ${a+120},${130+v} ${a},${130+v}`,`C ${a-18},${130+v} ${x-8},${130+v*.55} ${x},130`,"Z"].join(" "),b=e==="magnetosphere",y=b?m==="storm"?"0.12":"0.08":"0.04",S=b?"0.75":"0.28",k=`<g id="${c}-base-sun">
    ...
    <path d="${f}" fill="${g}" fill-opacity="${y}"
          stroke="${g}" stroke-opacity="${S}" stroke-width="1.8"/>
    ${p?`<text x="${x+5}" y="${130-v-7}" font-size="12" fill="${g}"
  ...
  </g>`,R="";if(e==="magnetosphere"){let z=(T=o.windKms)!=null?T:0,j=z>500,D=z<350,E=(j?.5:D?1.4:.9)*1.3,K=z>700?"#e05c5c":z>500?"#e0a84a":z>350?"#d4c840":"#5cce8c",oe=i+8,te=x-14,A=8,Y=6,U=(te-oe)/(A-1),se=260/(Y+1),Z=38,ne=24,ye=2,ke=Array.from({length:A},(re,ie)=>{let q=oe+ie*U,pe=Array.from({length:Y},(Fe,ae)=>{let Q=se*(ae+1);return`<path d="M ${q.toFixed(1)},${Q.toFixed(1)} L ${(q+Z).toFixed(1)},${Q.toFixed(1)} M ${(q+ne).toFixed(1)},${(Q-6).toFixed(1)} L ${(q+Z).toFixed(1)},${Q.toFixed(1)} L ${(q+ne).toFixed(1)},${(Q+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:ye},(Fe,ae)=>{let Q=-((A-ie)/A*E)-ae*E/ye;return`<g style="opacity:.12;animation:hw-arrow-chase ${E}s linear ${Q.toFixed(3)}s infinite">${pe}</g>`}).join("")}).join(""),J=(F=o.bz)!=null?F:null,de=J==null?"":(()=>{let re=J>0?"#5cce8c":"#e05c5c";return`${J>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
           stroke="${re}" stroke-width="2.2" fill="none" stroke-linecap="round"/>`:`<path d="M ${a},123 L ${a},137 M ${a-3},134 L ${a},137 L ${a+3},134"
           stroke="${re}" stroke-width="2.2" fill="none" stroke-linecap="round"/>`}<text x="${a+22}" y="135" font-size="13"
        fill="${re}" font-family="monospace">Bz${J>0?"\u2191":"\u2193"}</text>`})();R=`${ke}${de}`}let N=`<g id="${c}-overlay-solar-wind">${R}</g>`,B="";if(e==="coronal_hole"&&o.hssState){let z=o.hssState,j=(ee=z.speed)!=null?ee:0,D=j>=420,E=z.color,K=D?"0.85":"0.25",oe=j>=500?"0.18":D?"0.10":"0.04",te=i+8,A=d-16,Y=60,U=`${te},130 ${A},${130-Y} ${A},${130+Y}`,se=A+6,Z=`${se},120 ${se+18},130 ${se},140`;B=`
    <polygon points="${U}" fill="${E}" opacity="${oe}"/>
    <line x1="${te}" y1="130" x2="${A-5}" y2="130"
          stroke="${E}" stroke-width="3.5" stroke-dasharray="10 6"
          stroke-linecap="round" opacity="${K}"/>
    <polygon points="${Z}" fill="${E}" opacity="${D?"0.9":"0.25"}"/>`}let X=`<g id="${c}-overlay-coronal-hole">${B}</g>`,P="";if(e==="cme_cone"&&o.cmeState){let z=o.cmeState,j=i,D=d-10,E=D-j,K=U=>Math.tan(U*Math.PI/180),oe=Math.round(K(9)*E),te=Math.round(K(6)*E),A=Math.round(K(3)*E),Y=U=>`${j},130 ${D},${130-U} ${D},${130+U}`;if(z.status!=="quiet"){let U=z.status==="impact"?"#e05c5c":"#d4cc5c";P=`
    <polygon points="${Y(oe)}" fill="#253238" opacity="0.85"/>
    <polygon points="${Y(te)}"   fill="#d4cc5c" opacity="0.14"/>
    <polygon points="${Y(A)}" fill="#e0a84a" opacity="0.28"/>
    <line x1="${j+14}" y1="130" x2="${D-5}" y2="130"
          stroke="#3a5058" stroke-dasharray="6 5" stroke-width="2"/>
    <circle cx="${a}" cy="130" r="${l+8}" fill="none"
            stroke="${U}" stroke-width="7" opacity="0.16"/>`}else P=`
    <line x1="${j+14}" y1="130" x2="${d-14}" y2="130"
          stroke="#1e2c30" stroke-dasharray="7 5" stroke-width="2"/>`}let G=`<g id="${c}-overlay-cme-cone">${P}</g>`,W=`<g id="${c}-overlay-labels">
  ...
  </div>`}function Nt(e,o,t,s){switch(o){case"solar_wind":return Et(e);case"xray":return Ft(e);case"imf_bz":return It(e);case"aurora":return zt(t,s);case"magnetosphere":return Ot(e);default:return""}}function Bt(e,o){if(e.length<2)return"\u2192";let t=e[e.length-1],s=Math.max(0,e.length-4),n=e[s];if(!isFinite(t)||!isFinite(n))return"\u2192";let c=t-n;return c>o?"\u2191":c<-o?"\u2193":"\u2192"}var Pt={quiet:"171",active:"195",elevated:"284",storm:"304"};function Dt(e,o){var s,n,c;if(o==null)return(n=(s=e.summary)==null?void 0:s.status)!=null?n:"quiet";let t=parseInt(((c=o.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":o.kp>=4?"active":"quiet"}function Gt(e,o){var l,d;let t=(l=Pt[e])!=null?l:"171",s=`/assets/gifs/current_eit_${t}.gif`,n=io(s,o),c=co,r=(d=xe[e])!=null?d:xe.quiet,i=`${r.accent}44`,a=`0 0 10px ${r.accent}55,0 0 24px ${r.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
    <div class="hw-solar-mini-inner" style="border-color:${i};box-shadow:${a}">
      <img class="hw-solar-mini-img" src="${O(n)}" alt="Sun EIT ${O(t)}"
        onerror="if(this.src!=='${O(c)}')this.src='${O(c)}'" />
    </div>
  </div>`}function jt(e,o,t,s,n){var f,b,y;let{summary:c,metrics:r}=e,i=(f=xe[c.status])!=null?f:xe.quiet,a=t!=null?t.kp.toFixed(1):r.kp_latest!=null?r.kp_latest.toFixed(1):"\u2014",l=St(e,t),p=[{key:"G",text:l.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:l.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:l.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${l.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(S=>{let k;return S.key==="G"?k=Me(Se(l.g,"G")):S.key==="R"?k=Me(Se(l.r,"R")):S.key==="S"?k=Me(Se(l.s,"S")):k=_t(l.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${k.color};background:${k.background};border-color:${k.borderColor}`}" data-hero-chip="${S.key}" title="${O(S.title)}" aria-label="${O(S.aria)}">${u(S.text)}</button>`}).join(""),m=Bt(((b=r.kp_history_1h)!=null?b:[]).map(S=>S.kp),.5),g=(y=r.kp_latest)!=null?y:0,h=g>=5,x=h?`linear-gradient(160deg, #0d2a1a 0%, ${i.bg}22 75%)`:`${i.bg}18`,v=Dt(e,t),w=h?`
    ...
    <div class="hw-hero" style="background:${x}">
      ...
      ${w}
    </div>`}function Yt(e){var d,p,m,g;let{metrics:o}=e,t=(d=o.kp_history_1h)!=null?d:[],s=(p=o.wind_history_1h)!=null?p:[],n=(m=o.bz_history_1h)!=null?m:[],c=(g=o.xray_history_1h)!=null?g:[],r=Ht(t),i=Ge(s.map(h=>{var x;return(x=h.kms)!=null?x:0}).filter(h=>h>0),s.map(h=>fe(h.t_utc)),"#5cce8c",28,!1),a=Ge(n.map(h=>h.bz),n.map(h=>fe(h.t_utc)),"#d4cc5c",28,!0),l=Lt(c);return`
    ...
    <div class="hw-forecast">
      ...
      ${s?`<div class="hw-forecast-text">${u(h)}</div>`:""}
    </div>`;let $=320,w=38,f=14,b=w+f,y=$/d,S=H=>w-Math.max(2,Math.min(w-2,H/9*(w-2))),k="",M=l.map(H=>H.kp),C=Ut(M);l.forEach((H,I)=>{let V=S(H.kp),T=w-V,F=I*y,ee=F+y/2,z=H.kp>=6?"#e05c5c":H.kp>=5?"#e0a84a":H.kp>=4?"#d4cc5c":"#5cce8c",j=`Kp ${H.kp.toFixed(1)} \xB7 ${ue(H.t_utc)}`;if(k+=`<rect x="${F.toFixed(1)}" y="${V.toFixed(1)}" width="${(y-1.5).toFixed(1)}" height="${T.toFixed(1)}" fill="${z}" fill-opacity="0.85" rx="1.5"/>`,k+=`<rect x="${F.toFixed(1)}" y="0" width="${y.toFixed(1)}" height="${w}" fill="transparent"><title>${O(j)}</title></rect>`,d<=8||I%2===0){let E=new Date(H.t_utc).getHours();k+=`<text x="${ee.toFixed(1)}" y="${(b-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${E.toString().padStart(2,"0")}</text>`}});let L=`<polyline points="${l.map((H,I)=>{let V=I*y+y/2,T=S(C[I]);return`${V.toFixed(1)},${T.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,R="";if(o>0&&d>0){let H=Math.min($-1,o/(d*3)*$);R=`
      <line x1="${H.toFixed(1)}" y1="0" x2="${H.toFixed(1)}" y2="${w}" stroke="rgba(255,255,255,0.75)" stroke-width="1.5" stroke-dasharray="3,2"/>
      <polygon points="${H.toFixed(1)},${w} ${(H-4).toFixed(1)},${(w-7).toFixed(1)} ${(H+4).toFixed(1)},${(w-7).toFixed(1)}" fill="rgba(255,255,255,0.75)"/>`}let N=Math.round(p/4),B=Math.round(p/2),X=Math.round(p*3/4),P=`
    <div class="hw-scrub-wrap">
      ...
      <input type="range" class="hw-scrub-slider" data-scrub min="0" max="${p}" step="1" value="${o}" style="--pct:${m}">
    ...
    <div class="hw-forecast">
      ...
      ${P}`:""}
    </div>`}function Zt(e){let o=/([NS])(\d+)([EW])(\d+)/i.exec(e);return o?{lat:(o[1].toUpperCase()==="N"?1:-1)*parseInt(o[2],10),lon:(o[3].toUpperCase()==="E"?1:-1)*parseInt(o[4],10)}:null}var et=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function Jt(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function eo(e,o,t){let s=o/2,n=s*.87,c=o*.03,r=o*.009,i=e.map(a=>{var $,w;let l=Zt(a.location);if(!l||Math.abs(l.lon)>88||a.location.includes("*"))return"";let d=Jt(a);if(!t.has(d))return"";let p=et.find(f=>f.id===d).color,m=l.lat*Math.PI/180,g=l.lon*Math.PI/180,h=(s+n*Math.cos(m)*Math.sin(g)).toFixed(1),x=(s-n*Math.sin(m)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
Class: ${($=a.spot_class)!=null?$:"\u2014"} / ${(w=a.mag_class)!=null?w:"\u2014"}
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
    ...
    <div class="hw-radio-meta">X-ray: <b style="color:${(p=$e[s])!=null?p:"#a0b4b8"}">${u(s)}-class</b> \xB7 ${u(c)}</div>
  </div>`}var ho={0:"Quiet",1:"Minor Storm",2:"Moderate Storm",3:"Strong Storm",4:"Severe Storm",5:"Extreme Storm"};function mo(e){return e>=9?5:e>=8?4:e>=7?3:e>=6?2:e>=5?1:0}function ce(e,o){if(e<o-.7)return 0;if(e>o+1)return .9;let t=(e-(o-.7))/1.7;return Math.round(Math.pow(Math.max(0,t),.7)*90)/100}function go(e){var l,d,p;let o=parseInt(((l=e.scales.g_scale)!=null?l:"G0").replace(/\D/g,""),10),t=Math.max(0,Math.min(5,Number.isFinite(o)?o:0)),s=(d=e.metrics.kp_forecast_3h)!=null?d:[],n=Date.now(),c=n+24*60*60*1e3,r=s.filter(m=>{let g=new Date(m.t_utc).getTime();return g>=n-3*60*60*1e3&&g<=c}),i=r.length===0?0:Math.max(...r.map(m=>m.kp)),a={G1:ce(i,5),G2:ce(i,6),G3:ce(i,7),G4:ce(i,8),G5:ce(i,9),max_expected:mo(i)};return{now:{g_level:t,label:(p=ho[t])!=null?p:"Quiet"},forecast_24h:a}}function uo(e){if(!e||typeof e!="object")return null;let o=e,t=o.now,s=o.forecast_24h;if(!t||!s)return null;let n=typeof t.g_level=="number"?t.g_level:parseInt(String(t.g_level),10),c=typeof t.label=="string"?t.label:"Quiet";if(!Number.isFinite(n))return null;let r=l=>{let d=typeof l=="number"?l:parseFloat(String(l));return Number.isFinite(d)?Math.max(0,Math.min(1,d)):0},i=s.max_expected,a=typeof i=="number"&&Number.isFinite(i)?Math.max(0,Math.min(5,Math.round(i))):0;return{now:{g_level:Math.max(0,Math.min(5,Math.round(n))),label:c},forecast_24h:{G1:r(s.G1),G2:r(s.G2),G3:r(s.G3),G4:r(s.G4),G5:r(s.G5),max_expected:a}}}function ot(e){let o=go(e),t=uo(e.storm_risk);if(!t)return o;let s=e.storm_risk,n=s&&typeof s.forecast_24h=="object"&&s.forecast_24h!==null?s.forecast_24h:void 0,c=n==null?void 0:n.max_expected;return typeof c=="number"&&Number.isFinite(c)?t:ge(me({},t),{forecast_24h:ge(me({},t.forecast_24h),{max_expected:o.forecast_24h.max_expected})})}function wo(e){return e>=4?"#e05c5c":e>=3?"#e0a84a":e>=1?"#d4cc5c":"#607880"}var je={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function xo(e){var l,d,p;let o=(l=e.metrics.kp_latest)!=null?l:0,t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,n=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,c=o>=5||n>=1,r=(p=e.metrics.kp_history_1h)!=null?p:[],i=0;if(r.length>=2&&(i=r[r.length-1].kp-r[r.length-2].kp),!c)return{active:!1,phase:"quiet",kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s};let a;return i>.3&&(t==null||t<-5)?a="rising":i<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s}}function fo(e){if(!e.active)return"";let o=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=o.findIndex(i=>i.key===e.phase),s=je[e.phase],n=o[t].label,c=o.map((i,a)=>{let l=a===t,d=a<t,p=je[i.key],m=l?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",g=l?" hw-spi-dot-active":"",h=l?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",x=a<o.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
  ...
  </div>`}function Ye(e,o,t){let s=Math.max(0,Math.min(5,Math.round(e))),n=(t==null?void 0:t.showDialCode)!==!1,c=70,r=76,i=48,l=i-9,d=Math.PI,p=y=>d*(1-y/5),m=p(s),g=(y,S)=>({x:c+S*Math.cos(y),y:r-S*Math.sin(y)}),h=(y,S,k)=>{let M=g(y,i),C=g(S,i),_=g(y,l),L=g(S,l);return`<path d="M ${_.x.toFixed(2)} ${_.y.toFixed(2)} L ${M.x.toFixed(2)} ${M.y.toFixed(2)} A ${i} ${i} 0 0 1 ${C.x.toFixed(2)} ${C.y.toFixed(2)} L ${L.x.toFixed(2)} ${L.y.toFixed(2)} A ${l} ${l} 0 0 0 ${_.x.toFixed(2)} ${_.y.toFixed(2)} Z" fill="${k}"/>`},x=y=>{let S=p(y),k=g(S,i+1),M=g(S,i-5);return`<line x1="${k.x.toFixed(2)}" y1="${k.y.toFixed(2)}" x2="${M.x.toFixed(2)}" y2="${M.y.toFixed(2)}" stroke="#2a3a40" stroke-width="1" stroke-linecap="round"/>`},v=g(m,i-2),$=`<line x1="${c}" y1="${r}" x2="${v.x.toFixed(2)}" y2="${v.y.toFixed(2)}" stroke="#c8d6dc" stroke-width="2" stroke-linecap="round"/>`,w=`<circle cx="${c}" cy="${r}" r="3.5" fill="#3a4c52" stroke="#1e2c30" stroke-width="1"/>`,f=h(p(0),p(2),"#3d8f62")+h(p(2),p(4),"#b8982a")+h(p(4),p(5),"#b04048"),b=[0,1,2,3,4,5].map(x).join("");return`<div class="hw-storm-risk-gauge" role="img" aria-label="${O(o)} G${s}">
    <svg viewBox="0 0 140 88" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="140" height="88" fill="none"/>
      <path d="M ${g(d,i).x.toFixed(2)} ${g(d,i).y.toFixed(2)} A ${i} ${i} 0 0 1 ${g(0,i).x.toFixed(2)} ${g(0,i).y.toFixed(2)}" fill="none" stroke="#1a2428" stroke-width="2" stroke-linecap="round"/>
      ${f}
      ${b}
      ${$}
      ${w}
  ...
  </div>`}function $o(e,o){let t=ot(e),s=xo(e),n=t.forecast_24h,c=Math.max(0,Math.min(5,Math.round(n.max_expected))),r=`<div class="hw-storm-risk-now-gauge">${Ye(t.now.g_level,"Current observed geomagnetic storm level",{showDialCode:!0})}</div>`,i=`<div class="hw-storm-risk-fc-gauge">${Ye(c,"Max expected geomagnetic level in next 24 hours",{showDialCode:!1})}</div>`,a=`
  ...
  </div>`}var we={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},st={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function bo(e){var C;let o=we,t=(C=st[o.phase])!=null?C:"#96a8b8",s=o.phase.charAt(0).toUpperCase()+o.phase.slice(1),n=280,c=52,r=10,i=c-6,a=c-18,l=.5,d=.19,p=_=>Math.exp(-Math.pow((_-l)/d,2)/2),m=_=>r+_*(n-2*r),g=_=>i-p(_)*a,h=80,x=[];for(let _=0;_<=h;_++){let L=_/h;x.push(`${_===0?"M":"L"}${m(L).toFixed(1)},${g(L).toFixed(1)}`)}let v=Math.round(o.progress_0_1*h),$=[];for(let _=0;_<=v;_++){let L=_/h;$.push(`${_===0?"M":"L"}${m(L).toFixed(1)},${g(L).toFixed(1)}`)}let w=m(o.progress_0_1),f=[`M${r},${i}`,...$.slice(1),`L${w.toFixed(1)},${i} Z`],b=g(o.progress_0_1),y=5,S=`M${w.toFixed(1)},${b.toFixed(1)} L${(w-y).toFixed(1)},${(b-y*1.8).toFixed(1)} L${(w+y).toFixed(1)},${(b-y*1.8).toFixed(1)} Z`,k=i+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
    <div class="hw-sc-name">${u(o.cycle_name)}</div>
    ...
    <div class="hw-sc-footer">Phase: <b style="color:${t}">${u(s)}</b>${o.subtitle?` \xB7 ${u(o.subtitle)}`:""}</div>
  </div>`}function nt(e){var a,l,d,p,m;let o=(l=(a=e.coronal_hole)==null?void 0:a.estimated_speed_kms)!=null?l:e.metrics.solar_wind_kms,t=(d=e.coronal_hole)==null?void 0:d.status,s=o!=null?o:0,n=t!=null?t:s>=600?"strong":s>=500?"active":s>=420?"watch":"quiet",c={strong:"#e05c5c",active:"#e0a84a",watch:"#d4cc5c",quiet:"#5cce8c"},r={strong:"Strong",active:"Active",watch:"Watch",quiet:"None"},i={strong:"Strong high-speed stream",active:"High-speed stream active",watch:"Elevated solar wind",quiet:"Background solar wind"};return{status:n,color:c[n],label:r[n],desc:(m=(p=e.coronal_hole)==null?void 0:p.note)!=null?m:i[n],speed:o}}function vo(e,o){var l;let t=nt(e),s=(l=t.speed)!=null?l:0,n=t.speed!=null?`${Math.round(t.speed)} km/s`:"\u2014",c=o?" hw-impact-tip-open":"",r=s>=420,i=ve("coronal_hole",{hssState:t,uid:"hss"}),a=r?'<div class="hw-hss-meta" style="font-size:.72em">Elevated speed may indicate Earth-facing coronal hole stream</div>':'<div class="hw-hss-meta" style="font-size:.72em">Background solar wind \xB7 no HSS detected</div>';return`<div class="hw-impact-tip${c}">
    ${i}
    <div class="hw-hss-meta">Solar wind: <b style="color:${t.color}">${u(n)}</b> \xB7 ${u(t.desc)}</div>
    ${a}
  </div>`}var We={none:"#3a5060",low:"#5cce8c",moderate:"#d4cc5c",strong:"#e0a84a",severe:"#e05c5c"},yo={none:"none",low:"0 0 5px #5cce8c55",moderate:"0 0 5px #d4cc5c55",strong:"0 0 6px #e0a84a77",severe:"0 0 7px #e05c5c99"};function ko(e){var b,y,S,k;let o=(b=e.metrics.xray_class)!=null?b:"A",t=e.observer_impacts.find(M=>M.kind==="solar_activity"),s=(y=t==null?void 0:t.level)!=null?y:"none",n=e.coronal_hole,c=(S=n==null?void 0:n.status)!=null?S:"quiet",r=[];o==="X"?(r.push("Solar flare: X-class"),r.push("Elevated X-ray activity")):o==="M"?(r.push("Solar flare: M-class"),r.push("Elevated X-ray activity")):o==="C"&&r.push("Minor C-class flare activity"),(c==="strong"||c==="active")&&(r.push(`Coronal hole: ${c==="strong"?"Strong":"Active"}`),(n==null?void 0:n.estimated_speed_kms)!=null&&r.push(`Fast solar wind: ~${Math.round(n.estimated_speed_kms)} km/s`)),r.length===0&&r.push("No significant solar source activity");let i,a;o==="X"||s==="high"?(i="Strong",a="strong"):o==="M"||s==="moderate"||c==="strong"?(i="Active",a="moderate"):o==="C"||s==="low"||c==="active"?(i="Elevated",a="low"):(i="Quiet",a="none");let l=e.cme_tracker,d=e.metrics.solar_wind_kms,p=[],m="Clear",g="none";if(l){let M=l.status,C=l.impact_level;if(M==="arrived"||M==="arrival_window")m="Impacting",g=C==="high"?"strong":"moderate",p.push("CME impact underway"),l.speed_kms!=null&&p.push(`Speed: ~${Math.round(l.speed_kms)} km/s`);else if(M==="inbound"||M==="detected"){if(m="Incoming",g=C==="high"?"moderate":"low",p.push("Earth-directed CME detected"),l.arrival_time_utc){let _=new Date(l.arrival_time_utc),L=_.getUTCDate().toString().padStart(2,"0"),R=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][_.getUTCMonth()],N=_.getUTCHours().toString().padStart(2,"0"),B=_.getUTCMinutes().toString().padStart(2,"0");p.push(`ETA: ${L} ${R} ${N}:${B} UTC`)}p.push(`Expected impact: ${C.charAt(0).toUpperCase()+C.slice(1)}`)}}p.length===0&&(d!=null&&d>500?(m="Active",g="low",p.push(`High-speed solar wind: ${Math.round(d)} km/s`),p.push("No Earth-directed CME tracked")):p.push("No Earth-directed events"));let h=parseInt(((k=e.scales.g_scale)!=null?k:"G0").slice(1),10),x=e.metrics.kp_latest,v=x!=null?`Kp ${x.toFixed(1)}`:"Kp \u2014",$=[`G${h}`],w,f;return h>=4?(w="Severe",f="severe",$.push("Severe geomagnetic storm")):h===3?(w="Storm",f="strong",$.push("Strong geomagnetic storm")):h===2?(w="Storm",f="moderate",$.push("Moderate geomagnetic storm")):h===1?(w="Active",f="low",$.push("Minor geomagnetic storm")):(w="Quiet",f="none",$.push("Quiet conditions")),$.push(v),{sun:{state:i,severity:a,label:i,messages:r},space:{state:m,severity:g,label:m,messages:p},earth:{state:w,severity:f,label:w,messages:$}}}function Ce(e,o){var c,r;let t=(c=We[e.severity])!=null?c:We.none,s=(r=yo[e.severity])!=null?r:"none",n=e.messages.slice(0,3).map(i=>`<span class="hw-chain-msg">${u(i)}</span>`).join("");return`<div class="hw-chain-col">
    <div class="hw-chain-head">${u(o)}</div>
    <span class="hw-chain-lamp" style="background:${t};box-shadow:${s}"></span>
    <div class="hw-chain-state" style="color:${t}">${u(e.label)}</div>
    <div class="hw-chain-msgs">${n}</div>
  </div>`}function _o(e){var s;let o=(s=e.chain_panel)!=null?s:ko(e),t='<div class="hw-chain-arrow">\u203A</div>';return`<div class="hw-chain">
    <div class="hw-chain-title">Solar \xB7 Space \xB7 Earth</div>
  ...
  </div>`}function rt(e){var n,c;let o=(n=e.scales.g_scale)!=null?n:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let r=(c=e.metrics.kp_forecast_3h)!=null?c:[],i=Date.now(),a=r.filter(l=>new Date(l.t_utc).getTime()<=i+3*60*60*1e3).sort((l,d)=>new Date(d.t_utc).getTime()-new Date(l.t_utc).getTime());a.length>0&&(s=a[0].kp)}return t>=2||s!=null&&s>=6?{level:2,color:"#e05c5c",label:"High",kp:s,gScale:o}:t>=1||s!=null&&s>=4?{level:1,color:"#d4cc5c",label:"Moderate",kp:s,gScale:o}:{level:0,color:"#5cce8c",label:"Low",kp:s,gScale:o}}function So(e,o){let t=rt(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(a=>{let l=a.l===t.level,d=l?`${a.color}2e`:"#1b2a2e",p=l?a.color:"#3d5058",m=l?`1px solid ${a.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${d};color:${p};border:${m}">${a.label}</div>`}).join(""),r=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Near-normal thermospheric density",1:"Elevated drag \u2014 minor orbit correction may be needed",2:"Strong thermospheric expansion \u2014 significant drag increase"};return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-satdrag-meta">${r} \xB7 ${u(t.gScale)} \xB7 ${i[t.level]}</div>
  </div>`}function it(e){var l,d,p;let o=(l=e.scales.g_scale)!=null?l:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let m=(d=e.metrics.kp_forecast_3h)!=null?d:[],g=Date.now(),h=m.filter(x=>new Date(x.t_utc).getTime()<=g+3*60*60*1e3).sort((x,v)=>new Date(v.t_utc).getTime()-new Date(x.t_utc).getTime());h.length>0&&(s=h[0].kp)}let n=0;t>=2||s!=null&&s>=6?n=2:(t>=1||s!=null&&s>=4)&&(n=1);let c=parseInt(((p=e.scales.r_scale)!=null?p:"R0").slice(1),10),r=c>=2&&n<2;c>=2&&(n=Math.min(2,n+1));let i={0:"#5cce8c",1:"#d4cc5c",2:"#e05c5c"},a={0:"Low",1:"Moderate",2:"High"};return{level:n,color:i[n],label:a[n],kp:s,gScale:o,boostedByFlare:r}}function Mo(e,o){var l;let t=it(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(d=>{let p=d.l===t.level,m=p?`${d.color}2e`:"#1b2a2e",g=p?d.color:"#3d5058",h=p?`1px solid ${d.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${m};color:${g};border:${h}">${d.label}</div>`}).join(""),r=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Stable ionosphere \xB7 normal positioning accuracy",1:"Possible signal delay or scintillation",2:"Significant positioning errors \xB7 possible signal loss"},a=t.boostedByFlare?`<div class="hw-gnss-meta" style="font-size:.72em">Risk elevated by solar flare activity (R${parseInt(((l=e.scales.r_scale)!=null?l:"R0").slice(1),10)})</div>`:"";return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-gnss-meta">${r} \xB7 ${u(t.gScale)} \xB7 ${i[t.level]}</div>
    ${a}
  </div>`}function at(e){var l,d;let o=(l=e.alerts_all)!=null?l:[],t=o.find(p=>p.kind==="cme_impact"),s=o.find(p=>p.kind==="cme_watch"),n=t!=null?t:s;if(!n)return{status:"quiet",color:"#5cce8c",label:"None",speed_kms:null,issued_utc:null,arrival_utc:null};let c=((d=n.raw_body)!=null?d:"").match(/Estimated Velocity[:\s]+(\d+)\s*km\/s/i),r=c?parseInt(c[1],10):null,i=null;if(r&&n.t_utc){let p=1496e5/r*1e3;i=new Date(new Date(n.t_utc).getTime()+p).toISOString().replace(".000Z","Z")}let a=t?"impact":"watch";return{status:a,color:a==="impact"?"#e05c5c":"#d4cc5c",label:a==="impact"?"Active":"Watch",speed_kms:r,issued_utc:n.t_utc,arrival_utc:i}}function Co(e,o){let t=at(e),s=o?" hw-impact-tip-open":"",n="\u2014";if(t.arrival_utc){let a=new Date(t.arrival_utc),l=a.toLocaleString("en-US",{month:"short",timeZone:"UTC"}),d=a.getUTCDate(),p=String(a.getUTCHours()).padStart(2,"0"),m=String(a.getUTCMinutes()).padStart(2,"0");n=`~${l}\xA0${d}\xA0${p}:${m}\u202FUTC`}let c=t.speed_kms?`${t.speed_kms}\u202Fkm/s`:"\u2014",r=t.status!=="quiet"?`Velocity: <b style="color:#b4c6cc">${u(c)}</b>&ensp;Arrival: <b style="color:#b4c6cc">${u(n)}</b>`:"No Earth-directed CME in forecast window",i=ve("cme_cone",{cmeState:t,uid:"cme"});return`<div class="hw-impact-tip${s}">
    ${i}
    <div class="hw-cme-footer">${r}</div>
  </div>`}function He(e,o,t,s,n,c,r,i,a){let l=c.has(e),d=l?" hw-impact-open":"",p=l?" hw-impact-tip-open":"";return`<div class="hw-impact-row${d}" id="${e}" data-impact-row="${e}">
      <span class="hw-impact-caret">\u25B6</span>
      <span class="hw-impact-kind" style="color:${n}">${t}<span style="color:#b4c6cc">${u(o)}</span></span>
      <span class="hw-impact-badge" style="background:${n}22;color:${n}">${u(s)}</span>
      <div class="hw-impact-tip${p}">${Nt(r,e,i,a)}</div>
    </div>`}function Ho(e,o){let t=e.find(c=>c.kind==="aurora");if(t)return t;let s=o.aurora_hint;return{kind:"aurora",level:s.aurora_label==="good"?"moderate":s.aurora_label==="possible"?"low":"none",label:"Aurora",summary:s.summary}}function Lo(e,o,t,s){var w,f;let n=(w=qe[e.level])!=null?w:"#666",c=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),r=(f=Ee[e.kind])!=null?f:tt,i=e.level==="none"?"#606870":n,a=o.has("aurora"),l=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,m=null;t&&s.lat!=null&&s.lon!=null&&(m=Ve(t.entries,s.lat,s.lon));let g=s.lat!=null&&s.lon!=null,h=m!=null?m>=30?"#5cce8c":m>=10?"#d4cc5c":"#9ab4bc":"#607880",x=m!=null?`${m}%`:t?"n/a":"\u2026",v=g?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
      <span>${s.locationName?u(s.locationName)+" \xB7 ":""}${s.lat.toFixed(1)}\xB0${s.lat>=0?"N":"S"} ${Math.abs(s.lon).toFixed(1)}\xB0${s.lon>=0?"E":"W"}</span>
    ...
    ${$}
  </div>`}function Ue(e,o,t,s,n,c){var x,v;let r=(x=qe[e.level])!=null?x:"#666",i=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Ee[e.kind])!=null?v:tt,l=e.level==="none"?"#606870":r,d=e.kind==="solar_activity"?t:c,p=d?" hw-impact-open":"",m;if(e.kind==="solar_activity"){let $=t?" hw-solar-open":"",w=et.map(f=>{let b=s.has(f.id),y=b?f.color+"22":"transparent",S=b?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${y};opacity:${S}">${f.label}</button>`}).join("");m=`<div class="hw-solar-tip${$}">
        <div class="hw-solar-disk-wrap" id="solar">
          <img class="hw-solar-disk-img" src="${ao}" alt="Solar disk" loading="lazy" />
          ${o?eo(o,lo,s):""}
        </div>
        <div class="hw-solar-layers">${w}</div>
        <span class="hw-solar-tip-text">${u(e.summary)}</span>
      </div>`}else m=po(n,d);let g=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${O(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${g}>
    <span class="hw-impact-caret">\u25B6</span>
    ...
    ${m}
  </div>`}function Eo(e,o,t,s,n,c,r,i,a){var Q,Re,Ie,Ae;let l=(Re=(Q=o==null?void 0:o.impacts)!=null?Q:e.observer_impacts)!=null?Re:[],d=Ho(l,e),p=Lo(d,r,i,a),m=l.find(_e=>_e.kind==="radio"),g=l.find(_e=>_e.kind==="solar_activity"),h=m?Ue(m,t,n,c,e,r.has("radio")):"",x=g?Ue(g,t,n,c,e,!1):"",w=`
    <div class="hw-section-row" data-impacts-toggle>
    ...
    </div>`,{metrics:f}=e,b=f.xray_class,y=b?(Ie=$e[b])!=null?Ie:"#a0b4b8":"#607880",S=b?`${b}-class`:"\u2014",k=f.imf_bz_nt,M=k!=null?k<=-10?"#e05c5c":k<=-5?"#e0a84a":k>=5?"#5cce8c":"#a0b4b8":"#607880",C=k!=null?(k>=0?"+":"")+k.toFixed(1)+" nT":"\u2014",_=f.solar_wind_kms,L=_!=null?`${Math.round(_)} km/s`:"\u2014",R=_!=null?_>700?"#e05c5c":_>500?"#e0a84a":_>400?"#d4cc5c":"#5cce8c":"#607880",N=He("xray","X-Ray",to,S,y,r,e,a,i),B=He("imf_bz","IMF Bz",oo,C,M,r,e,a,i),X=He("solar_wind","Solar Wind",so,L,R,r,e,a,i),P='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',G=r.has("geomag_storm"),W=ot(e),H=wo(W.now.g_level),I=`G${W.now.g_level}`,T=`<div class="hw-impact-row${G?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      <span class="hw-impact-badge" style="background:${H}22;color:${H}">${I}</span>
      ${$o(e,G)}
    </div>`,F=r.has("solar_cycle"),ee=(Ae=st[we.phase])!=null?Ae:"#96a8b8",z=we.phase.charAt(0).toUpperCase()+we.phase.slice(1),D=`<div class="hw-impact-row${F?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      <span class="hw-impact-kind" style="color:${ee}"><svg viewBox="0 0 13 13" width="13" height="13" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.3"><path d="M1 9 Q3 4 6.5 4 Q10 4 12 9"/><circle cx="6.5" cy="4" r="1.3" fill="currentColor" stroke="none"/></svg><span style="color:#b4c6cc">Solar Cycle</span></span>
      <span class="hw-impact-badge" style="background:${ee}22;color:${ee}">${z}</span>
      ${bo(F)}
    </div>`,E=nt(e),K=r.has("hss"),te=`<div class="hw-impact-row${K?" hw-impact-open":""}" data-impact-row="hss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${vo(e,K)}
    </div>`,A=rt(e),Y=r.has("sat_drag"),se=`<div class="hw-impact-row${Y?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${So(e,Y)}
    </div>`,Z=it(e),ne=r.has("gnss"),ke=`<div class="hw-impact-row${ne?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Mo(e,ne)}
    </div>`,J=at(e),de=r.has("cme_cone"),ie=`<div class="hw-impact-row${de?" hw-impact-open":""}" data-impact-row="cme_cone">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      <span class="hw-impact-badge" style="background:${J.color}22;color:${J.color}">${u(J.label)}</span>
      ${Co(e,de)}
    </div>`,q=be(e),pe=r.has("magnetosphere"),ae=`<div class="hw-impact-row${pe?" hw-impact-open":""}" data-impact-row="magnetosphere">
      <span class="hw-impact-caret">\u25B6</span>
    ...
    ${r}
        ...
        <circle cx="6.5" cy="3.8" r=".6" fill="currentColor" stroke="none"/>`)}}function Oo(e){var s;let o=(s=e.metadata)!=null?s:{},t=[];return o.source_code&&t.push(`Code: ${o.source_code}`),o.model&&t.push(`Model: ${String(o.model).toUpperCase()}`),t.length===0?"":`
${t.join(" \xB7 ")}`}function To(e,o,t){var a;let s=e.is_active?Io:(a=Ro[e.level])!=null?a:"#445c64",n=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",r=e.source==="NASA_DONKI"?"DONKI":"SWPC",i=n?`<div class="hw-tl-detail">${u(e.description)}${u(Oo(e))}</div>`:"";return`
    <div class="hw-tl-item" data-timeline-key="${O(e.event_time)}">
      ...
      <div class="hw-tl-body">
        ...
        <div class="hw-tl-title${e.is_active?" hw-tl-active":""}">
          ${Ao(e.event_type)} ${u(e.event_title)}
        </div>
        ${i}
      </div>
    </div>`}function zo(e,o,t,s){var $,w;let n=($=e.timeline)!=null?$:[],c=Date.now(),r=new Date(c).toISOString().slice(0,10),i=new Date(c-864e5).toISOString().slice(0,10),a=new Date(c-1728e5).toISOString().slice(0,10),l=new Set([r,i,a]),d=n.filter(f=>{var b;return l.has(((b=f.event_time)!=null?b:"").slice(0,10))}).slice().reverse(),p=d.length,m=t?"\u25BC":"\u25B6",g=p>0?`Solar Activity Timeline (${p})`:"Solar Activity Timeline",h=`
    ...
    </div>`;if(!t||p===0)return`<div class="hw-timeline">${h}</div>`;let x=new Map;for(let f of d){let b=((w=f.event_time)!=null?w:"").slice(0,10);x.has(b)||x.set(b,[]),x.get(b).push(f)}let v=[...x.entries()].map(([f,b])=>{let S=new Date(f+"T12:00:00Z").toLocaleDateString("en-US",{month:"short",day:"numeric",timeZone:"UTC"}),k=s.has(f),M=k?"\u25B6":"\u25BC",C=k?`<span class="hw-tl-day-count">${b.length} events</span>`:"",_=`
      <div class="hw-tl-day-row" data-tl-day="${O(f)}">
        <span class="hw-section-caret">${M}</span>
        <span class="hw-tl-date">${S}</span>
        ${C}
      </div>`,L=k?"":b.map((R,N)=>To(R,N<b.length-1,o)).join("");return`<div class="hw-tl-group">${_}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function No(e,o,t){var l;let s=(l=e.alerts_all)!=null?l:[],n=s.length,c=o?"\u25BC":"\u25B6",r=n>0?`SWPC Alerts (${n})`:"SWPC Alerts",i=`
    ...
    </div>`;if(!o||n===0)return`<div class="hw-alerts">${i}${o&&n===0?'<div class="hw-empty-alerts">No significant recent SWPC alerts</div>':""}</div>`;let a=s.map(d=>Fo(d,d.dedupe_key===t)).join("");return`
    <div class="hw-alerts">
      ${i}
      ${a}
    </div>`}function Bo(e,o){var B,X,P;let t=e.cme_tracker;if(!t)return"";let s=(B=ft[t.impact_level])!=null?B:"#96a8b8",n=(X=$t[t.status])!=null?X:t.status,c=300,r=44,i=18,a=r/2,l=10,d=c-18,p=7,m=`<line x1="${i+l}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,g=`<circle cx="${i}" cy="${a}" r="${l}" fill="#f0c040" opacity="0.92"/>`,h=`
    <circle cx="${d}" cy="${a}" r="${p}" fill="#4a90c4" opacity="0.88"/>
    <circle cx="${d}" cy="${a}" r="2.5" fill="#fff" opacity="0.7"/>`,x=`<text x="${i}" y="${a+l+9}" text-anchor="middle" font-size="9" fill="#c8aa60">Sun</text>`,v=`<text x="${d}" y="${a+p+9}" text-anchor="middle" font-size="9" fill="#7ab0d4">Earth</text>`,$="";if(t.progress!=null){let G=i+l+4,W=d-p-4,H=G+t.progress*(W-G),I=5;t.status==="arrival_window"?$=`
        <g transform="translate(${H.toFixed(1)},${a})" class="hw-cme-pulse-dot" style="transform-box:fill-box;transform-origin:center">
          <circle cx="0" cy="0" r="${I}" fill="${s}" opacity="0.92"/>
        </g>`:$=`<circle cx="${H.toFixed(1)}" cy="${a}" r="${I}" fill="${s}" opacity="0.85"/>`}let w=`<svg class="hw-cme-svg" viewBox="0 0 ${c} ${r}" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
    ${m}
    ${g}${x}
    ${h}${v}
    ${$}
  </svg>`,f=Ne(t.arrival_time_utc),b=Ne(t.launch_time_utc),y=t.speed_kms!=null?`${Math.round(t.speed_kms)} km/s`:"\u2014",S=t.half_angle_deg!=null?`${t.half_angle_deg}\xB0`:"\u2014",k=(P=t.source_location)!=null?P:"\u2014",M=t.is_earth_direct?"Direct hit":"Glancing blow",C=t.progress!=null?`${Math.round(t.progress*100)}%`:"\u2014",_=`
    <div class="hw-cme-detail">
      <div class="hw-cme-stat-grid">
        ...
        <div class="hw-cme-stat">
          ...
          <span class="hw-cme-stat-value" style="color:${s}">${u(y)}</span>
        </div>
        <div class="hw-cme-stat">
          <span class="hw-cme-stat-label">Impact</span>
          <span class="hw-cme-stat-value" style="color:${s}">${u(t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1))}</span>
        </div>
        <div class="hw-cme-stat">
        ...
        <div class="hw-cme-stat">
          ...
          <span class="hw-cme-stat-value">${u(C)}</span>
        </div>
      </div>
      <div class="hw-cme-note">Half-angle: ${u(S)} \xB7 Source: ${u(k)} \xB7 ${u(M)} \xB7 Model: Enlil (NASA DONKI)</div>
    </div>`,L=o?"\u25BC":"\u25B6",R=t.impact_level==="unknown"?"Unrated":t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1),N=o?`${w}${_}`:"";return`
    <div class="hw-cme">
      <div class="hw-cme-row" data-cme-toggle>
        ...
        <span class="hw-cme-badge" style="background:${s}22;color:${s};margin-left:auto">${u(n)}</span>
        <span class="hw-cme-badge" style="background:${s}15;color:${s};margin-left:4px">${u(R)} impact</span>
      </div>
      ${N}
    </div>`}function Po(e,o,t,s,n,c,r,i,a,l,d,p,m,g,h,x,v,$){var M;let w=Qt(e,s),f=(M=e.metrics.kp_history_1h)!=null?M:[],b=f.length?ue(f[f.length-1].t_utc):null,y=b?`Recent history \xB7 Last step ${b}`:"Recent history",S=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    <span class="hw-section-caret">${t?"\u25BC":"\u25B6"}</span>
    <span class="hw-section-label" style="margin-bottom:0">${O(y)}</span>
  </div></div>`,k=t?Yt(e):"";return`
    <div class="hw-root">
      ${Wt(e)}
      ${jt(e,t,w,v,$)}
      ${_o(e)}
      ...
      ${zo(e,r,i,a)}
      ${No(e,n,c)}
    </div>`}function Do(e){return`<div class="hw-root">
