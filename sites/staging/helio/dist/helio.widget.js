"use strict";var HelioWidgetModule=(()=>{var de=Object.defineProperty,at=Object.defineProperties,ct=Object.getOwnPropertyDescriptor,lt=Object.getOwnPropertyDescriptors,dt=Object.getOwnPropertyNames,He=Object.getOwnPropertySymbols;var Ee=Object.prototype.hasOwnProperty,pt=Object.prototype.propertyIsEnumerable;var Le=(e,o,t)=>o in e?de(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,pe=(e,o)=>{for(var t in o||(o={}))Ee.call(o,t)&&Le(e,t,o[t]);if(He)for(var t of He(o))pt.call(o,t)&&Le(e,t,o[t]);return e},he=(e,o)=>at(e,lt(o));var ht=(e,o)=>{for(var t in o)de(e,t,{get:o[t],enumerable:!0})},mt=(e,o,t,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of dt(o))!Ee.call(e,n)&&n!==t&&de(e,n,{get:()=>o[n],enumerable:!(s=ct(o,n))||s.enumerable});return e};var gt=e=>mt(de({},"__esModule",{value:!0}),e);var No={};ht(No,{HelioWidget:()=>nt});var ue={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},Ye={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},ut={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},fe={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},wt={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},xt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function ft(e){if(!e)return"Update time unavailable";try{let o=Math.round((Date.now()-new Date(e).getTime())/6e4);if(o<1)return"Updated just now";if(o<60)return`Updated ${o} min ago`;let t=Math.floor(o/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(o){return"Updated recently"}}function $t(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function me(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e}}function we(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e.slice(11,16)}}function Fe(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function F(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function w(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Ie={G:["magnetosphere"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},bt=2400;function We(){var e,o;try{let t=(o=(e=globalThis.location)==null?void 0:e.hostname)!=null?o:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function vt(e){let o=[],t=null;for(let s of e){let n=document.getElementById(s);n instanceof HTMLElement?(t||(t=n),o.push(n)):We()&&console.warn(`[Helio] Hero chip nav: missing element #${s}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let s of o)s.classList.add("section-flash"),window.setTimeout(()=>s.classList.remove("section-flash"),bt)}function Ae(e){let o=e.trim();return o.toUpperCase().startsWith("X:")?o.slice(2).trim()||"\u2014":o||"\u2014"}function ye(e,o){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==o)return 0;let s=parseInt(t.slice(1),10);return!isFinite(s)||s<0?0:Math.min(5,s)}function ke(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function yt(e){var c,r,i;let o=e.trim().toUpperCase();if(o==="\u2014"||o===""||o==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=fe[o])!=null?c:"#a0b4b8",s={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},n={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(r=s[o])!=null?r:"#1e2830",borderColor:(i=n[o])!=null?i:"#3a4c52"}}function kt(e,o){var c,r,i,a,l,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",s={g:(c=o==null?void 0:o.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Ae(t)},n=(r=e.hero)==null?void 0:r.scales;return n?{g:(i=n.g)!=null?i:s.g,r:(a=n.r)!=null?a:s.r,s:(l=n.s)!=null?l:s.s,x:Ae((d=n.x)!=null?d:s.x)}:s}var _t=`
...
`,Re=!1;function St(){if(Re)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=_t,document.head.appendChild(e),Re=!0}function Mt(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.length,n=o/s,c=e.map((r,i)=>{let a=Math.max(2,Math.min(t,r.kp/9*t)),l=t-a,d=i*n,p=r.kp>=6?"#e05c5c":r.kp>=5?"#e0a84a":r.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${l.toFixed(1)}" width="${(n-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${r.kp.toFixed(1)} \xB7 ${w(we(r.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function Oe(e,o,t,s,n){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,r=Math.min(...e),i=Math.max(...e),a=i-r||1,l=m=>s-2-(m-r)/a*(s-4),d=e.map((m,h)=>`${(h/(e.length-1)*c).toFixed(1)},${l(m).toFixed(1)}`).join(" "),p="";if(n&&r<0&&i>0){let m=l(0);p=`<line x1="0" y1="${m.toFixed(1)}" x2="${c}" y2="${m.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let g=e.map((m,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${s}" fill="transparent"><title>${w(o[h]||"")} \xB7 ${m.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${s}" style="width:100%;height:${s}px;display:block" preserveAspectRatio="none">
  ...
  </g>`,A="";if(e==="magnetosphere"){let z=(T=o.windKms)!=null?T:0,j=z>500,D=z<350,E=(j?.5:D?1.4:.9)*1.3,K=z>700?"#e05c5c":z>500?"#e0a84a":z>350?"#d4c840":"#5cce8c",ee=i+8,J=x-14,O=8,Y=6,U=(J-ee)/(O-1),te=260/(Y+1),Q=38,ie=24,$e=2,be=Array.from({length:O},(se,re)=>{let V=ee+re*U,rt=Array.from({length:Y},(it,ve)=>{let ne=te*(ve+1);return`<path d="M ${V.toFixed(1)},${ne.toFixed(1)} L ${(V+Q).toFixed(1)},${ne.toFixed(1)} M ${(V+ie).toFixed(1)},${(ne-6).toFixed(1)} L ${(V+Q).toFixed(1)},${ne.toFixed(1)} L ${(V+ie).toFixed(1)},${(ne+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:$e},(it,ve)=>{let ne=-((O-re)/O*E)-ve*E/$e;return`<g style="opacity:.12;animation:hw-arrow-chase ${E}s linear ${ne.toFixed(3)}s infinite">${rt}</g>`}).join("")}).join(""),oe=(I=o.bz)!=null?I:null,le=oe==null?"":(()=>{let se=oe>0?"#5cce8c":"#e05c5c";return`${oe>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
  ...
  </div>`}function Tt(e,o,t,s){switch(o){case"solar_wind":return Ht(e);case"xray":return Lt(e);case"imf_bz":return Ft(e);case"aurora":return Ot(t,s);case"magnetosphere":return At(e);default:return""}}function zt(e,o){if(e.length<2)return"\u2192";let t=e[e.length-1],s=Math.max(0,e.length-4),n=e[s];if(!isFinite(t)||!isFinite(n))return"\u2192";let c=t-n;return c>o?"\u2191":c<-o?"\u2193":"\u2192"}var Nt={quiet:"171",active:"195",elevated:"284",storm:"304"};function Pt(e,o){var s,n,c;if(o==null)return(n=(s=e.summary)==null?void 0:s.status)!=null?n:"quiet";let t=parseInt(((c=o.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":o.kp>=4?"active":"quiet"}function Bt(e,o){var l,d;let t=(l=Nt[e])!=null?l:"171",s=`/assets/gifs/current_eit_${t}.gif`,n=Ze(s,o),c=ro,r=(d=ue[e])!=null?d:ue.quiet,i=`${r.accent}44`,a=`0 0 10px ${r.accent}55,0 0 24px ${r.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
  ...
  </div>`}function Dt(e,o,t,s,n){var f,b,y;let{summary:c,metrics:r}=e,i=(f=ue[c.status])!=null?f:ue.quiet,a=t!=null?t.kp.toFixed(1):r.kp_latest!=null?r.kp_latest.toFixed(1):"\u2014",l=kt(e,t),p=[{key:"G",text:l.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:l.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:l.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${l.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(S=>{let k;return S.key==="G"?k=ke(ye(l.g,"G")):S.key==="R"?k=ke(ye(l.r,"R")):S.key==="S"?k=ke(ye(l.s,"S")):k=yt(l.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${k.color};background:${k.background};border-color:${k.borderColor}`}" data-hero-chip="${S.key}" title="${F(S.title)}" aria-label="${F(S.aria)}">${w(S.text)}</button>`}).join(""),g=zt(((b=r.kp_history_1h)!=null?b:[]).map(S=>S.kp),.5),m=(y=r.kp_latest)!=null?y:0,h=m>=5,x=h?`linear-gradient(160deg, #0d2a1a 0%, ${i.bg}22 75%)`:`${i.bg}18`,v=Pt(e,t),u=h?`
    ...
    <div class="hw-hero" style="background:${x}">
      ...
      ${u}
    </div>`}function Gt(e){var d,p,g,m;let{metrics:o}=e,t=(d=o.kp_history_1h)!=null?d:[],s=(p=o.wind_history_1h)!=null?p:[],n=(g=o.bz_history_1h)!=null?g:[],c=(m=o.xray_history_1h)!=null?m:[],r=Mt(t),i=Oe(s.map(h=>{var x;return(x=h.kms)!=null?x:0}).filter(h=>h>0),s.map(h=>we(h.t_utc)),"#5cce8c",28,!1),a=Oe(n.map(h=>h.bz),n.map(h=>we(h.t_utc)),"#d4cc5c",28,!0),l=Ct(c);return`
    ...
    <div class="hw-forecast">
      ...
      ${B}`:""}
    </div>`}function Qt(e){let o=/([NS])(\d+)([EW])(\d+)/i.exec(e);return o?{lat:(o[1].toUpperCase()==="N"?1:-1)*parseInt(o[2],10),lon:(o[3].toUpperCase()==="E"?1:-1)*parseInt(o[4],10)}:null}var Qe=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function Vt(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function Zt(e,o,t){let s=o/2,n=s*.87,c=o*.03,r=o*.009,i=e.map(a=>{var $,u;let l=Qt(a.location);if(!l||Math.abs(l.lon)>88||a.location.includes("*"))return"";let d=Vt(a);if(!t.has(d))return"";let p=Qe.find(f=>f.id===d).color,g=l.lat*Math.PI/180,m=l.lon*Math.PI/180,h=(s+n*Math.cos(g)*Math.sin(m)).toFixed(1),x=(s-n*Math.sin(g)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
  ...
  </div>`}var ge={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},et={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function xo(e){var C;let o=ge,t=(C=et[o.phase])!=null?C:"#96a8b8",s=o.phase.charAt(0).toUpperCase()+o.phase.slice(1),n=280,c=52,r=10,i=c-6,a=c-18,l=.5,d=.19,p=_=>Math.exp(-Math.pow((_-l)/d,2)/2),g=_=>r+_*(n-2*r),m=_=>i-p(_)*a,h=80,x=[];for(let _=0;_<=h;_++){let L=_/h;x.push(`${_===0?"M":"L"}${g(L).toFixed(1)},${m(L).toFixed(1)}`)}let v=Math.round(o.progress_0_1*h),$=[];for(let _=0;_<=v;_++){let L=_/h;$.push(`${_===0?"M":"L"}${g(L).toFixed(1)},${m(L).toFixed(1)}`)}let u=g(o.progress_0_1),f=[`M${r},${i}`,...$.slice(1),`L${u.toFixed(1)},${i} Z`],b=m(o.progress_0_1),y=5,S=`M${u.toFixed(1)},${b.toFixed(1)} L${(u-y).toFixed(1)},${(b-y*1.8).toFixed(1)} L${(u+y).toFixed(1)},${(b-y*1.8).toFixed(1)} Z`,k=i+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
  ...
  </div>`}function bo(e,o){var a,l;let t=(a=e.chain_panel)!=null?a:$o(e),s='<div class="hw-chain-arrow">\u203A</div>',n=(l=xe[t.earth.severity])!=null?l:xe.none,c=tt("earth",t.earth.severity,o),r=t.earth.messages.slice(0,3).map(d=>`<span class="hw-chain-msg">${w(d)}</span>`).join(""),i=`<div class="hw-chain-col hw-chain-col-earth" data-chain-col="earth" title="Click to expand Aurora &amp; Storm Risk">
    ...
    ${g}
  </div>`}function So(e,o,t,s,n,c,r,i,a){var oe,le,se,re;let l=(le=(oe=o==null?void 0:o.impacts)!=null?oe:e.observer_impacts)!=null?le:[],d=ko(l,e),p=_o(d,r,i,a),g=l.find(V=>V.kind==="radio"),m=l.find(V=>V.kind==="solar_activity"),h=g?De(g,t,n,c,e,r.has("radio")):"",x=m?De(m,t,n,c,e,!1):"",u=`
    <div class="hw-section-row" data-impacts-toggle>
      ...
      ${wo(e,G)}
    </div>`,I=r.has("solar_cycle"),Z=(re=et[ge.phase])!=null?re:"#96a8b8",z=ge.phase.charAt(0).toUpperCase()+ge.phase.slice(1),D=`<div class="hw-impact-row${I?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${xo(I)}
    </div>`,E=ot(e),K=r.has("sat_drag"),J=`<div class="hw-impact-row${K?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${vo(e,K)}
    </div>`,O=st(e),Y=r.has("gnss"),te=`<div class="hw-impact-row${Y?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
    ...
    ${r}
        ...
        <circle cx="6.5" cy="3.8" r=".6" fill="currentColor" stroke="none"/>`)}}function Eo(e){var s;let o=(s=e.metadata)!=null?s:{},t=[];return o.source_code&&t.push(`Code: ${o.source_code}`),o.model&&t.push(`Model: ${String(o.model).toUpperCase()}`),t.length===0?"":`
${t.join(" \xB7 ")}`}function Fo(e,o,t){var a;let s=e.is_active?Ho:(a=Co[e.level])!=null?a:"#445c64",n=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",r=e.source==="NASA_DONKI"?"DONKI":"SWPC",i=n?`<div class="hw-tl-detail">${w(e.description)}${w(Eo(e))}</div>`:"";return`
    ...
    <div class="hw-section-row" data-tl-section>
      ...
      <div class="hw-tl-day-row" data-tl-day="${F(f)}">
        ...
        ${C}
      </div>`,L=k?"":b.map((A,N)=>Fo(A,N<b.length-1,o)).join("");return`<div class="hw-tl-group">${_}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Ao(e,o,t){var l;let s=(l=e.alerts_all)!=null?l:[],n=s.length,c=o?"\u25BC":"\u25B6",r=n>0?`SWPC Alerts (${n})`:"SWPC Alerts",i=`
    ...
    <div class="hw-cme">
      ...
      ${N}
    </div>`}function Oo(e,o,t,s,n,c,r,i,a,l,d,p,g,m,h,x,v,$){var M;let u=Kt(e,s),f=(M=e.metrics.kp_history_1h)!=null?M:[],b=f.length?me(f[f.length-1].t_utc):null,y=b?`Recent history \xB7 Last step ${b}`:"Recent history",S=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
