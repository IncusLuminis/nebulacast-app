"use strict";var HelioWidgetModule=(()=>{var ue=Object.defineProperty,mt=Object.defineProperties,ut=Object.getOwnPropertyDescriptor,gt=Object.getOwnPropertyDescriptors,wt=Object.getOwnPropertyNames,Oe=Object.getOwnPropertySymbols;var Te=Object.prototype.hasOwnProperty,xt=Object.prototype.propertyIsEnumerable;var ze=(e,s,t)=>s in e?ue(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t,Ne=(e,s)=>{for(var t in s||(s={}))Te.call(s,t)&&ze(e,t,s[t]);if(Oe)for(var t of Oe(s))xt.call(s,t)&&ze(e,t,s[t]);return e},Pe=(e,s)=>mt(e,gt(s));var ft=(e,s)=>{for(var t in s)ue(e,t,{get:s[t],enumerable:!0})},$t=(e,s,t,o)=>{if(s&&typeof s=="object"||typeof s=="function")for(let n of wt(s))!Te.call(e,n)&&n!==t&&ue(e,n,{get:()=>s[n],enumerable:!(o=ut(s,n))||o.enumerable});return e};var bt=e=>$t(ue({},"__esModule",{value:!0}),e);var Ys={};ft(Ys,{HelioWidget:()=>pt});var xe={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},qe={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},vt={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},$e={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},yt={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},kt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function _t(e){if(!e)return"Update time unavailable";try{let s=Math.round((Date.now()-new Date(e).getTime())/6e4);if(s<1)return"Updated just now";if(s<60)return`Updated ${s} min ago`;let t=Math.floor(s/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(s){return"Updated recently"}}function St(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(s){return e}}function ge(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(s){return e}}function fe(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(s){return e.slice(11,16)}}function Be(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(s){return e}}function A(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var De={G:["aurora","storm_risk"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},Mt=2400;function Qe(){var e,s;try{let t=(s=(e=globalThis.location)==null?void 0:e.hostname)!=null?s:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function Ct(e){let s=[],t=null;for(let o of e){let n=document.getElementById(o);n instanceof HTMLElement?(t||(t=n),s.push(n)):Qe()&&console.warn(`[Helio] Hero chip nav: missing element #${o}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let o of s)o.classList.add("section-flash"),window.setTimeout(()=>o.classList.remove("section-flash"),Mt)}function Ge(e){let s=e.trim();return s.toUpperCase().startsWith("X:")?s.slice(2).trim()||"\u2014":s||"\u2014"}function Se(e,s){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==s)return 0;let o=parseInt(t.slice(1),10);return!isFinite(o)||o<0?0:Math.min(5,o)}function Me(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function Ht(e){var i,r,l;let s=e.trim().toUpperCase();if(s==="\u2014"||s===""||s==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(i=$e[s])!=null?i:"#a0b4b8",o={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},n={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(r=o[s])!=null?r:"#1e2830",borderColor:(l=n[s])!=null?l:"#3a4c52"}}function Lt(e,s){var i,r,l,a,c,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",o={g:(i=s==null?void 0:s.gScale)!=null?i:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Ge(t)},n=(r=e.hero)==null?void 0:r.scales;return n?{g:(l=n.g)!=null?l:o.g,r:(a=n.r)!=null?a:o.r,s:(c=n.s)!=null?c:o.s,x:Ge((d=n.x)!=null?d:o.x)}:o}var Ft=`
...
`,Ye=!1;function Et(){if(Ye)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=Ft,document.head.appendChild(e),Ye=!0}function Rt(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let s=200,t=32,o=e.length,n=s/o,i=e.map((r,l)=>{let a=Math.max(2,Math.min(t,r.kp/9*t)),c=t-a,d=l*n,p=r.kp>=6?"#e05c5c":r.kp>=5?"#e0a84a":r.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${c.toFixed(1)}" width="${(n-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${r.kp.toFixed(1)} \xB7 ${u(fe(r.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${s} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${i}</svg>`}function We(e,s,t,o,n){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let i=200,r=Math.min(...e),l=Math.max(...e),a=l-r||1,c=g=>o-2-(g-r)/a*(o-4),d=e.map((g,h)=>`${(h/(e.length-1)*i).toFixed(1)},${c(g).toFixed(1)}`).join(" "),p="";if(n&&r<0&&l>0){let g=c(0);p=`<line x1="0" y1="${g.toFixed(1)}" x2="${i}" y2="${g.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let m=e.map((g,h)=>`<rect x="${(h/(e.length-1)*i-4).toFixed(1)}" y="0" width="8" height="${o}" fill="transparent"><title>${u(s[h]||"")} \xB7 ${g.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${i} ${o}" style="width:100%;height:${o}px;display:block" preserveAspectRatio="none">
    ${p}
    <polyline points="${d}" fill="none" stroke="${t}" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/>
    ${m}
  </svg>`}function It(e){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let s=200,t=32,o=e.map(d=>Math.max(-9,Math.min(-3,Math.log10(d.flux)))),n=Math.min(...o),r=Math.max(...o)-n||1,l=d=>t-2-(d-n)/r*(t-4),a=o.map((d,p)=>`${(p/(o.length-1)*s).toFixed(1)},${l(d).toFixed(1)}`).join(" "),c=e.map((d,p)=>{let m=p/(o.length-1)*s,g=d.flux>=1e-4?"X":d.flux>=1e-5?"M":d.flux>=1e-6?"C":d.flux>=1e-7?"B":"A";return`<rect x="${(m-4).toFixed(1)}" y="0" width="8" height="${t}" fill="transparent"><title>${u(fe(d.t_utc))} \xB7 ${g}-class (${d.flux.toExponential(2)})</title></rect>`}).join("");return`<svg viewBox="0 0 ${s} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">
    ...
    <div class="hw-kpi-hint" style="margin-top:4px">Trend history: \u25B6 HISTORY</div>
  </div>`}function zt(e){let a='<rect x="0" y="16" width="200" height="6" rx="3" fill="#1e2c30"/>',c=[-10,-5,5,10].map(S=>{let k=100+S/20*100;return`<line x1="${k.toFixed(1)}" y1="16" x2="${k.toFixed(1)}" y2="22" stroke="#2a3c42" stroke-width="1"/>`}).join(""),d='<line x1="100" y1="14" x2="100" y2="24" stroke="#3a4c52" stroke-width="1.5"/>';if(e==null)return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">${a}${c}${d}</svg>`;let p=e<=-10?"#e05c5c":e<=-5?"#e0a84a":e<0?"#d4b84a":e>=5?"#5cce8c":"#7acca8",m=Math.max(-20,Math.min(20,e)),g=100+m/20*100,h=3,x=m<0?g-h:100-h,v=Math.max(2*h,Math.abs(g-100)+2*h),b=`<rect x="${x.toFixed(1)}" y="16" width="${v.toFixed(1)}" height="6" rx="${h}" fill="${p}" opacity="0.82"/>`,w=5,f=15,$=f-w*1.1,_=`<polygon points="${g.toFixed(1)},${f.toFixed(1)} ${(g-w).toFixed(1)},${$.toFixed(1)} ${(g+w).toFixed(1)},${$.toFixed(1)}" fill="${p}"/>`,M=`<line x1="${g.toFixed(1)}" y1="${f.toFixed(1)}" x2="${g.toFixed(1)}" y2="${19 .toFixed(1)}" stroke="${p}" stroke-width="1" opacity="0.6"/>`,H=`<text x="${g.toFixed(1)}" y="31" text-anchor="middle" font-size="8" fill="${p}" font-weight="600">${e>=0?"+":""}${e.toFixed(1)}</text>`;return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">
    ${a}${c}${d}${b}${_}${M}${H}
  </svg>`}function Tt(e){var m;let s=e.metrics.imf_bz_nt,t=e.metrics.imf_bt_nt,o=e.metrics.solar_wind_kms,n=(m=e.metrics.pressure_npa)!=null?m:null,i=s!=null?s<=-10?"#e05c5c":s<=-5?"#e0a84a":s>=5?"#5cce8c":"#a0b4b8":"#607880",r=s!=null?(s>=0?"+":"")+s.toFixed(1)+" nT":"\u2014",l=t!=null?t.toFixed(1)+" nT":"\u2014",a=o!=null?`${Math.round(o)} km/s`:"\u2014",c=n!=null?`${n.toFixed(2)} nPa`:"\u2014",d=be(e),p=s!=null&&s<-5?{msg:"Southward IMF \xB7 Aurora favorable",color:"#5cce8c"}:s!=null&&s<0?{msg:"Weakly southward \xB7 Conditions may improve",color:"#d4cc5c"}:{msg:"Northward IMF \xB7 Stable magnetosphere",color:"#96a8b8"};return`<div class="hw-kpi-popover">
    ...
    <div style="font-size:.65em;color:#607880">Coupling: <span style="color:${d.color};font-weight:600">${u(d.coupling)}</span> \xB7 Trend history: \u25B6 Details</div>
      ...
      <path d="${w}" fill="${i}14" stroke="${i}b0" stroke-width="0.9"/>
      <circle cx="45" cy="25" r="${4.5}" fill="#2a4a6a" stroke="#4a7090" stroke-width="0.8"/>
      ${H}
    </svg>`}else{let b=e.state==="storm"?16:e.state==="active"?26:38,w=155-b,f=e.state==="storm"?22:e.state==="active"?30:40,$=120-f,_=240,M=[`M ${w},60`,`C ${w-4},42 150,${f} 155,${f}`,`C 173,${f} ${_-5},${f+18} ${_},60`,`C ${_-5},${$-18} 173,${$} 155,${$}`,`C 150,${$} ${w-4},78 ${w},60`,"Z"].join(" "),y=`M ${w+2},60 C ${w+2},${60-b*.4} 152,54 150,60 C 152,66 ${w+2},${60+b*.4} ${w+2},60 Z`,H=r>700?"#e05c5c":r>500?"#e0a84a":r>350?"#d4c840":"#5cce8c",S=r>700?.4:r>500?.65:r>350?1.1:1.8,k=r>500?[10,24,40,57,74,90,106]:r>350?[14,34,57,82,104]:[20,50,82,108],L=16,T=22,Y=w-6,W=Math.ceil((Y-T)/L)+2,X=Array.from({length:W},(O,E)=>T-L+E*L),N=12,B=8,j=X.flatMap(O=>k.map(E=>`<path d="M ${O},${E} L ${O+N},${E} M ${O+B},${E-3} L ${O+N},${E} L ${O+B},${E+3}" stroke="${H}cc" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`)).join(""),C=`<g class="hw-wg-full" style="animation-duration:${S}s">${j}</g>`,R=s==null?"":s>0?'<path d="M 155,64 L 155,56 M 153,58 L 155,56 L 157,58" stroke="#5cce8c" stroke-width="1.3" fill="none" stroke-linecap="round"/>':'<path d="M 155,56 L 155,64 M 153,62 L 155,64 L 157,62" stroke="#e05c5c" stroke-width="1.3" fill="none" stroke-linecap="round"/>',Q=s==null?"":`<text x="163" y="62" font-size="6" fill="${s>0?"#5cce8c":"#e05c5c"}" font-family="monospace">Bz${s>0?"\u2191":"\u2193"}</text>`;return ve("magnetosphere",{magnetInfo:e,bz:s,windKms:t,uid:n})}}function ve(e,s={}){var C,R,Q,O,E,J;let i=(C=s.uid)!=null?C:"hse",r=0,l=160,a=800,c=17,d=a-c,p=s.magnetInfo,m=(R=p==null?void 0:p.state)!=null?R:"stable",g=(Q=p==null?void 0:p.color)!=null?Q:"#e0a84a",x=a-(m==="storm"?55:m==="active"?80:110),v=m==="storm"?58:m==="active"?76:95,b=1120,w=20,f=[`M ${x},130`,`C ${x-8},${130-v*.55} ${a-18},${130-v} ${a},${130-v}`,`C ${a+120},${130-v} ${b-180},${130-w} ${b},${130-w}`,`L ${b},${130+w}`,`C ${b-180},${130+w} ${a+120},${130+v} ${a},${130+v}`,`C ${a-18},${130+v} ${x-8},${130+v*.55} ${x},130`,"Z"].join(" "),$=e==="magnetosphere",_=$?m==="storm"?"0.12":"0.08":"0.04",M=$?"0.75":"0.28",y=`<g id="${i}-base-sun">
    ...
    <line x1="${d}" y1="130" x2="${a+c}" y2="130"
          stroke="#4a8ab0" stroke-width="1.2" opacity="0.35"/>`,S=`<g id="${i}-base-earth">
    <circle cx="${a}" cy="130" r="${c}" fill="#1a4a6e" opacity="0.92"/>
    ${H}
  </g>`,k=`<g id="${i}-base-magnetosphere">
  ...
  </g>`,L=`<g id="${i}-base-axis">
    <line x1="${l}" y1="130" x2="${x}" y2="130"
          stroke="rgba(255,255,255,0.10)" stroke-width="1.5" stroke-dasharray="8 5"/>
  </g>`,T="";if(e==="magnetosphere"){let z=(O=s.windKms)!=null?O:0,D=z>500,P=z<350,F=(D?.5:P?1.4:.9)*1.3,K=z>700?"#e05c5c":z>500?"#e0a84a":z>350?"#d4c840":"#5cce8c",te=l+8,ee=x-14,I=8,G=6,U=(ee-te)/(I-1),se=260/(G+1),V=38,ae=24,ye=2,ke=Array.from({length:I},(ne,de)=>{let oe=te+de*U,re=Array.from({length:G},(pe,he)=>{let Z=se*(he+1);return`<path d="M ${oe.toFixed(1)},${Z.toFixed(1)} L ${(oe+V).toFixed(1)},${Z.toFixed(1)} M ${(oe+ae).toFixed(1)},${(Z-6).toFixed(1)} L ${(oe+V).toFixed(1)},${Z.toFixed(1)} L ${(oe+ae).toFixed(1)},${(Z+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:ye},(pe,he)=>{let Z=-((I-de)/I*F)-he*F/ye;return`<g style="opacity:.12;animation:hw-arrow-chase ${F}s linear ${Z.toFixed(3)}s infinite">${re}</g>`}).join("")}).join(""),q=(E=s.bz)!=null?E:null,ce=q==null?"":(()=>{let ne=q>0?"#5cce8c":"#e05c5c";return`${q>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
        ...
        fill="${ne}" font-family="monospace">Bz${q>0?"\u2191":"\u2193"}</text>`})();T=`${ke}${ce}`}let Y=`<g id="${i}-overlay-solar-wind">${T}</g>`,W="";if(e==="coronal_hole"&&s.hssState){let z=s.hssState,D=(J=z.speed)!=null?J:0,P=D>=420,F=z.color,K=P?"0.85":"0.25",te=D>=500?"0.18":P?"0.10":"0.04",ee=l+8,I=d-16,G=60,U=`${ee},130 ${I},${130-G} ${I},${130+G}`,se=I+6,V=`${se},120 ${se+18},130 ${se},140`;W=`
    ...
    <polygon points="${V}" fill="${F}" opacity="${P?"0.9":"0.25"}"/>`}let X=`<g id="${i}-overlay-coronal-hole">${W}</g>`,N="";if(e==="cme_cone"&&s.cmeState){let z=s.cmeState,D=l,P=d-10,F=P-D,K=U=>Math.tan(U*Math.PI/180),te=Math.round(K(9)*F),ee=Math.round(K(6)*F),I=Math.round(K(3)*F),G=U=>`${D},130 ${P},${130-U} ${P},${130+U}`;if(z.status!=="quiet"){let U=z.status==="impact"?"#e05c5c":"#d4cc5c";N=`
    ...
    <line x1="${D+14}" y1="130" x2="${P-5}" y2="130"
    ...
    <line x1="${D+14}" y1="130" x2="${d-14}" y2="130"
          stroke="#1e2c30" stroke-dasharray="7 5" stroke-width="2"/>`}let B=`<g id="${i}-overlay-cme-cone">${N}</g>`,j=`<g id="${i}-overlay-labels">
    ...
    <div style="border-radius:3px;overflow:hidden;margin-bottom:6px">${ve("magnetosphere",{windKms:n!=null?n:void 0,bz:o!=null?o:void 0})}</div>
    <div class="hw-kpi-stat-row">
      <div class="hw-kpi-stat">
        <span class="hw-kpi-stat-label">Solar wind</span>
        <span class="hw-kpi-stat-value" style="color:${m}">${u(a)}</span>
  ...
  </div>`}function Gt(e,s,t,o){switch(s){case"solar_wind":return At(e);case"xray":return Ot(e);case"imf_bz":return Tt(e);case"aurora":return Dt(t,o);case"magnetosphere":return Pt(e);default:return""}}function Yt(e,s){if(e.length<2)return"\u2192";let t=e[e.length-1],o=Math.max(0,e.length-4),n=e[o];if(!isFinite(t)||!isFinite(n))return"\u2192";let i=t-n;return i>s?"\u2191":i<-s?"\u2193":"\u2192"}var Wt={quiet:"171",active:"195",elevated:"284",storm:"304"};function jt(e,s){var o,n,i;if(s==null)return(n=(o=e.summary)==null?void 0:o.status)!=null?n:"quiet";let t=parseInt(((i=s.gScale)!=null?i:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":s.kp>=4?"active":"quiet"}function Ut(e,s){var c,d;let t=(c=Wt[e])!=null?c:"171",o=`/assets/gifs/current_eit_${t}.gif`,n=ds(o,s),i=hs,r=(d=xe[e])!=null?d:xe.quiet,l=`${r.accent}44`,a=`0 0 10px ${r.accent}55,0 0 24px ${r.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
    <div class="hw-solar-mini-inner" style="border-color:${l};box-shadow:${a}">
      <img class="hw-solar-mini-img" src="${A(n)}" alt="Sun EIT ${A(t)}"
        onerror="if(this.src!=='${A(i)}')this.src='${A(i)}'" />
    </div>
  </div>`}function Xt(e,s,t,o,n){var f,$,_;let{summary:i,metrics:r}=e,l=(f=xe[i.status])!=null?f:xe.quiet,a=t!=null?t.kp.toFixed(1):r.kp_latest!=null?r.kp_latest.toFixed(1):"\u2014",c=Lt(e,t),p=[{key:"G",text:c.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:c.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:c.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${c.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(M=>{let y;return M.key==="G"?y=Me(Se(c.g,"G")):M.key==="R"?y=Me(Se(c.r,"R")):M.key==="S"?y=Me(Se(c.s,"S")):y=Ht(c.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${y.color};background:${y.background};border-color:${y.borderColor}`}" data-hero-chip="${M.key}" title="${A(M.title)}" aria-label="${A(M.aria)}">${u(M.text)}</button>`}).join(""),m=Yt((($=r.kp_history_1h)!=null?$:[]).map(M=>M.kp),.5),g=(_=r.kp_latest)!=null?_:0,h=g>=5,x=h?`linear-gradient(160deg, #0d2a1a 0%, ${l.bg}22 75%)`:`${l.bg}18`,v=jt(e,t),w=h?`
    ...
    <div class="hw-hero" style="background:${x}">
      <div class="hw-hero-main">
        <div class="hw-kp-col">
          ...
          <span class="hw-status-badge" style="background:${l.accent}22;color:${l.accent};display:block;text-align:center">${u(i.label)}</span>
      ...
      ${w}
    </div>`}function Kt(e){var d,p,m,g;let{metrics:s}=e,t=(d=s.kp_history_1h)!=null?d:[],o=(p=s.wind_history_1h)!=null?p:[],n=(m=s.bz_history_1h)!=null?m:[],i=(g=s.xray_history_1h)!=null?g:[],r=Rt(t),l=We(o.map(h=>{var x;return(x=h.kms)!=null?x:0}).filter(h=>h>0),o.map(h=>fe(h.t_utc)),"#5cce8c",28,!1),a=We(n.map(h=>h.bz),n.map(h=>fe(h.t_utc)),"#d4cc5c",28,!0),c=It(i);return`
    ...
    </div>`}function qt(e){let s=_t(e.updated_utc);return`
    <div class="hw-header">
      <span class="hw-header-title">Space Weather</span>
      <span class="hw-freshness">${u(s)}</span>
    </div>`}function Qt(e){return e.map((s,t)=>t===0?(s+e[1])/2:t===e.length-1?(e[t-1]+s)/2:(e[t-1]+s+e[t+1])/3)}function Vt(e){return e>=9?"G5":e>=8?"G4":e>=7?"G3":e>=6?"G2":e>=5?"G1":"G0"}function Zt(e){return e>=5?"good":e>=3?"possible":"none"}function Je(e){return e>=9?40:e>=8?45:e>=7?50:e>=6?55:e>=5?60:null}function Jt(e){let s=e>=7?"high":e>=5?"moderate":e>=3?"low":"none",t=Je(e),o=s==="none"?"No aurora expected at mid-latitudes":t!=null?`Aurora possible equatorward of ~${t}\xB0 lat`:"Minor aurora possible at high latitudes",n=e>=7?"moderate":e>=5?"low":"none",i=n==="none"?"No significant HF degradation expected":n==="low"?"Minor HF degradation at high latitudes":"Moderate HF degradation, possible blackouts at high latitudes",r=e>=8?"high":e>=6?"moderate":e>=4?"low":"none";return[{kind:"aurora",level:s,label:"Aurora",summary:o},{kind:"radio",level:n,label:"HF Radio",summary:i},{kind:"solar_activity",level:r,label:"Solar Activity",summary:r==="none"?"Quiet geomagnetic conditions expected":r==="low"?"Active geomagnetic conditions possible":r==="moderate"?"Minor to moderate storm conditions":"Major geomagnetic storm conditions"}]}function es(e,s){var p;if(s<=0)return null;let t=(p=e.metrics.kp_forecast_3h)!=null?p:[];if(!t.length)return null;let o=Date.now()+s*36e5,n=t[0],i=1/0;for(let m of t){let g=Math.abs(new Date(m.t_utc).getTime()-o);g<i&&(i=g,n=m)}let r=n.kp,l=Vt(r),a=Zt(r),c=Je(r),d=Jt(r);return{offsetH:s,kp:r,gScale:l,auroraLabel:a,auroraMinLat:c,impacts:d}}function ts(e,s,t,o){var j;let{forecast:n,metrics:i}=e,{kp_max_next_24h:r,kp_max_at_utc:l,trend:a}=n,c=((j=i.kp_forecast_3h)!=null?j:[]).slice(0,16),d=c.length,p=d*3,m=p>0?`${(s/p*100).toFixed(0)}%`:"0%",g=s>0?`\u23F1 +${Math.round(s)}h`:"Timeline",h="Kp forecast unavailable";if(r!=null){let C=ge(l),R=a==="rising"?"rising":a==="falling"?"falling":"steady";h=`Peak Kp ${r.toFixed(1)} next 24h${C?` at ${C}`:""} \xB7 ${R}`}let x=c.length?ge(c[0].t_utc):null,v=x?`Forecast \xB7 Next step ${x}`:"Forecast";if(!c.length)return`
    ...
    </div>`;let b=320,w=38,f=14,$=w+f,_=b/d,M=C=>w-Math.max(2,Math.min(w-2,C/9*(w-2))),y="",H=c.map(C=>C.kp),S=Qt(H);c.forEach((C,R)=>{let Q=M(C.kp),O=w-Q,E=R*_,J=E+_/2,z=C.kp>=6?"#e05c5c":C.kp>=5?"#e0a84a":C.kp>=4?"#d4cc5c":"#5cce8c",D=`Kp ${C.kp.toFixed(1)} \xB7 ${ge(C.t_utc)}`;if(y+=`<rect x="${E.toFixed(1)}" y="${Q.toFixed(1)}" width="${(_-1.5).toFixed(1)}" height="${O.toFixed(1)}" fill="${z}" fill-opacity="0.85" rx="1.5"/>`,y+=`<rect x="${E.toFixed(1)}" y="0" width="${_.toFixed(1)}" height="${w}" fill="transparent"><title>${A(D)}</title></rect>`,d<=8||R%2===0){let F=new Date(C.t_utc).getHours();y+=`<text x="${J.toFixed(1)}" y="${($-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${F.toString().padStart(2,"0")}</text>`}});let L=`<polyline points="${c.map((C,R)=>{let Q=R*_+_/2,O=M(S[R]);return`${Q.toFixed(1)},${O.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,T="";if(s>0&&d>0){let C=Math.min(b-1,s/(d*3)*b);T=`
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
    ...
    <div class="hw-radio-meta">X-ray: <b style="color:${(p=$e[o])!=null?p:"#a0b4b8"}">${u(o)}-class</b> \xB7 ${u(i)}</div>
  </div>`}var st={0:"Quiet",1:"Minor Storm",2:"Moderate Storm",3:"Strong Storm",4:"Severe Storm",5:"Extreme Storm"};function gs(e){return e>=9?5:e>=8?4:e>=7?3:e>=6?2:e>=5?1:0}function ie(e,s){if(e<s-.7)return 0;if(e>s+1)return .9;let t=(e-(s-.7))/1.7;return Math.round(Math.pow(Math.max(0,t),.7)*90)/100}function ws(e){var c,d,p;let s=parseInt(((c=e.scales.g_scale)!=null?c:"G0").replace(/\D/g,""),10),t=Math.max(0,Math.min(5,Number.isFinite(s)?s:0)),o=(d=e.metrics.kp_forecast_3h)!=null?d:[],n=Date.now(),i=n+24*60*60*1e3,r=o.filter(m=>{let g=new Date(m.t_utc).getTime();return g>=n-3*60*60*1e3&&g<=i}),l=r.length===0?0:Math.max(...r.map(m=>m.kp)),a={G1:ie(l,5),G2:ie(l,6),G3:ie(l,7),G4:ie(l,8),G5:ie(l,9),max_expected:gs(l)};return{now:{g_level:t,label:(p=st[t])!=null?p:"Quiet"},forecast_24h:a}}function xs(e){if(!e||typeof e!="object")return null;let s=e,t=s.now,o=s.forecast_24h;if(!t||!o)return null;let n=typeof t.g_level=="number"?t.g_level:parseInt(String(t.g_level),10),i=typeof t.label=="string"?t.label:"Quiet";if(!Number.isFinite(n))return null;let r=c=>{let d=typeof c=="number"?c:parseFloat(String(c));return Number.isFinite(d)?Math.max(0,Math.min(1,d)):0},l=o.max_expected,a=typeof l=="number"&&Number.isFinite(l)?Math.max(0,Math.min(5,Math.round(l))):0;return{now:{g_level:Math.max(0,Math.min(5,Math.round(n))),label:i},forecast_24h:{G1:r(o.G1),G2:r(o.G2),G3:r(o.G3),G4:r(o.G4),G5:r(o.G5),max_expected:a}}}function ot(e){var s;return(s=xs(e.storm_risk))!=null?s:ws(e)}function nt(e){return e>=4?"#e05c5c":e>=3?"#e0a84a":e>=1?"#d4cc5c":"#607880"}var je={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function fs(e){var c,d,p;let s=(c=e.metrics.kp_latest)!=null?c:0,t=e.metrics.imf_bz_nt,o=e.metrics.solar_wind_kms,n=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,i=s>=5||n>=1,r=(p=e.metrics.kp_history_1h)!=null?p:[],l=0;if(r.length>=2&&(l=r[r.length-1].kp-r[r.length-2].kp),!i)return{active:!1,phase:"quiet",kp_current:s,kp_trend:l,bz_nt:t,solar_wind_kms:o};let a;return l>.3&&(t==null||t<-5)?a="rising":l<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:s,kp_trend:l,bz_nt:t,solar_wind_kms:o}}function $s(e){if(!e.active)return"";let s=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=s.findIndex(l=>l.key===e.phase),o=je[e.phase],n=s[t].label,i=s.map((l,a)=>{let c=a===t,d=a<t,p=je[l.key],m=c?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",g=c?" hw-spi-dot-active":"",h=c?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",x=a<s.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
  ...
  </div>`}function bs(e,s){let t=Math.max(0,Math.min(5,Math.round(e))),o=70,n=76,i=48,l=i-9,a=Math.PI,c=w=>a*(1-w/5),d=(w,f)=>({x:o+f*Math.cos(w),y:n-f*Math.sin(w)}),p=(w,f,$)=>{let _=d(w,i),M=d(f,i),y=d(w,l),H=d(f,l);return`<path d="M ${y.x.toFixed(2)} ${y.y.toFixed(2)} L ${_.x.toFixed(2)} ${_.y.toFixed(2)} A ${i} ${i} 0 0 1 ${M.x.toFixed(2)} ${M.y.toFixed(2)} L ${H.x.toFixed(2)} ${H.y.toFixed(2)} A ${l} ${l} 0 0 0 ${y.x.toFixed(2)} ${y.y.toFixed(2)} Z" fill="${$}"/>`},m=w=>{let f=c(w),$=d(f,i+1),_=d(f,i-5);return`<line x1="${$.x.toFixed(2)}" y1="${$.y.toFixed(2)}" x2="${_.x.toFixed(2)}" y2="${_.y.toFixed(2)}" stroke="#2a3a40" stroke-width="1" stroke-linecap="round"/>`},g=d(c(t),i-2),h=`<line x1="${o}" y1="${n}" x2="${g.x.toFixed(2)}" y2="${g.y.toFixed(2)}" stroke="#c8d6dc" stroke-width="2" stroke-linecap="round"/>`,x=`<circle cx="${o}" cy="${n}" r="3.5" fill="#3a4c52" stroke="#1e2c30" stroke-width="1"/>`,v=p(c(0),c(2),"#3d8f62")+p(c(2),c(4),"#b8982a")+p(c(4),c(5),"#b04048"),b=[0,1,2,3,4,5].map(m).join("");return`<div class="hw-storm-risk-gauge" role="img" aria-label="${A(s)} G${t}">
    <svg viewBox="0 0 140 88" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="140" height="88" fill="none"/>
      <path d="M ${d(a,i).x.toFixed(2)} ${d(a,i).y.toFixed(2)} A ${i} ${i} 0 0 1 ${d(0,i).x.toFixed(2)} ${d(0,i).y.toFixed(2)}" fill="none" stroke="#1a2428" stroke-width="2" stroke-linecap="round"/>
      ${v}
      ${b}
      ${h}
      ${x}
      <text x="${o}" y="84" text-anchor="middle" fill="#8a9ca8" font-size="11" font-family="inherit" font-weight="600">G${t}</text>
    </svg>
  </div>`}function vs(e,s){var v;let t=ot(e),o=fs(e),n=t.forecast_24h,i=n.G4>1e-6||n.G5>1e-6,r=n.G5>1e-6,l=r?5:4,a=r?n.G5:n.G4,c=r?"G5":"G4",d=(v=st[l])!=null?v:"Severe Storm",m=`
    <div class="hw-storm-risk-now">
      <div class="hw-storm-risk-now-num" style="color:${nt(t.now.g_level)}">G${t.now.g_level}</div>
      <div class="hw-storm-risk-now-lbl">${u(t.now.label)}</div>
    </div>`,g=Math.max(0,Math.min(5,Math.round(n.max_expected))),h;if(i){let b=Math.round(a*100);h=`
        <div class="hw-storm-severe" role="alert">
          <div class="hw-storm-severe-title">Severe storm risk</div>
          <div class="hw-storm-severe-g">${c} expected \xB7 ${u(d)}</div>
          <div class="hw-storm-severe-p">Probability: <b style="color:#e8c4c4">${b}%</b></div>
        </div>`}else h=`
        <div class="hw-storm-risk-fc-gauge">${bs(g,"24h max implied storm level")}</div>
        <div class="hw-gstorm-footer" style="margin-top:4px">From Kp forecast \xB7 max implied G${n.max_expected}</div>`;return`<div class="hw-impact-tip${s?" hw-impact-tip-open":""}">
    ${$s(o)}
  ...
  </div>`}var we={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},rt={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function ys(e){var S;let s=we,t=(S=rt[s.phase])!=null?S:"#96a8b8",o=s.phase.charAt(0).toUpperCase()+s.phase.slice(1),n=280,i=52,r=10,l=i-6,a=i-18,c=.5,d=.19,p=k=>Math.exp(-Math.pow((k-c)/d,2)/2),m=k=>r+k*(n-2*r),g=k=>l-p(k)*a,h=80,x=[];for(let k=0;k<=h;k++){let L=k/h;x.push(`${k===0?"M":"L"}${m(L).toFixed(1)},${g(L).toFixed(1)}`)}let v=Math.round(s.progress_0_1*h),b=[];for(let k=0;k<=v;k++){let L=k/h;b.push(`${k===0?"M":"L"}${m(L).toFixed(1)},${g(L).toFixed(1)}`)}let w=m(s.progress_0_1),f=[`M${r},${l}`,...b.slice(1),`L${w.toFixed(1)},${l} Z`],$=g(s.progress_0_1),_=5,M=`M${w.toFixed(1)},${$.toFixed(1)} L${(w-_).toFixed(1)},${($-_*1.8).toFixed(1)} L${(w+_).toFixed(1)},${($-_*1.8).toFixed(1)} Z`,y=l+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
  ...
  </div>`}function at(e){var a,c,d,p,m;let s=(c=(a=e.coronal_hole)==null?void 0:a.estimated_speed_kms)!=null?c:e.metrics.solar_wind_kms,t=(d=e.coronal_hole)==null?void 0:d.status,o=s!=null?s:0,n=t!=null?t:o>=600?"strong":o>=500?"active":o>=420?"watch":"quiet",i={strong:"#e05c5c",active:"#e0a84a",watch:"#d4cc5c",quiet:"#5cce8c"},r={strong:"Strong",active:"Active",watch:"Watch",quiet:"None"},l={strong:"Strong high-speed stream",active:"High-speed stream active",watch:"Elevated solar wind",quiet:"Background solar wind"};return{status:n,color:i[n],label:r[n],desc:(m=(p=e.coronal_hole)==null?void 0:p.note)!=null?m:l[n],speed:s}}function ks(e,s){var c;let t=at(e),o=(c=t.speed)!=null?c:0,n=t.speed!=null?`${Math.round(t.speed)} km/s`:"\u2014",i=s?" hw-impact-tip-open":"",r=o>=420,l=ve("coronal_hole",{hssState:t,uid:"hss"}),a=r?'<div class="hw-hss-meta" style="font-size:.72em">Elevated speed may indicate Earth-facing coronal hole stream</div>':'<div class="hw-hss-meta" style="font-size:.72em">Background solar wind \xB7 no HSS detected</div>';return`<div class="hw-impact-tip${i}">
    ${l}
    <div class="hw-hss-meta">Solar wind: <b style="color:${t.color}">${u(n)}</b> \xB7 ${u(t.desc)}</div>
    ${a}
  </div>`}function it(e){var n,i;let s=(n=e.scales.g_scale)!=null?n:"G0",t=parseInt(s.slice(1),10),o=e.metrics.kp_latest;if(o==null){let r=(i=e.metrics.kp_forecast_3h)!=null?i:[],l=Date.now(),a=r.filter(c=>new Date(c.t_utc).getTime()<=l+3*60*60*1e3).sort((c,d)=>new Date(d.t_utc).getTime()-new Date(c.t_utc).getTime());a.length>0&&(o=a[0].kp)}return t>=2||o!=null&&o>=6?{level:2,color:"#e05c5c",label:"High",kp:o,gScale:s}:t>=1||o!=null&&o>=4?{level:1,color:"#d4cc5c",label:"Moderate",kp:o,gScale:s}:{level:0,color:"#5cce8c",label:"Low",kp:o,gScale:s}}function _s(e,s){let t=it(e),o=s?" hw-impact-tip-open":"",i=[{l:0,label:"Low",color:"#5cce8c",width:33,desc:"Normal density"},{l:1,label:"Moderate",color:"#d4cc5c",width:64,desc:"Elevated density"},{l:2,label:"High",color:"#e05c5c",width:100,desc:"Strong expansion"}].map(a=>{let c=a.l===t.level,d=c?a.color:"#566068",p=c?"0.88":"0.16";return`<div class="hw-satdrag-rung">
  ...
  </div>`}function lt(e){var c,d,p;let s=(c=e.scales.g_scale)!=null?c:"G0",t=parseInt(s.slice(1),10),o=e.metrics.kp_latest;if(o==null){let m=(d=e.metrics.kp_forecast_3h)!=null?d:[],g=Date.now(),h=m.filter(x=>new Date(x.t_utc).getTime()<=g+3*60*60*1e3).sort((x,v)=>new Date(v.t_utc).getTime()-new Date(x.t_utc).getTime());h.length>0&&(o=h[0].kp)}let n=0;t>=2||o!=null&&o>=6?n=2:(t>=1||o!=null&&o>=4)&&(n=1);let i=parseInt(((p=e.scales.r_scale)!=null?p:"R0").slice(1),10),r=i>=2&&n<2;i>=2&&(n=Math.min(2,n+1));let l={0:"#5cce8c",1:"#d4cc5c",2:"#e05c5c"},a={0:"Low",1:"Moderate",2:"High"};return{level:n,color:l[n],label:a[n],kp:o,gScale:s,boostedByFlare:r}}function Ss(e,s){var c;let t=lt(e),o=s?" hw-impact-tip-open":"",i=[{l:0,label:"Low",color:"#5cce8c",width:33},{l:1,label:"Moderate",color:"#d4cc5c",width:64},{l:2,label:"High",color:"#e05c5c",width:100}].map(d=>{let p=d.l===t.level,m=p?d.color:"#566068",g=p?"0.88":"0.16";return`<div class="hw-gnss-rung">
    ...
    ${a}
  </div>`}function ct(e){var n;let s=e.metrics.pressure_npa,t=s!=null?s:null,o=(n=e.metrics.density)!=null?n:null;return t==null?{pressure:null,color:"#607880",label:"\u2014",density:o}:t>=6?{pressure:t,color:"#e05c5c",label:"Extreme",density:o}:t>=4?{pressure:t,color:"#e0a84a",label:"Strong",density:o}:t>=2?{pressure:t,color:"#d4cc5c",label:"Elevated",density:o}:t>=1?{pressure:t,color:"#5cce8c",label:"Typical",density:o}:{pressure:t,color:"#7a9298",label:"Weak",density:o}}function Ms(e,s){let t=ct(e),o=s?" hw-impact-tip-open":"",n=t.pressure,i=200,r=6,l=10,a=r+l,c=a+4,d=c+11,p=a+9,m=d+4,h=[{x:0,w:50,color:"#5cce8c"},{x:50,w:50,color:"#d4cc5c"},{x:100,w:50,color:"#e0a84a"},{x:150,w:50,color:"#e05c5c"}].map(S=>`<rect x="${S.x}" y="${r}" width="${S.w}" height="${l}" fill="${S.color}" opacity="0.55" rx="0"/>`).join(""),x=[{x:0,label:"0",anchor:"start"},{x:50,label:"2",anchor:"middle"},{x:100,label:"4",anchor:"middle"},{x:150,label:"6",anchor:"middle"},{x:200,label:"8+",anchor:"end"}],v=x.map(S=>`<line x1="${S.x}" y1="${a}" x2="${S.x}" y2="${c}" stroke="#3a5058" stroke-width="1"/>`).join(""),b=x.map(S=>`<text x="${S.x}" y="${d}" class="hw-swdp-axlabel" text-anchor="${S.anchor}">${S.label}</text>`).join(""),w="";if(n!=null){let k=Math.min(Math.max(n,0),8)/8*i;w=`<polygon points="${`${k-5},${p} ${k+5},${p} ${k},${a}`}" fill="${t.color}" opacity="0.95"/>
    <line x1="${k}" y1="${r}" x2="${k}" y2="${a}" stroke="${t.color}" stroke-width="1.5" opacity="0.7"/>`}let f=`<rect x="0" y="${r}" width="${i}" height="${l}" fill="none" stroke="#2a3c42" stroke-width="0.8" rx="0"/>`,$=`<svg class="hw-swdp-gauge" viewBox="0 0 ${i} ${m}" preserveAspectRatio="none" aria-hidden="true">
    ${h}${f}${w}${v}${b}
  </svg>`,_=n!=null?`${n.toFixed(2)} nPa`:"\u2014",M=t.density!=null?`${t.density.toFixed(2)} cm\u207B\xB3`:"\u2014",y=e.metrics.solar_wind_kms!=null?`${Math.round(e.metrics.solar_wind_kms)} km/s`:"\u2014",H=n==null?"":n>=4?" \xB7 Magnetosphere compressed":n>=2?" \xB7 Moderate compression":"";return`<div class="hw-impact-tip${o}">
    ${$}
    <div class="hw-swdp-meta"><b style="color:${t.color}">${u(_)}</b>${u(H)}</div>
    <div class="hw-swdp-meta" style="font-size:.72em">Speed ${u(y)} \xB7 Density ${u(M)}</div>
  </div>`}function dt(e){var c,d;let s=(c=e.alerts_all)!=null?c:[],t=s.find(p=>p.kind==="cme_impact"),o=s.find(p=>p.kind==="cme_watch"),n=t!=null?t:o;if(!n)return{status:"quiet",color:"#5cce8c",label:"None",speed_kms:null,issued_utc:null,arrival_utc:null};let i=((d=n.raw_body)!=null?d:"").match(/Estimated Velocity[:\s]+(\d+)\s*km\/s/i),r=i?parseInt(i[1],10):null,l=null;if(r&&n.t_utc){let p=1496e5/r*1e3;l=new Date(new Date(n.t_utc).getTime()+p).toISOString().replace(".000Z","Z")}let a=t?"impact":"watch";return{status:a,color:a==="impact"?"#e05c5c":"#d4cc5c",label:a==="impact"?"Active":"Watch",speed_kms:r,issued_utc:n.t_utc,arrival_utc:l}}function Cs(e,s){let t=dt(e),o=s?" hw-impact-tip-open":"",n="\u2014";if(t.arrival_utc){let a=new Date(t.arrival_utc),c=a.toLocaleString("en-US",{month:"short",timeZone:"UTC"}),d=a.getUTCDate(),p=String(a.getUTCHours()).padStart(2,"0"),m=String(a.getUTCMinutes()).padStart(2,"0");n=`~${c}\xA0${d}\xA0${p}:${m}\u202FUTC`}let i=t.speed_kms?`${t.speed_kms}\u202Fkm/s`:"\u2014",r=t.status!=="quiet"?`Velocity: <b style="color:#b4c6cc">${u(i)}</b>&ensp;Arrival: <b style="color:#b4c6cc">${u(n)}</b>`:"No Earth-directed CME in forecast window",l=ve("cme_cone",{cmeState:t,uid:"cme"});return`<div class="hw-impact-tip${o}">
    ${l}
    <div class="hw-cme-footer">${r}</div>
  </div>`}function Ce(e,s,t,o,n,i,r,l,a){let c=i.has(e),d=c?" hw-impact-open":"",p=c?" hw-impact-tip-open":"";return`<div class="hw-impact-row${d}" id="${e}" data-impact-row="${e}">
      ...
      <div class="hw-impact-tip${p}">${Gt(r,e,l,a)}</div>
    </div>`}function Hs(e,s){let t=e.find(i=>i.kind==="aurora");if(t)return t;let o=s.aurora_hint;return{kind:"aurora",level:o.aurora_label==="good"?"moderate":o.aurora_label==="possible"?"low":"none",label:"Aurora",summary:o.summary}}function Ls(e,s,t,o){var w,f;let n=(w=qe[e.level])!=null?w:"#666",i=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),r=(f=Le[e.kind])!=null?f:tt,l=e.level==="none"?"#606870":n,a=s.has("aurora"),c=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,m=null;t&&o.lat!=null&&o.lon!=null&&(m=Ve(t.entries,o.lat,o.lon));let g=o.lat!=null&&o.lon!=null,h=m!=null?m>=30?"#5cce8c":m>=10?"#d4cc5c":"#9ab4bc":"#607880",x=m!=null?`${m}%`:t?"n/a":"\u2026",v=g?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
    ...
    </div>`:"",b=`<div class="hw-aurora-tip${d}">
      <div class="hw-aurora-map-wrap">
    ...
    ${b}
  </div>`}function Ue(e,s,t,o,n,i){var x,v;let r=(x=qe[e.level])!=null?x:"#666",l=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Le[e.kind])!=null?v:tt,c=e.level==="none"?"#606870":r,d=e.kind==="solar_activity"?t:i,p=d?" hw-impact-open":"",m;if(e.kind==="solar_activity"){let b=t?" hw-solar-open":"",w=et.map(f=>{let $=o.has(f.id),_=$?f.color+"22":"transparent",M=$?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${_};opacity:${M}">${f.label}</button>`}).join("");m=`<div class="hw-solar-tip${b}">
        <div class="hw-solar-disk-wrap" id="solar">
          <img class="hw-solar-disk-img" src="${ps}" alt="Solar disk" loading="lazy" />
          ${s?ns(s,ms,o):""}
        </div>
        <div class="hw-solar-layers">${w}</div>
        <span class="hw-solar-tip-text">${u(e.summary)}</span>
      </div>`}else m=us(n,d);let g=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${A(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${g}>
    <span class="hw-impact-caret">\u25B6</span>
    ...
    ${m}
  </div>`}function Fs(e,s,t,o,n,i,r,l,a){var Ee,Re,Ie,Ae;let c=(Re=(Ee=s==null?void 0:s.impacts)!=null?Ee:e.observer_impacts)!=null?Re:[],d=Hs(c,e),p=Ls(d,r,l,a),m=c.find(_e=>_e.kind==="radio"),g=c.find(_e=>_e.kind==="solar_activity"),h=m?Ue(m,t,n,i,e,r.has("radio")):"",x=g?Ue(g,t,n,i,e,!1):"",w=`
    <div class="hw-section-row" data-impacts-toggle>
      <span class="hw-section-caret">${o?"\u25BC":"\u25B6"}</span>
      <span class="hw-section-label" style="margin-bottom:0">Indicators (${ls})${s?'<span style="font-size:.65em;color:#7a9870;font-weight:normal;text-transform:none;letter-spacing:0"> \xB7 simulated</span>':""}</span>
    </div>`,{metrics:f}=e,$=f.xray_class,_=$?(Ie=$e[$])!=null?Ie:"#a0b4b8":"#607880",M=$?`${$}-class`:"\u2014",y=f.imf_bz_nt,H=y!=null?y<=-10?"#e05c5c":y<=-5?"#e0a84a":y>=5?"#5cce8c":"#a0b4b8":"#607880",S=y!=null?(y>=0?"+":"")+y.toFixed(1)+" nT":"\u2014",k=f.solar_wind_kms,L=k!=null?`${Math.round(k)} km/s`:"\u2014",T=k!=null?k>700?"#e05c5c":k>500?"#e0a84a":k>400?"#d4cc5c":"#5cce8c":"#607880",Y=Ce("xray","X-Ray",rs,M,_,r,e,a,l),W=Ce("imf_bz","IMF Bz",as,S,H,r,e,a,l),X=Ce("solar_wind","Solar Wind",is,L,T,r,e,a,l),N='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',B=r.has("geomag_storm"),j=ot(e),C=nt(j.now.g_level),R=`G${j.now.g_level}`,O=`<div class="hw-impact-row${B?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${vs(e,B)}
    </div>`,E=r.has("solar_cycle"),J=(Ae=rt[we.phase])!=null?Ae:"#96a8b8",z=we.phase.charAt(0).toUpperCase()+we.phase.slice(1),P=`<div class="hw-impact-row${E?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      <span class="hw-impact-badge" style="background:${J}22;color:${J}">${z}</span>
      ${ys(E)}
    </div>`,F=at(e),K=r.has("hss"),ee=`<div class="hw-impact-row${K?" hw-impact-open":""}" data-impact-row="hss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${_s(e,G)}
    </div>`,V=lt(e),ae=r.has("gnss"),ke=`<div class="hw-impact-row${ae?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Ss(e,ae)}
    </div>`,q=ct(e),ce=r.has("sw_pressure"),ne=q.pressure!=null?`${q.pressure.toFixed(2)} nPa`:"\u2014",oe=`<div class="hw-impact-row${ce?" hw-impact-open":""}" data-impact-row="sw_pressure">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Ms(e,ce)}
    </div>`,re=dt(e),pe=r.has("cme_cone"),Z=`<div class="hw-impact-row${pe?" hw-impact-open":""}" data-impact-row="cme_cone">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Cs(e,pe)}
    </div>`,me=be(e),Fe=r.has("magnetosphere"),ht=`<div class="hw-impact-row${Fe?" hw-impact-open":""}" data-impact-row="magnetosphere">
      <span class="hw-impact-caret">\u25B6</span>
    ...
    ${r}
  </div>`}var Rs={info:"#445c64",watch:"#e0a84a",warning:"#e05c5c"},Is="#4ae0a4";function As(e){let s=(t,o="")=>`<svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" ${o}>${t}</svg>`;switch(e){case"solar_flare":return s(`<circle cx="6.5" cy="6.5" r="2.5"/>
        ...
        <circle cx="6.5" cy="3.8" r=".6" fill="currentColor" stroke="none"/>`)}}function Os(e){var o;let s=(o=e.metadata)!=null?o:{},t=[];return s.source_code&&t.push(`Code: ${s.source_code}`),s.model&&t.push(`Model: ${String(s.model).toUpperCase()}`),t.length===0?"":`
${t.join(" \xB7 ")}`}function zs(e,s,t){var a;let o=e.is_active?Is:(a=Rs[e.level])!=null?a:"#445c64",n=e.event_time===t,i=e.event_time.slice(11,16)+" UTC",r=e.source==="NASA_DONKI"?"DONKI":"SWPC",l=n?`<div class="hw-tl-detail">${u(e.description)}${u(Os(e))}</div>`:"";return`
    <div class="hw-tl-item" data-timeline-key="${A(e.event_time)}">
      ...
      <div class="hw-tl-body">
        ...
        <div class="hw-tl-title${e.is_active?" hw-tl-active":""}">
          ${As(e.event_type)} ${u(e.event_title)}
        </div>
        ${l}
      </div>
    </div>`}function Ts(e,s,t,o){var b,w;let n=(b=e.timeline)!=null?b:[],i=Date.now(),r=new Date(i).toISOString().slice(0,10),l=new Date(i-864e5).toISOString().slice(0,10),a=new Date(i-1728e5).toISOString().slice(0,10),c=new Set([r,l,a]),d=n.filter(f=>{var $;return c.has((($=f.event_time)!=null?$:"").slice(0,10))}).slice().reverse(),p=d.length,m=t?"\u25BC":"\u25B6",g=p>0?`Solar Activity Timeline (${p})`:"Solar Activity Timeline",h=`
    ...
    </div>`;if(!t||p===0)return`<div class="hw-timeline">${h}</div>`;let x=new Map;for(let f of d){let $=((w=f.event_time)!=null?w:"").slice(0,10);x.has($)||x.set($,[]),x.get($).push(f)}let v=[...x.entries()].map(([f,$])=>{let M=new Date(f+"T12:00:00Z").toLocaleDateString("en-US",{month:"short",day:"numeric",timeZone:"UTC"}),y=o.has(f),H=y?"\u25B6":"\u25BC",S=y?`<span class="hw-tl-day-count">${$.length} events</span>`:"",k=`
      <div class="hw-tl-day-row" data-tl-day="${A(f)}">
        <span class="hw-section-caret">${H}</span>
        <span class="hw-tl-date">${M}</span>
        ${S}
      </div>`,L=y?"":$.map((T,Y)=>zs(T,Y<$.length-1,s)).join("");return`<div class="hw-tl-group">${k}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Ns(e,s,t){var c;let o=(c=e.alerts_all)!=null?c:[],n=o.length,i=s?"\u25BC":"\u25B6",r=n>0?`SWPC Alerts (${n})`:"SWPC Alerts",l=`
    ...
    </div>`;if(!s||n===0)return`<div class="hw-alerts">${l}${s&&n===0?'<div class="hw-empty-alerts">No significant recent SWPC alerts</div>':""}</div>`;let a=o.map(d=>Es(d,d.dedupe_key===t)).join("");return`
    <div class="hw-alerts">
      ${l}
      ${a}
    </div>`}function Ps(e,s){var W,X,N;let t=e.cme_tracker;if(!t)return"";let o=(W=yt[t.impact_level])!=null?W:"#96a8b8",n=(X=kt[t.status])!=null?X:t.status,i=300,r=44,l=18,a=r/2,c=10,d=i-18,p=7,m=`<line x1="${l+c}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,g=`<circle cx="${l}" cy="${a}" r="${c}" fill="#f0c040" opacity="0.92"/>`,h=`
    <circle cx="${d}" cy="${a}" r="${p}" fill="#4a90c4" opacity="0.88"/>
    <circle cx="${d}" cy="${a}" r="2.5" fill="#fff" opacity="0.7"/>`,x=`<text x="${l}" y="${a+c+9}" text-anchor="middle" font-size="9" fill="#c8aa60">Sun</text>`,v=`<text x="${d}" y="${a+p+9}" text-anchor="middle" font-size="9" fill="#7ab0d4">Earth</text>`,b="";if(t.progress!=null){let B=l+c+4,j=d-p-4,C=B+t.progress*(j-B),R=5;t.status==="arrival_window"?b=`
        ...
        </g>`:b=`<circle cx="${C.toFixed(1)}" cy="${a}" r="${R}" fill="${o}" opacity="0.85"/>`}let w=`<svg class="hw-cme-svg" viewBox="0 0 ${i} ${r}" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
    ${m}
    ${g}${x}
    ${h}${v}
    ${b}
  </svg>`,f=Be(t.arrival_time_utc),$=Be(t.launch_time_utc),_=t.speed_kms!=null?`${Math.round(t.speed_kms)} km/s`:"\u2014",M=t.half_angle_deg!=null?`${t.half_angle_deg}\xB0`:"\u2014",y=(N=t.source_location)!=null?N:"\u2014",H=t.is_earth_direct?"Direct hit":"Glancing blow",S=t.progress!=null?`${Math.round(t.progress*100)}%`:"\u2014",k=`
    <div class="hw-cme-detail">
      ...
      <div class="hw-cme-note">Half-angle: ${u(M)} \xB7 Source: ${u(y)} \xB7 ${u(H)} \xB7 Model: Enlil (NASA DONKI)</div>
    </div>`,L=s?"\u25BC":"\u25B6",T=t.impact_level==="unknown"?"Unrated":t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1),Y=s?`${w}${k}`:"";return`
    <div class="hw-cme">
      ...
      ${Y}
    </div>`}function Bs(e,s,t,o,n,i,r,l,a,c,d,p,m,g,h,x,v,b){var H;let w=es(e,o),f=(H=e.metrics.kp_history_1h)!=null?H:[],$=f.length?ge(f[f.length-1].t_utc):null,_=$?`Recent history \xB7 Last step ${$}`:"Recent history",M=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    <span class="hw-section-caret">${t?"\u25BC":"\u25B6"}</span>
    <span class="hw-section-label" style="margin-bottom:0">${A(_)}</span>
  </div></div>`,y=t?Kt(e):"";return`
    <div class="hw-root">
      ${qt(e)}
      ${Xt(e,t,w,v,b)}
      ${Fs(e,w,m,c,g,h,x,b,v)}
      ${M}
      ${y}
      ${ts(e,o,w,p)}
      ${Ps(e,d)}
