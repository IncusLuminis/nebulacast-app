"use strict";var HelioWidgetModule=(()=>{var de=Object.defineProperty,it=Object.defineProperties,at=Object.getOwnPropertyDescriptor,ct=Object.getOwnPropertyDescriptors,lt=Object.getOwnPropertyNames,He=Object.getOwnPropertySymbols;var Ee=Object.prototype.hasOwnProperty,dt=Object.prototype.propertyIsEnumerable;var Le=(e,o,t)=>o in e?de(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,pe=(e,o)=>{for(var t in o||(o={}))Ee.call(o,t)&&Le(e,t,o[t]);if(He)for(var t of He(o))dt.call(o,t)&&Le(e,t,o[t]);return e},he=(e,o)=>it(e,ct(o));var pt=(e,o)=>{for(var t in o)de(e,t,{get:o[t],enumerable:!0})},ht=(e,o,t,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let r of lt(o))!Ee.call(e,r)&&r!==t&&de(e,r,{get:()=>o[r],enumerable:!(s=at(o,r))||s.enumerable});return e};var mt=e=>ht(de({},"__esModule",{value:!0}),e);var zo={};pt(zo,{HelioWidget:()=>st});var ue={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},Ye={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},gt={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},fe={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},ut={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},wt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function xt(e){if(!e)return"Update time unavailable";try{let o=Math.round((Date.now()-new Date(e).getTime())/6e4);if(o<1)return"Updated just now";if(o<60)return`Updated ${o} min ago`;let t=Math.floor(o/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(o){return"Updated recently"}}function ft(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function me(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e}}function we(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e.slice(11,16)}}function Fe(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function F(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function w(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var Ie={G:["magnetosphere"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},$t=2400;function We(){var e,o;try{let t=(o=(e=globalThis.location)==null?void 0:e.hostname)!=null?o:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function bt(e){let o=[],t=null;for(let s of e){let r=document.getElementById(s);r instanceof HTMLElement?(t||(t=r),o.push(r)):We()&&console.warn(`[Helio] Hero chip nav: missing element #${s}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let s of o)s.classList.add("section-flash"),window.setTimeout(()=>s.classList.remove("section-flash"),$t)}function Ae(e){let o=e.trim();return o.toUpperCase().startsWith("X:")?o.slice(2).trim()||"\u2014":o||"\u2014"}function ye(e,o){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==o)return 0;let s=parseInt(t.slice(1),10);return!isFinite(s)||s<0?0:Math.min(5,s)}function ke(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function vt(e){var c,n,i;let o=e.trim().toUpperCase();if(o==="\u2014"||o===""||o==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=fe[o])!=null?c:"#a0b4b8",s={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},r={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(n=s[o])!=null?n:"#1e2830",borderColor:(i=r[o])!=null?i:"#3a4c52"}}function yt(e,o){var c,n,i,a,l,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",s={g:(c=o==null?void 0:o.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Ae(t)},r=(n=e.hero)==null?void 0:n.scales;return r?{g:(i=r.g)!=null?i:s.g,r:(a=r.r)!=null?a:s.r,s:(l=r.s)!=null?l:s.s,x:Ae((d=r.x)!=null?d:s.x)}:s}var kt=`
...
`,Re=!1;function _t(){if(Re)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=kt,document.head.appendChild(e),Re=!0}function St(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.length,r=o/s,c=e.map((n,i)=>{let a=Math.max(2,Math.min(t,n.kp/9*t)),l=t-a,d=i*r,p=n.kp>=6?"#e05c5c":n.kp>=5?"#e0a84a":n.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${l.toFixed(1)}" width="${(r-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${n.kp.toFixed(1)} \xB7 ${w(we(n.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function Oe(e,o,t,s,r){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,n=Math.min(...e),i=Math.max(...e),a=i-n||1,l=m=>s-2-(m-n)/a*(s-4),d=e.map((m,h)=>`${(h/(e.length-1)*c).toFixed(1)},${l(m).toFixed(1)}`).join(" "),p="";if(r&&n<0&&i>0){let m=l(0);p=`<line x1="0" y1="${m.toFixed(1)}" x2="${c}" y2="${m.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let g=e.map((m,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${s}" fill="transparent"><title>${w(o[h]||"")} \xB7 ${m.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${s}" style="width:100%;height:${s}px;display:block" preserveAspectRatio="none">
    ...
    <line x1="${i}" y1="130" x2="${x}" y2="130"
  ...
  </g>`,A="";if(e==="magnetosphere"){let z=(T=o.windKms)!=null?T:0,j=z>500,D=z<350,E=(j?.5:D?1.4:.9)*1.3,K=z>700?"#e05c5c":z>500?"#e0a84a":z>350?"#d4c840":"#5cce8c",ee=i+8,J=x-14,O=8,Y=6,U=(J-ee)/(O-1),te=260/(Y+1),Q=38,ie=24,$e=2,be=Array.from({length:O},(se,re)=>{let V=ee+re*U,nt=Array.from({length:Y},(rt,ve)=>{let ne=te*(ve+1);return`<path d="M ${V.toFixed(1)},${ne.toFixed(1)} L ${(V+Q).toFixed(1)},${ne.toFixed(1)} M ${(V+ie).toFixed(1)},${(ne-6).toFixed(1)} L ${(V+Q).toFixed(1)},${ne.toFixed(1)} L ${(V+ie).toFixed(1)},${(ne+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:$e},(rt,ve)=>{let ne=-((O-re)/O*E)-ve*E/$e;return`<g style="opacity:.12;animation:hw-arrow-chase ${E}s linear ${ne.toFixed(3)}s infinite">${nt}</g>`}).join("")}).join(""),oe=(I=o.bz)!=null?I:null,le=oe==null?"":(()=>{let se=oe>0?"#5cce8c":"#e05c5c";return`${oe>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
        ...
        fill="${se}" font-family="monospace">Bz${oe>0?"\u2191":"\u2193"}</text>`})();A=`${be}${le}`}let N=`<g id="${c}-overlay-solar-wind">${A}</g>`,P="";if(e==="coronal_hole"&&o.hssState){let z=o.hssState,j=(Z=z.speed)!=null?Z:0,D=j>=420,E=z.color,K=D?"0.85":"0.25",ee=j>=500?"0.18":D?"0.10":"0.04",J=i+8,O=d-16,Y=60,U=`${J},130 ${O},${130-Y} ${O},${130+Y}`,te=O+6,Q=`${te},120 ${te+18},130 ${te},140`;P=`
    ...
    <polygon points="${Q}" fill="${E}" opacity="${D?"0.9":"0.25"}"/>`}let X=`<g id="${c}-overlay-coronal-hole">${P}</g>`,B="";if(e==="cme_cone"&&o.cmeState){let z=o.cmeState,j=i,D=d-10,E=D-j,K=U=>Math.tan(U*Math.PI/180),ee=Math.round(K(9)*E),J=Math.round(K(6)*E),O=Math.round(K(3)*E),Y=U=>`${j},130 ${D},${130-U} ${D},${130+U}`;if(z.status!=="quiet"){let U=z.status==="impact"?"#e05c5c":"#d4cc5c";B=`
    <polygon points="${Y(ee)}" fill="#253238" opacity="0.85"/>
    <polygon points="${Y(J)}"   fill="#d4cc5c" opacity="0.14"/>
    <polygon points="${Y(O)}" fill="#e0a84a" opacity="0.28"/>
    ...
    ${C}
    ${W}
  </svg>`}function It(e){let o=Me(e),t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,r=t!=null&&t<-5?"Southward IMF Bz is strongly coupling energy into the magnetosphere. Geomagnetic storm conditions likely.":t!=null&&t<0?"Southward IMF Bz is partially opening the magnetosphere. Enhanced aurora activity possible.":"Northward IMF Bz keeps the magnetosphere closed. Solar wind energy transfer is minimal.";return`<div class="hw-kpi-popover">
    ${ce("Magnetosphere")}
    <div class="hw-spark-wrap" style="border-radius:3px;overflow:hidden">${Ft(o,t,s,!1)}</div>
    <div class="hw-kpi-hint" style="margin-bottom:0">${w(r)}</div>
  </div>`}function At(e,o){if(!o)return"";let t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,r=t!=null&&t<-5?"Southward IMF Bz is strongly coupling energy into the magnetosphere. Geomagnetic storm conditions likely.":t!=null&&t<0?"Southward IMF Bz is partially opening the magnetosphere. Enhanced aurora activity possible.":"Northward IMF Bz keeps the magnetosphere closed. Solar wind energy transfer is minimal.";return`<div class="hw-impact-tip hw-impact-tip-open">
    <div style="border-radius:3px;overflow:hidden;margin-bottom:2px">${Ue("magnetosphere",{windKms:s!=null?s:void 0,bz:t!=null?t:void 0})}</div>
    ${$o(e)}
    <div class="hw-kpi-hint" style="margin-top:6px;margin-bottom:0">${w(r)}</div>
  </div>`}function Xe(e,o,t){if(!e.length)return null;let s=(t%360+360)%360,r=-1,c=1/0,n=Math.cos(o*Math.PI/180);for(let i of e){let a=i.lat-o,l=(i.lon-s+180+360)%360-180,d=a*a+l*n*(l*n);d<c&&(c=d,r=i.prob)}return r>=0?r:null}function Ke(e){return`<svg viewBox="0 0 100 100" width="100%" height="100%"
    style="position:absolute;top:0;left:0;pointer-events:none">${['<text x="50" y="4"   font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">N</text>','<text x="96"  y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">W</text>','<text x="50" y="97"  font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">S</text>','<text x="4"   y="51" font-size="3.2" fill="#6a8a98" text-anchor="middle" font-family="monospace" opacity=".6">E</text>'].join("")}</svg>`}function Rt(e,o){let t=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,s=null;o&&e.lat!=null&&e.lon!=null&&(s=Xe(o.entries,e.lat,e.lon));let r=e.lat!=null&&e.lon!=null,c=s!=null?s>=30?"#5cce8c":s>=10?"#d4cc5c":"#9ab4bc":"#607880",n=s!=null?`${s}%`:o?"n/a":"\u2026",i=r?`
  ...
  </div>`}function Ot(e,o,t,s){switch(o){case"solar_wind":return Ct(e);case"xray":return Ht(e);case"imf_bz":return Et(e);case"aurora":return Rt(t,s);case"magnetosphere":return It(e);default:return""}}function Tt(e,o){if(e.length<2)return"\u2192";let t=e[e.length-1],s=Math.max(0,e.length-4),r=e[s];if(!isFinite(t)||!isFinite(r))return"\u2192";let c=t-r;return c>o?"\u2191":c<-o?"\u2193":"\u2192"}var zt={quiet:"171",active:"195",elevated:"284",storm:"304"};function Nt(e,o){var s,r,c;if(o==null)return(r=(s=e.summary)==null?void 0:s.status)!=null?r:"quiet";let t=parseInt(((c=o.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":o.kp>=4?"active":"quiet"}function Pt(e,o){var l,d;let t=(l=zt[e])!=null?l:"171",s=`/assets/gifs/current_eit_${t}.gif`,r=so(s,o),c=ro,n=(d=ue[e])!=null?d:ue.quiet,i=`${n.accent}44`,a=`0 0 10px ${n.accent}55,0 0 24px ${n.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
  ...
  </div>`}function Bt(e,o,t,s,r){var f,b,y;let{summary:c,metrics:n}=e,i=(f=ue[c.status])!=null?f:ue.quiet,a=t!=null?t.kp.toFixed(1):n.kp_latest!=null?n.kp_latest.toFixed(1):"\u2014",l=yt(e,t),p=[{key:"G",text:l.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:l.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:l.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${l.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(S=>{let k;return S.key==="G"?k=ke(ye(l.g,"G")):S.key==="R"?k=ke(ye(l.r,"R")):S.key==="S"?k=ke(ye(l.s,"S")):k=vt(l.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${k.color};background:${k.background};border-color:${k.borderColor}`}" data-hero-chip="${S.key}" title="${F(S.title)}" aria-label="${F(S.aria)}">${w(S.text)}</button>`}).join(""),g=Tt(((b=n.kp_history_1h)!=null?b:[]).map(S=>S.kp),.5),m=(y=n.kp_latest)!=null?y:0,h=m>=5,x=h?`linear-gradient(160deg, #0d2a1a 0%, ${i.bg}22 75%)`:`${i.bg}18`,v=Nt(e,t),u=h?`
    ...
    <div class="hw-hero" style="background:${x}">
      ...
      ${u}
    </div>`}function Dt(e){var d,p,g,m;let{metrics:o}=e,t=(d=o.kp_history_1h)!=null?d:[],s=(p=o.wind_history_1h)!=null?p:[],r=(g=o.bz_history_1h)!=null?g:[],c=(m=o.xray_history_1h)!=null?m:[],n=St(t),i=Oe(s.map(h=>{var x;return(x=h.kms)!=null?x:0}).filter(h=>h>0),s.map(h=>we(h.t_utc)),"#5cce8c",28,!1),a=Oe(r.map(h=>h.bz),r.map(h=>we(h.t_utc)),"#d4cc5c",28,!0),l=Mt(c);return`
    ...
    </div>`;let $=320,u=38,f=14,b=u+f,y=$/d,S=H=>u-Math.max(2,Math.min(u-2,H/9*(u-2))),k="",M=l.map(H=>H.kp),C=jt(M);l.forEach((H,R)=>{let q=S(H.kp),T=u-q,I=R*y,Z=I+y/2,z=H.kp>=6?"#e05c5c":H.kp>=5?"#e0a84a":H.kp>=4?"#d4cc5c":"#5cce8c",j=`Kp ${H.kp.toFixed(1)} \xB7 ${me(H.t_utc)}`;if(k+=`<rect x="${I.toFixed(1)}" y="${q.toFixed(1)}" width="${(y-1.5).toFixed(1)}" height="${T.toFixed(1)}" fill="${z}" fill-opacity="0.85" rx="1.5"/>`,k+=`<rect x="${I.toFixed(1)}" y="0" width="${y.toFixed(1)}" height="${u}" fill="transparent"><title>${F(j)}</title></rect>`,d<=8||R%2===0){let E=new Date(H.t_utc).getHours();k+=`<text x="${Z.toFixed(1)}" y="${(b-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${E.toString().padStart(2,"0")}</text>`}});let L=`<polyline points="${l.map((H,R)=>{let q=R*y+y/2,T=S(C[R]);return`${q.toFixed(1)},${T.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,A="";if(o>0&&d>0){let H=Math.min($-1,o/(d*3)*$);A=`
    ...
    <div class="hw-forecast">
      ...
      ${B}`:""}
    </div>`}function qt(e){let o=/([NS])(\d+)([EW])(\d+)/i.exec(e);return o?{lat:(o[1].toUpperCase()==="N"?1:-1)*parseInt(o[2],10),lon:(o[3].toUpperCase()==="E"?1:-1)*parseInt(o[4],10)}:null}var Qe=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function Qt(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function Vt(e,o,t){let s=o/2,r=s*.87,c=o*.03,n=o*.009,i=e.map(a=>{var $,u;let l=qt(a.location);if(!l||Math.abs(l.lon)>88||a.location.includes("*"))return"";let d=Qt(a);if(!t.has(d))return"";let p=Qe.find(f=>f.id===d).color,g=l.lat*Math.PI/180,m=l.lon*Math.PI/180,h=(s+r*Math.cos(g)*Math.sin(m)).toFixed(1),x=(s-r*Math.sin(g)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
  ...
  </div>`}var co={0:"Quiet",1:"Minor Storm",2:"Moderate Storm",3:"Strong Storm",4:"Severe Storm",5:"Extreme Storm"};function lo(e){return e>=9?5:e>=8?4:e>=7?3:e>=6?2:e>=5?1:0}function ae(e,o){if(e<o-.7)return 0;if(e>o+1)return .9;let t=(e-(o-.7))/1.7;return Math.round(Math.pow(Math.max(0,t),.7)*90)/100}function po(e){var l,d,p;let o=parseInt(((l=e.scales.g_scale)!=null?l:"G0").replace(/\D/g,""),10),t=Math.max(0,Math.min(5,Number.isFinite(o)?o:0)),s=(d=e.metrics.kp_forecast_3h)!=null?d:[],r=Date.now(),c=r+24*60*60*1e3,n=s.filter(g=>{let m=new Date(g.t_utc).getTime();return m>=r-3*60*60*1e3&&m<=c}),i=n.length===0?0:Math.max(...n.map(g=>g.kp)),a={G1:ae(i,5),G2:ae(i,6),G3:ae(i,7),G4:ae(i,8),G5:ae(i,9),max_expected:lo(i)};return{now:{g_level:t,label:(p=co[t])!=null?p:"Quiet"},forecast_24h:a}}function ho(e){if(!e||typeof e!="object")return null;let o=e,t=o.now,s=o.forecast_24h;if(!t||!s)return null;let r=typeof t.g_level=="number"?t.g_level:parseInt(String(t.g_level),10),c=typeof t.label=="string"?t.label:"Quiet";if(!Number.isFinite(r))return null;let n=l=>{let d=typeof l=="number"?l:parseFloat(String(l));return Number.isFinite(d)?Math.max(0,Math.min(1,d)):0},i=s.max_expected,a=typeof i=="number"&&Number.isFinite(i)?Math.max(0,Math.min(5,Math.round(i))):0;return{now:{g_level:Math.max(0,Math.min(5,Math.round(r))),label:c},forecast_24h:{G1:n(s.G1),G2:n(s.G2),G3:n(s.G3),G4:n(s.G4),G5:n(s.G5),max_expected:a}}}function Ze(e){let o=po(e),t=ho(e.storm_risk);if(!t)return o;let s=e.storm_risk,r=s&&typeof s.forecast_24h=="object"&&s.forecast_24h!==null?s.forecast_24h:void 0,c=r==null?void 0:r.max_expected;return typeof c=="number"&&Number.isFinite(c)?t:he(pe({},t),{forecast_24h:he(pe({},t.forecast_24h),{max_expected:o.forecast_24h.max_expected})})}function mo(e){return e>=4?"#e05c5c":e>=3?"#e0a84a":e>=1?"#d4cc5c":"#607880"}var Te={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function go(e){var l,d,p;let o=(l=e.metrics.kp_latest)!=null?l:0,t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,r=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,c=o>=5||r>=1,n=(p=e.metrics.kp_history_1h)!=null?p:[],i=0;if(n.length>=2&&(i=n[n.length-1].kp-n[n.length-2].kp),!c)return{active:!1,phase:"quiet",kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s};let a;return i>.3&&(t==null||t<-5)?a="rising":i<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s}}function uo(e){if(!e.active)return"";let o=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=o.findIndex(i=>i.key===e.phase),s=Te[e.phase],r=o[t].label,c=o.map((i,a)=>{let l=a===t,d=a<t,p=Te[i.key],g=l?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",m=l?" hw-spi-dot-active":"",h=l?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",x=a<o.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
  ...
  </div>`}function wo(e,o){let t=Ze(e),s=go(e),r=t.forecast_24h,c=Math.max(0,Math.min(5,Math.round(r.max_expected))),n=`<div class="hw-storm-risk-now-gauge">${ze(t.now.g_level,"Current observed geomagnetic storm level",{showDialCode:!0})}</div>`,i=`<div class="hw-storm-risk-fc-gauge">${ze(c,"Max expected geomagnetic level in next 24 hours",{showDialCode:!1})}</div>`,a=`
  ...
  </div>`}var ge={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},Je={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function xo(e){var C;let o=ge,t=(C=Je[o.phase])!=null?C:"#96a8b8",s=o.phase.charAt(0).toUpperCase()+o.phase.slice(1),r=280,c=52,n=10,i=c-6,a=c-18,l=.5,d=.19,p=_=>Math.exp(-Math.pow((_-l)/d,2)/2),g=_=>n+_*(r-2*n),m=_=>i-p(_)*a,h=80,x=[];for(let _=0;_<=h;_++){let L=_/h;x.push(`${_===0?"M":"L"}${g(L).toFixed(1)},${m(L).toFixed(1)}`)}let v=Math.round(o.progress_0_1*h),$=[];for(let _=0;_<=v;_++){let L=_/h;$.push(`${_===0?"M":"L"}${g(L).toFixed(1)},${m(L).toFixed(1)}`)}let u=g(o.progress_0_1),f=[`M${n},${i}`,...$.slice(1),`L${u.toFixed(1)},${i} Z`],b=m(o.progress_0_1),y=5,S=`M${u.toFixed(1)},${b.toFixed(1)} L${(u-y).toFixed(1)},${(b-y*1.8).toFixed(1)} L${(u+y).toFixed(1)},${(b-y*1.8).toFixed(1)} Z`,k=i+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
    ...
    ${a}
      ...
      <div class="hw-impact-tip${p}">${Ot(n,e,i,a)}</div>
    </div>`}function yo(e,o){let t=e.find(c=>c.kind==="aurora");if(t)return t;let s=o.aurora_hint;return{kind:"aurora",level:s.aurora_label==="good"?"moderate":s.aurora_label==="possible"?"low":"none",label:"Aurora",summary:s.summary}}function ko(e,o,t,s){var u,f;let r=(u=Ye[e.level])!=null?u:"#666",c=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),n=(f=Ce[e.kind])!=null?f:Ve,i=e.level==="none"?"#606870":r,a=o.has("aurora"),l=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,g=null;t&&s.lat!=null&&s.lon!=null&&(g=Xe(t.entries,s.lat,s.lon));let m=s.lat!=null&&s.lon!=null,h=g!=null?g>=30?"#5cce8c":g>=10?"#d4cc5c":"#9ab4bc":"#607880",x=g!=null?`${g}%`:t?"n/a":"\u2026",v=m?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
    ...
    ${$}
  </div>`}function De(e,o,t,s,r,c){var x,v;let n=(x=Ye[e.level])!=null?x:"#666",i=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Ce[e.kind])!=null?v:Ve,l=e.level==="none"?"#606870":n,d=e.kind==="solar_activity"?t:c,p=d?" hw-impact-open":"",g;if(e.kind==="solar_activity"){let $=t?" hw-solar-open":"",u=Qe.map(f=>{let b=s.has(f.id),y=b?f.color+"22":"transparent",S=b?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${y};opacity:${S}">${f.label}</button>`}).join("");g=`<div class="hw-solar-tip${$}">
        <div class="hw-solar-disk-wrap" id="solar">
          <img class="hw-solar-disk-img" src="${no}" alt="Solar disk" loading="lazy" />
          ${o?Vt(o,io,s):""}
        </div>
        <div class="hw-solar-layers">${u}</div>
        <span class="hw-solar-tip-text">${w(e.summary)}</span>
      </div>`}else g=ao(r,d);let m=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${F(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${m}>
    <span class="hw-impact-caret">\u25B6</span>
    ...
    ${g}
  </div>`}function _o(e,o,t,s,r,c,n,i,a){var oe,le,se,re;let l=(le=(oe=o==null?void 0:o.impacts)!=null?oe:e.observer_impacts)!=null?le:[],d=yo(l,e),p=ko(d,n,i,a),g=l.find(V=>V.kind==="radio"),m=l.find(V=>V.kind==="solar_activity"),h=g?De(g,t,r,c,e,n.has("radio")):"",x=m?De(m,t,r,c,e,!1):"",u=`
    <div class="hw-section-row" data-impacts-toggle>
      <span class="hw-section-caret">${s?"\u25BC":"\u25B6"}</span>
      <span class="hw-section-label" style="margin-bottom:0">Indicators (${to})${o?'<span style="font-size:.65em;color:#7a9870;font-weight:normal;text-transform:none;letter-spacing:0"> \xB7 simulated</span>':""}</span>
    </div>`,{metrics:f}=e,b=f.xray_class,y=b?(se=fe[b])!=null?se:"#a0b4b8":"#607880",S=b?`${b}-class`:"\u2014",k=f.imf_bz_nt,M=k!=null?k<=-10?"#e05c5c":k<=-5?"#e0a84a":k>=5?"#5cce8c":"#a0b4b8":"#607880",C=k!=null?(k>=0?"+":"")+k.toFixed(1)+" nT":"\u2014",_=f.solar_wind_kms,L=_!=null?`${Math.round(_)} km/s`:"\u2014",A=_!=null?_>700?"#e05c5c":_>500?"#e0a84a":_>400?"#d4cc5c":"#5cce8c":"#607880",N=_e("xray","X-Ray",Zt,S,y,n,e,a,i),P=_e("imf_bz","IMF Bz",Jt,C,M,n,e,a,i),X=_e("solar_wind","Solar Wind",eo,L,A,n,e,a,i),B='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',G=n.has("geomag_storm"),W=Ze(e),H=mo(W.now.g_level),R=`G${W.now.g_level}`,T=`<div class="hw-impact-row${G?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${wo(e,G)}
    </div>`,I=n.has("solar_cycle"),Z=(re=Je[ge.phase])!=null?re:"#96a8b8",z=ge.phase.charAt(0).toUpperCase()+ge.phase.slice(1),D=`<div class="hw-impact-row${I?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${xo(I)}
    </div>`,E=tt(e),K=n.has("sat_drag"),J=`<div class="hw-impact-row${K?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${bo(e,K)}
    </div>`,O=ot(e),Y=n.has("gnss"),te=`<div class="hw-impact-row${Y?" hw-impact-open":""}" id="gnss" data-impact-row="gnss">
      <span class="hw-impact-caret">\u25B6</span>
    ...
    ${n}
  </div>`}var Mo={info:"#445c64",watch:"#e0a84a",warning:"#e05c5c"},Co="#4ae0a4";function Ho(e){let o=(t,s="")=>`<svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" ${s}>${t}</svg>`;switch(e){case"solar_flare":return o(`<circle cx="6.5" cy="6.5" r="2.5"/>
        ...
        <circle cx="6.5" cy="3.8" r=".6" fill="currentColor" stroke="none"/>`)}}function Lo(e){var s;let o=(s=e.metadata)!=null?s:{},t=[];return o.source_code&&t.push(`Code: ${o.source_code}`),o.model&&t.push(`Model: ${String(o.model).toUpperCase()}`),t.length===0?"":`
${t.join(" \xB7 ")}`}function Eo(e,o,t){var a;let s=e.is_active?Co:(a=Mo[e.level])!=null?a:"#445c64",r=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",n=e.source==="NASA_DONKI"?"DONKI":"SWPC",i=r?`<div class="hw-tl-detail">${w(e.description)}${w(Lo(e))}</div>`:"";return`
    ...
    <div class="hw-section-row" data-tl-section>
      ...
      <div class="hw-tl-day-row" data-tl-day="${F(f)}">
        ...
        ${C}
      </div>`,L=k?"":b.map((A,N)=>Eo(A,N<b.length-1,o)).join("");return`<div class="hw-tl-group">${_}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Io(e,o,t){var l;let s=(l=e.alerts_all)!=null?l:[],r=s.length,c=o?"\u25BC":"\u25B6",n=r>0?`SWPC Alerts (${r})`:"SWPC Alerts",i=`
    ...
    </div>`;if(!o||r===0)return`<div class="hw-alerts">${i}${o&&r===0?'<div class="hw-empty-alerts">No significant recent SWPC alerts</div>':""}</div>`;let a=s.map(d=>So(d,d.dedupe_key===t)).join("");return`
    <div class="hw-alerts">
      ${i}
      ${a}
    </div>`}function Ao(e,o){var P,X,B;let t=e.cme_tracker;if(!t)return"";let s=(P=ut[t.impact_level])!=null?P:"#96a8b8",r=(X=wt[t.status])!=null?X:t.status,c=300,n=44,i=18,a=n/2,l=10,d=c-18,p=7,g=`<line x1="${i+l}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,m=`<circle cx="${i}" cy="${a}" r="${l}" fill="#f0c040" opacity="0.92"/>`,h=`
    ...
    <div class="hw-cme">
      ...
      ${N}
    </div>`}function Ro(e,o,t,s,r,c,n,i,a,l,d,p,g,m,h,x,v,$){var M;let u=Xt(e,s),f=(M=e.metrics.kp_history_1h)!=null?M:[],b=f.length?me(f[f.length-1].t_utc):null,y=b?`Recent history \xB7 Last step ${b}`:"Recent history",S=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    <span class="hw-section-caret">${t?"\u25BC":"\u25B6"}</span>
    <span class="hw-section-label" style="margin-bottom:0">${F(y)}</span>
  </div></div>`,k=t?Dt(e):"";return`
    <div class="hw-root">
      ${Gt(e)}
      ${Bt(e,t,u,v,$)}
      ${_o(e,u,g,l,m,h,x,$,v)}
      ...
      ${Fo(e,n,i,a)}
      ${Io(e,r,c)}
    </div>`}function Oo(e){return`<div class="hw-root">
