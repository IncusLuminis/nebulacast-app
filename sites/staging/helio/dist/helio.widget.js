"use strict";var HelioWidgetModule=(()=>{var ue=Object.defineProperty,ht=Object.defineProperties,mt=Object.getOwnPropertyDescriptor,ut=Object.getOwnPropertyDescriptors,gt=Object.getOwnPropertyNames,ze=Object.getOwnPropertySymbols;var Be=Object.prototype.hasOwnProperty,wt=Object.prototype.propertyIsEnumerable;var Ne=(e,o,t)=>o in e?ue(e,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[o]=t,ge=(e,o)=>{for(var t in o||(o={}))Be.call(o,t)&&Ne(e,t,o[t]);if(ze)for(var t of ze(o))wt.call(o,t)&&Ne(e,t,o[t]);return e},we=(e,o)=>ht(e,ut(o));var xt=(e,o)=>{for(var t in o)ue(e,t,{get:o[t],enumerable:!0})},ft=(e,o,t,s)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of gt(o))!Be.call(e,n)&&n!==t&&ue(e,n,{get:()=>o[n],enumerable:!(s=mt(o,n))||s.enumerable});return e};var $t=e=>ft(ue({},"__esModule",{value:!0}),e);var jo={};xt(jo,{HelioWidget:()=>dt});var $e={quiet:{bg:"#1a2e22",accent:"#5cce8c"},active:{bg:"#2e2a1a",accent:"#d4cc5c"},elevated:{bg:"#2e1f10",accent:"#e0a84a"},storm:{bg:"#2e1212",accent:"#e05c5c"}},Qe={none:"#666",low:"#5cce8c",moderate:"#e0a84a",high:"#e05c5c"},bt={info:"#666",watch:"#d4cc5c",warning:"#e05c5c"},ve={A:"#888",B:"#5cce8c",C:"#aad47a",M:"#e0a84a",X:"#e05c5c"},vt={low:"#5cce8c",moderate:"#d4cc5c",high:"#e05c5c",unknown:"#96a8b8"},yt={detected:"Detected",inbound:"Inbound",arrival_window:"Arriving",arrived:"Arrived"};function kt(e){if(!e)return"Update time unavailable";try{let o=Math.round((Date.now()-new Date(e).getTime())/6e4);if(o<1)return"Updated just now";if(o<60)return`Updated ${o} min ago`;let t=Math.floor(o/60);return t<24?`Updated ${t}h ago`:`Updated ${Math.floor(t/24)}d ago`}catch(o){return"Updated recently"}}function _t(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function xe(e){if(!e)return"";try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e}}function be(e){try{return new Date(e).toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(o){return e.slice(11,16)}}function Pe(e){if(!e)return"\u2014";try{return new Date(e).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",hour12:!1})+" UTC"}catch(o){return e}}function O(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function g(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var De={G:["aurora","storm_risk"],R:["radio"],S:["satellite_drag","gnss"],X:["xray","solar"]},St=2400;function Ve(){var e,o;try{let t=(o=(e=globalThis.location)==null?void 0:e.hostname)!=null?o:"";return t==="localhost"||t==="127.0.0.1"||t.endsWith(".local")}catch(t){return!1}}function Mt(e){let o=[],t=null;for(let s of e){let n=document.getElementById(s);n instanceof HTMLElement?(t||(t=n),o.push(n)):Ve()&&console.warn(`[Helio] Hero chip nav: missing element #${s}`)}t&&t.scrollIntoView({behavior:"smooth",block:"start"});for(let s of o)s.classList.add("section-flash"),window.setTimeout(()=>s.classList.remove("section-flash"),St)}function Ge(e){let o=e.trim();return o.toUpperCase().startsWith("X:")?o.slice(2).trim()||"\u2014":o||"\u2014"}function Ce(e,o){let t=e.trim().toUpperCase();if(t.length<2||t[0]!==o)return 0;let s=parseInt(t.slice(1),10);return!isFinite(s)||s<0?0:Math.min(5,s)}function He(e){return e<=0?{color:"#96a8b8",background:"#1e2830",borderColor:"#2a3c42"}:e===1?{color:"#d4cc5c",background:"#2a2616",borderColor:"#5a5028"}:e===2?{color:"#e0a84a",background:"#2c2214",borderColor:"#6a5018"}:e===3?{color:"#e8a060",background:"#301810",borderColor:"#744018"}:e===4?{color:"#e07058",background:"#2c1412",borderColor:"#762820"}:{color:"#e05c5c",background:"#2e1214",borderColor:"#7a2828"}}function Ct(e){var c,r,i;let o=e.trim().toUpperCase();if(o==="\u2014"||o===""||o==="-")return{color:"#607880",background:"#1e2830",borderColor:"#2a3c42"};let t=(c=ve[o])!=null?c:"#a0b4b8",s={A:"#242628",B:"#15221c",C:"#1a2215",M:"#221a10",X:"#281416"},n={A:"#404448",B:"#2a5a40",C:"#3e6a30",M:"#6a5018",X:"#7a2828"};return{color:t,background:(r=s[o])!=null?r:"#1e2830",borderColor:(i=n[o])!=null?i:"#3a4c52"}}function Ht(e,o){var c,r,i,a,l,d;let t=e.metrics.xray_class!=null?String(e.metrics.xray_class):"\u2014",s={g:(c=o==null?void 0:o.gScale)!=null?c:e.scales.g_scale,r:e.scales.r_scale,s:e.scales.s_scale,x:Ge(t)},n=(r=e.hero)==null?void 0:r.scales;return n?{g:(i=n.g)!=null?i:s.g,r:(a=n.r)!=null?a:s.r,s:(l=n.s)!=null?l:s.s,x:Ge((d=n.x)!=null?d:s.x)}:s}var Lt=`
...
`,Ye=!1;function Ft(){if(Ye)return;let e=document.createElement("style");e.id="helio-widget-css",e.textContent=Lt,document.head.appendChild(e),Ye=!0}function Et(e){if(!e.length)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.length,n=o/s,c=e.map((r,i)=>{let a=Math.max(2,Math.min(t,r.kp/9*t)),l=t-a,d=i*n,p=r.kp>=6?"#e05c5c":r.kp>=5?"#e0a84a":r.kp>=4?"#d4cc5c":"#5cce8c";return`<rect x="${d.toFixed(1)}" y="${l.toFixed(1)}" width="${(n-1).toFixed(1)}" height="${a.toFixed(1)}" fill="${p}" rx="1"><title>Kp ${r.kp.toFixed(1)} \xB7 ${g(be(r.t_utc))} UTC</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">${c}</svg>`}function je(e,o,t,s,n){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let c=200,r=Math.min(...e),i=Math.max(...e),a=i-r||1,l=u=>s-2-(u-r)/a*(s-4),d=e.map((u,h)=>`${(h/(e.length-1)*c).toFixed(1)},${l(u).toFixed(1)}`).join(" "),p="";if(n&&r<0&&i>0){let u=l(0);p=`<line x1="0" y1="${u.toFixed(1)}" x2="${c}" y2="${u.toFixed(1)}" stroke="#2a3438" stroke-width="0.8" stroke-dasharray="3,2"/>`}let m=e.map((u,h)=>`<rect x="${(h/(e.length-1)*c-4).toFixed(1)}" y="0" width="8" height="${s}" fill="transparent"><title>${g(o[h]||"")} \xB7 ${u.toFixed(1)}</title></rect>`).join("");return`<svg viewBox="0 0 ${c} ${s}" style="width:100%;height:${s}px;display:block" preserveAspectRatio="none">
    ${p}
    <polyline points="${d}" fill="none" stroke="${t}" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/>
    ${m}
  </svg>`}function Rt(e){if(e.length<2)return'<div style="color:#405058;font-size:.72em;padding:4px">No data</div>';let o=200,t=32,s=e.map(d=>Math.max(-9,Math.min(-3,Math.log10(d.flux)))),n=Math.min(...s),r=Math.max(...s)-n||1,i=d=>t-2-(d-n)/r*(t-4),a=s.map((d,p)=>`${(p/(s.length-1)*o).toFixed(1)},${i(d).toFixed(1)}`).join(" "),l=e.map((d,p)=>{let m=p/(s.length-1)*o,u=d.flux>=1e-4?"X":d.flux>=1e-5?"M":d.flux>=1e-6?"C":d.flux>=1e-7?"B":"A";return`<rect x="${(m-4).toFixed(1)}" y="0" width="8" height="${t}" fill="transparent"><title>${g(be(d.t_utc))} \xB7 ${u}-class (${d.flux.toExponential(2)})</title></rect>`}).join("");return`<svg viewBox="0 0 ${o} ${t}" style="width:100%;height:${t}px;display:block" preserveAspectRatio="none">
  ...
  </div>`}function Ot(e){var i,a;let o=(i=e.metrics.xray_class)!=null?i:"A",t=e.metrics.xray_flux_wm2,s=t!=null?t.toExponential(2)+" W/m\xB2":"\u2014",n=[{label:"A",color:"#888"},{label:"B",color:"#5cce8c"},{label:"C",color:"#aad47a"},{label:"M",color:"#e0a84a"},{label:"X",color:"#e05c5c"}],c=n.map(l=>{let d=l.label===o,p=d?'<div class="hw-xray-scale-marker"></div>':"";return`<div class="hw-xray-scale-band" style="background:${l.color}${d?"cc":"44"}">${p}</div>`}).join(""),r=n.map(l=>`<div class="hw-xray-scale-label" style="color:${l.label===o?"#c8d8dc":"#607880"}">${l.label}</div>`).join("");return`<div class="hw-kpi-popover">
    ${ce("X-Ray \xB7 Current")}
    <div style="margin-bottom:8px">
      <div class="hw-xray-scale">${c}</div>
      <div class="hw-xray-scale-labels">${r}</div>
    </div>
    <div class="hw-kpi-hint">Class: <b style="color:${(a=ve[o])!=null?a:"#a0b4b8"}">${g(o)}-class</b> \xB7 ${g(s)}</div>
    <div class="hw-kpi-hint" style="margin-top:4px">Trend history: \u25B6 HISTORY</div>
  </div>`}function At(e){let a='<rect x="0" y="16" width="200" height="6" rx="3" fill="#1e2c30"/>',l=[-10,-5,5,10].map(M=>{let y=100+M/20*100;return`<line x1="${y.toFixed(1)}" y1="16" x2="${y.toFixed(1)}" y2="22" stroke="#2a3c42" stroke-width="1"/>`}).join(""),d='<line x1="100" y1="14" x2="100" y2="24" stroke="#3a4c52" stroke-width="1.5"/>';if(e==null)return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">${a}${l}${d}</svg>`;let p=e<=-10?"#e05c5c":e<=-5?"#e0a84a":e<0?"#d4b84a":e>=5?"#5cce8c":"#7acca8",m=Math.max(-20,Math.min(20,e)),u=100+m/20*100,h=3,w=m<0?u-h:100-h,v=Math.max(2*h,Math.abs(u-100)+2*h),$=`<rect x="${w.toFixed(1)}" y="16" width="${v.toFixed(1)}" height="6" rx="${h}" fill="${p}" opacity="0.82"/>`,x=5,f=15,b=f-x*1.1,k=`<polygon points="${u.toFixed(1)},${f.toFixed(1)} ${(u-x).toFixed(1)},${b.toFixed(1)} ${(u+x).toFixed(1)},${b.toFixed(1)}" fill="${p}"/>`,S=`<line x1="${u.toFixed(1)}" y1="${f.toFixed(1)}" x2="${u.toFixed(1)}" y2="${19 .toFixed(1)}" stroke="${p}" stroke-width="1" opacity="0.6"/>`,H=`<text x="${u.toFixed(1)}" y="31" text-anchor="middle" font-size="8" fill="${p}" font-weight="600">${e>=0?"+":""}${e.toFixed(1)}</text>`;return`<svg viewBox="0 0 200 36" style="width:100%;height:36px;display:block">
    ${a}${l}${d}${$}${k}${S}${H}
  </svg>`}function Tt(e){let o=e.metrics.imf_bz_nt,t=e.metrics.imf_bt_nt,s=o!=null?o<=-10?"#e05c5c":o<=-5?"#e0a84a":o>=5?"#5cce8c":"#a0b4b8":"#607880",n=o!=null?(o>=0?"+":"")+o.toFixed(1)+" nT":"\u2014",c=t!=null?t.toFixed(1)+" nT":"\u2014",r=ye(e),i=o!=null&&o<-5?{msg:"Southward IMF \xB7 Aurora favorable",color:"#5cce8c"}:o!=null&&o<0?{msg:"Weakly southward \xB7 Conditions may improve",color:"#d4cc5c"}:{msg:"Northward IMF \xB7 Stable magnetosphere",color:"#96a8b8"};return`<div class="hw-kpi-popover">
    ...
    <div class="hw-kpi-hint" style="color:${i.color};font-weight:600;margin-bottom:0">${g(i.msg)}</div>
  </div>`}function ye(e){var a,l;let o=e.metrics.imf_bz_nt,t=(a=e.metrics.kp_latest)!=null?a:0,s=(l=e.metrics.solar_wind_kms)!=null?l:0,n,c,r;if(o!=null&&o<-5||t>=6)n="storm",c="#e05c5c",r="Storm conditions";else if(o!=null&&o<0||t>=4||s>=400){let d=o!=null&&o<0;n="active",c="#e0a84a",r=d?"Active coupling":"Elevated"}else n="stable",c="#5cce8c",r="Stable";let i;return o==null?i="Unknown":o>2?i="Closed":o>0?i="Minimal":o>-5?i="Moderate":o>-10?i="Strong":i="Very strong",{state:n,color:c,label:r,coupling:i}}function zt(e,o,t,s){let n=s?"mc":"mf",c=e.color,r=t!=null?t:0,i=r>500,a=r<350,l=i?.9:a?1.8:1.3;if(s){let h=45-(e.state==="storm"?11:e.state==="active"?16:21),w=e.state==="storm"?12:e.state==="active"?10:8,v=50-w,$=76,x=[`M ${h},25`,`C ${h-2},15 41,${w} 45,${w}`,`C 53,${w} ${$-8},${w+4} ${$},20`,`C ${$+1},23 ${$+1},27 ${$},30`,`C ${$-8},${v-4} 53,${v} 45,${v}`,`C 41,${v} ${h-2},35 ${h},25`,"Z"].join(" "),f=i?3:2,b=[14,25,36],k=M=>`<path d="M 0,${M} L ${i?8:6},${M} M ${i?6:4},${M-2} L ${i?8:6},${M} L ${i?6:4},${M+2}" stroke="${c}bb" stroke-width="${i?1.4:1}" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`,S=b.map(M=>k(M)).join(""),_=Array.from({length:f},(M,y)=>`<g class="hw-wg" style="animation-duration:${l}s;animation-delay:${(l/f*y).toFixed(2)}s">${S}</g>`).join(""),H=o==null?"":o>0?`<path d="M 45,27 L 45,23 M ${45-1.5},${25-.5} L 45,23 L ${45+1.5},${25-.5}" stroke="#5cce8c" stroke-width="1" fill="none" stroke-linecap="round"/>`:`<path d="M 45,23 L 45,27 M ${45-1.5},${25+.5} L 45,27 L ${45+1.5},${25+.5}" stroke="#e05c5c" stroke-width="1" fill="none" stroke-linecap="round"/>`;return`<svg viewBox="0 0 80 50" style="width:78px;height:49px;display:block" xmlns="http://www.w3.org/2000/svg">
      ...
      ${H}
    </svg>`}else{let $=e.state==="storm"?16:e.state==="active"?26:38,x=155-$,f=e.state==="storm"?22:e.state==="active"?30:40,b=120-f,k=240,S=[`M ${x},60`,`C ${x-4},42 150,${f} 155,${f}`,`C 173,${f} ${k-5},${f+18} ${k},60`,`C ${k-5},${b-18} 173,${b} 155,${b}`,`C 150,${b} ${x-4},78 ${x},60`,"Z"].join(" "),_=`M ${x+2},60 C ${x+2},${60-$*.4} 152,54 150,60 C 152,66 ${x+2},${60+$*.4} ${x+2},60 Z`,H=r>700?"#e05c5c":r>500?"#e0a84a":r>350?"#d4c840":"#5cce8c",M=r>700?.4:r>500?.65:r>350?1.1:1.8,y=r>500?[10,24,40,57,74,90,106]:r>350?[14,34,57,82,104]:[20,50,82,108],L=16,z=22,Y=x-6,j=Math.ceil((Y-z)/L)+2,X=Array.from({length:j},(A,E)=>z-L+E*L),N=12,P=8,W=X.flatMap(A=>y.map(E=>`<path d="M ${A},${E} L ${A+N},${E} M ${A+P},${E-3} L ${A+N},${E} L ${A+P},${E+3}" stroke="${H}cc" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`)).join(""),C=`<g class="hw-wg-full" style="animation-duration:${M}s">${W}</g>`,R=o==null?"":o>0?'<path d="M 155,64 L 155,56 M 153,58 L 155,56 L 157,58" stroke="#5cce8c" stroke-width="1.3" fill="none" stroke-linecap="round"/>':'<path d="M 155,56 L 155,64 M 153,62 L 155,64 L 157,62" stroke="#e05c5c" stroke-width="1.3" fill="none" stroke-linecap="round"/>',Q=o==null?"":`<text x="163" y="62" font-size="6" fill="${o>0?"#5cce8c":"#e05c5c"}" font-family="monospace">Bz${o>0?"\u2191":"\u2193"}</text>`;return ke("magnetosphere",{magnetInfo:e,bz:o,windKms:t,uid:n})}}function ke(e,o={}){var C,R,Q,A,E,J;let c=(C=o.uid)!=null?C:"hse",r=0,i=160,a=800,l=17,d=a-l,p=o.magnetInfo,m=(R=p==null?void 0:p.state)!=null?R:"stable",u=(Q=p==null?void 0:p.color)!=null?Q:"#e0a84a",w=a-(m==="storm"?55:m==="active"?80:110),v=m==="storm"?58:m==="active"?76:95,$=1120,x=20,f=[`M ${w},130`,`C ${w-8},${130-v*.55} ${a-18},${130-v} ${a},${130-v}`,`C ${a+120},${130-v} ${$-180},${130-x} ${$},${130-x}`,`L ${$},${130+x}`,`C ${$-180},${130+x} ${a+120},${130+v} ${a},${130+v}`,`C ${a-18},${130+v} ${w-8},${130+v*.55} ${w},130`,"Z"].join(" "),b=e==="magnetosphere",k=b?m==="storm"?"0.12":"0.08":"0.04",S=b?"0.75":"0.28",_=`<g id="${c}-base-sun">
    ...
    <line x1="${i}" y1="130" x2="${w}" y2="130"
  ...
  </g>`,z="";if(e==="magnetosphere"){let T=(A=o.windKms)!=null?A:0,D=T>500,B=T<350,F=(D?.5:B?1.4:.9)*1.3,K=T>700?"#e05c5c":T>500?"#e0a84a":T>350?"#d4c840":"#5cce8c",te=i+8,ee=w-14,I=8,G=6,U=(ee-te)/(I-1),oe=260/(G+1),V=38,ie=24,_e=2,Se=Array.from({length:I},(ne,de)=>{let se=te+de*U,re=Array.from({length:G},(pe,he)=>{let Z=oe*(he+1);return`<path d="M ${se.toFixed(1)},${Z.toFixed(1)} L ${(se+V).toFixed(1)},${Z.toFixed(1)} M ${(se+ie).toFixed(1)},${(Z-6).toFixed(1)} L ${(se+V).toFixed(1)},${Z.toFixed(1)} L ${(se+ie).toFixed(1)},${(Z+6).toFixed(1)}"
          stroke="${K}" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`}).join("");return Array.from({length:_e},(pe,he)=>{let Z=-((I-de)/I*F)-he*F/_e;return`<g style="opacity:.12;animation:hw-arrow-chase ${F}s linear ${Z.toFixed(3)}s infinite">${re}</g>`}).join("")}).join(""),q=(E=o.bz)!=null?E:null,le=q==null?"":(()=>{let ne=q>0?"#5cce8c":"#e05c5c";return`${q>0?`<path d="M ${a},137 L ${a},123 M ${a-3},126 L ${a},123 L ${a+3},126"
        ...
        fill="${ne}" font-family="monospace">Bz${q>0?"\u2191":"\u2193"}</text>`})();z=`${Se}${le}`}let Y=`<g id="${c}-overlay-solar-wind">${z}</g>`,j="";if(e==="coronal_hole"&&o.hssState){let T=o.hssState,D=(J=T.speed)!=null?J:0,B=D>=420,F=T.color,K=B?"0.85":"0.25",te=D>=500?"0.18":B?"0.10":"0.04",ee=i+8,I=d-16,G=60,U=`${ee},130 ${I},${130-G} ${I},${130+G}`,oe=I+6,V=`${oe},120 ${oe+18},130 ${oe},140`;j=`
    ...
    <polygon points="${V}" fill="${F}" opacity="${B?"0.9":"0.25"}"/>`}let X=`<g id="${c}-overlay-coronal-hole">${j}</g>`,N="";if(e==="cme_cone"&&o.cmeState){let T=o.cmeState,D=i,B=d-10,F=B-D,K=U=>Math.tan(U*Math.PI/180),te=Math.round(K(9)*F),ee=Math.round(K(6)*F),I=Math.round(K(3)*F),G=U=>`${D},130 ${B},${130-U} ${B},${130+U}`;if(T.status!=="quiet"){let U=T.status==="impact"?"#e05c5c":"#d4cc5c";N=`
  ...
  </div>`}function Dt(e,o,t,s){switch(o){case"solar_wind":return It(e);case"xray":return Ot(e);case"imf_bz":return Tt(e);case"aurora":return Pt(t,s);case"magnetosphere":return Nt(e);default:return""}}function Gt(e,o){if(e.length<2)return"\u2192";let t=e[e.length-1],s=Math.max(0,e.length-4),n=e[s];if(!isFinite(t)||!isFinite(n))return"\u2192";let c=t-n;return c>o?"\u2191":c<-o?"\u2193":"\u2192"}var Yt={quiet:"171",active:"195",elevated:"284",storm:"304"};function jt(e,o){var s,n,c;if(o==null)return(n=(s=e.summary)==null?void 0:s.status)!=null?n:"quiet";let t=parseInt(((c=o.gScale)!=null?c:"G0").replace(/\D/g,""),10)||0;return t>=3?"storm":t>=1?"elevated":o.kp>=4?"active":"quiet"}function Wt(e,o){var l,d;let t=(l=Yt[e])!=null?l:"171",s=`/assets/gifs/current_eit_${t}.gif`,n=lo(s,o),c=ho,r=(d=$e[e])!=null?d:$e.quiet,i=`${r.accent}44`,a=`0 0 10px ${r.accent}55,0 0 24px ${r.accent}22`;return`<div class="hw-solar-mini-wrap" style="cursor:default">
  ...
  </div>`}function Ut(e,o,t,s,n){var f,b,k;let{summary:c,metrics:r}=e,i=(f=$e[c.status])!=null?f:$e.quiet,a=t!=null?t.kp.toFixed(1):r.kp_latest!=null?r.kp_latest.toFixed(1):"\u2014",l=Ht(e,t),p=[{key:"G",text:l.g,title:"Geomagnetic storm level. Based on Kp index.",aria:"Geomagnetic storm level"},{key:"R",text:l.r,title:"Radio blackout level. Based on solar X-ray flux.",aria:"Radio blackout level"},{key:"S",text:l.s,title:"Solar radiation storm level. Based on energetic proton flux.",aria:"Solar radiation storm level"},{key:"X",text:`X:${l.x}`,title:"Current solar X-ray activity class.",aria:"Solar X-ray activity"}].map(S=>{let _;return S.key==="G"?_=He(Ce(l.g,"G")):S.key==="R"?_=He(Ce(l.r,"R")):S.key==="S"?_=He(Ce(l.s,"S")):_=Ct(l.x),`<button type="button" class="hw-scale-chip hw-hero-scale-chip"
      style="${`color:${_.color};background:${_.background};border-color:${_.borderColor}`}" data-hero-chip="${S.key}" title="${O(S.title)}" aria-label="${O(S.aria)}">${g(S.text)}</button>`}).join(""),m=Gt(((b=r.kp_history_1h)!=null?b:[]).map(S=>S.kp),.5),u=(k=r.kp_latest)!=null?k:0,h=u>=5,w=h?`linear-gradient(160deg, #0d2a1a 0%, ${i.bg}22 75%)`:`${i.bg}18`,v=jt(e,t),x=h?`
    ...
    <div class="hw-hero" style="background:${w}">
      ...
      ${x}
    </div>`}function Xt(e){var d,p,m,u;let{metrics:o}=e,t=(d=o.kp_history_1h)!=null?d:[],s=(p=o.wind_history_1h)!=null?p:[],n=(m=o.bz_history_1h)!=null?m:[],c=(u=o.xray_history_1h)!=null?u:[],r=Et(t),i=je(s.map(h=>{var w;return(w=h.kms)!=null?w:0}).filter(h=>h>0),s.map(h=>be(h.t_utc)),"#5cce8c",28,!1),a=je(n.map(h=>h.bz),n.map(h=>be(h.t_utc)),"#d4cc5c",28,!0),l=Rt(c);return`
    ...
    </div>`;let $=320,x=38,f=14,b=x+f,k=$/d,S=C=>x-Math.max(2,Math.min(x-2,C/9*(x-2))),_="",H=l.map(C=>C.kp),M=qt(H);l.forEach((C,R)=>{let Q=S(C.kp),A=x-Q,E=R*k,J=E+k/2,T=C.kp>=6?"#e05c5c":C.kp>=5?"#e0a84a":C.kp>=4?"#d4cc5c":"#5cce8c",D=`Kp ${C.kp.toFixed(1)} \xB7 ${xe(C.t_utc)}`;if(_+=`<rect x="${E.toFixed(1)}" y="${Q.toFixed(1)}" width="${(k-1.5).toFixed(1)}" height="${A.toFixed(1)}" fill="${T}" fill-opacity="0.85" rx="1.5"/>`,_+=`<rect x="${E.toFixed(1)}" y="0" width="${k.toFixed(1)}" height="${x}" fill="transparent"><title>${O(D)}</title></rect>`,d<=8||R%2===0){let F=new Date(C.t_utc).getHours();_+=`<text x="${J.toFixed(1)}" y="${(b-3).toFixed(1)}" text-anchor="middle" font-size="9" fill="#7a9098">${F.toString().padStart(2,"0")}</text>`}});let L=`<polyline points="${l.map((C,R)=>{let Q=R*k+k/2,A=S(M[R]);return`${Q.toFixed(1)},${A.toFixed(1)}`}).join(" ")}" fill="none" stroke="rgba(255,255,255,0.55)" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>`,z="";if(o>0&&d>0){let C=Math.min($-1,o/(d*3)*$);z=`
    ...
    <div class="hw-forecast">
      ...
      ${N}`:""}
    </div>`}function to(e){let o=/([NS])(\d+)([EW])(\d+)/i.exec(e);return o?{lat:(o[1].toUpperCase()==="N"?1:-1)*parseInt(o[2],10),lon:(o[3].toUpperCase()==="E"?1:-1)*parseInt(o[4],10)}:null}var tt=[{id:"X",label:"X-risk",color:"#e05c5c"},{id:"M",label:"M-risk",color:"#e0a84a"},{id:"C",label:"C-risk",color:"#d4cc5c"},{id:"quiet",label:"Quiet",color:"#5cce8c"}];function oo(e){return e.x_flare_probability>0?"X":e.m_flare_probability>0?"M":e.c_flare_probability>0?"C":"quiet"}function so(e,o,t){let s=o/2,n=s*.87,c=o*.03,r=o*.009,i=e.map(a=>{var $,x;let l=to(a.location);if(!l||Math.abs(l.lon)>88||a.location.includes("*"))return"";let d=oo(a);if(!t.has(d))return"";let p=tt.find(f=>f.id===d).color,m=l.lat*Math.PI/180,u=l.lon*Math.PI/180,h=(s+n*Math.cos(m)*Math.sin(u)).toFixed(1),w=(s-n*Math.sin(m)).toFixed(1),v=`AR ${a.region} \xB7 ${a.location}
...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
    ...
    <div class="hw-radio-meta">X-ray: <b style="color:${(p=ve[s])!=null?p:"#a0b4b8"}">${g(s)}-class</b> \xB7 ${g(c)}</div>
  </div>`}var go={0:"Quiet",1:"Minor Storm",2:"Moderate Storm",3:"Strong Storm",4:"Severe Storm",5:"Extreme Storm"};function wo(e){return e>=9?5:e>=8?4:e>=7?3:e>=6?2:e>=5?1:0}function ae(e,o){if(e<o-.7)return 0;if(e>o+1)return .9;let t=(e-(o-.7))/1.7;return Math.round(Math.pow(Math.max(0,t),.7)*90)/100}function xo(e){var l,d,p;let o=parseInt(((l=e.scales.g_scale)!=null?l:"G0").replace(/\D/g,""),10),t=Math.max(0,Math.min(5,Number.isFinite(o)?o:0)),s=(d=e.metrics.kp_forecast_3h)!=null?d:[],n=Date.now(),c=n+24*60*60*1e3,r=s.filter(m=>{let u=new Date(m.t_utc).getTime();return u>=n-3*60*60*1e3&&u<=c}),i=r.length===0?0:Math.max(...r.map(m=>m.kp)),a={G1:ae(i,5),G2:ae(i,6),G3:ae(i,7),G4:ae(i,8),G5:ae(i,9),max_expected:wo(i)};return{now:{g_level:t,label:(p=go[t])!=null?p:"Quiet"},forecast_24h:a}}function fo(e){if(!e||typeof e!="object")return null;let o=e,t=o.now,s=o.forecast_24h;if(!t||!s)return null;let n=typeof t.g_level=="number"?t.g_level:parseInt(String(t.g_level),10),c=typeof t.label=="string"?t.label:"Quiet";if(!Number.isFinite(n))return null;let r=l=>{let d=typeof l=="number"?l:parseFloat(String(l));return Number.isFinite(d)?Math.max(0,Math.min(1,d)):0},i=s.max_expected,a=typeof i=="number"&&Number.isFinite(i)?Math.max(0,Math.min(5,Math.round(i))):0;return{now:{g_level:Math.max(0,Math.min(5,Math.round(n))),label:c},forecast_24h:{G1:r(s.G1),G2:r(s.G2),G3:r(s.G3),G4:r(s.G4),G5:r(s.G5),max_expected:a}}}function st(e){let o=xo(e),t=fo(e.storm_risk);if(!t)return o;let s=e.storm_risk,n=s&&typeof s.forecast_24h=="object"&&s.forecast_24h!==null?s.forecast_24h:void 0,c=n==null?void 0:n.max_expected;return typeof c=="number"&&Number.isFinite(c)?t:we(ge({},t),{forecast_24h:we(ge({},t.forecast_24h),{max_expected:o.forecast_24h.max_expected})})}function $o(e){return e>=4?"#e05c5c":e>=3?"#e0a84a":e>=1?"#d4cc5c":"#607880"}var We={rising:"#e0884a",peak:"#e05c5c",decline:"#d4cc5c"};function bo(e){var l,d,p;let o=(l=e.metrics.kp_latest)!=null?l:0,t=e.metrics.imf_bz_nt,s=e.metrics.solar_wind_kms,n=parseInt(((d=e.scales.g_scale)!=null?d:"G0").replace("G",""),10)||0,c=o>=5||n>=1,r=(p=e.metrics.kp_history_1h)!=null?p:[],i=0;if(r.length>=2&&(i=r[r.length-1].kp-r[r.length-2].kp),!c)return{active:!1,phase:"quiet",kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s};let a;return i>.3&&(t==null||t<-5)?a="rising":i<-.5?a="decline":a="peak",{active:!0,phase:a,kp_current:o,kp_trend:i,bz_nt:t,solar_wind_kms:s}}function vo(e){if(!e.active)return"";let o=[{key:"rising",label:"Rising"},{key:"peak",label:"Peak"},{key:"decline",label:"Decline"}],t=o.findIndex(i=>i.key===e.phase),s=We[e.phase],n=o[t].label,c=o.map((i,a)=>{let l=a===t,d=a<t,p=We[i.key],m=l?`background:${p};border-color:${p};box-shadow:0 0 6px ${p}88`:d?`background:${p}44;border-color:${p}66`:"background:#111b1e;border-color:#1e2c30",u=l?" hw-spi-dot-active":"",h=l?`color:${p};font-weight:700`:d?`color:${p}66`:"color:#2e4248",w=a<o.length-1?`<div class="hw-spi-arr">${d?`<span style="color:${p}55">\u2192</span>`:"\u2192"}</div>`:"";return`<div class="hw-spi-node">
  ...
  </div>`}function Ue(e,o,t){let s=Math.max(0,Math.min(5,Math.round(e))),n=(t==null?void 0:t.showDialCode)!==!1,c=70,r=76,i=48,l=i-9,d=Math.PI,p=k=>d*(1-k/5),m=p(s),u=(k,S)=>({x:c+S*Math.cos(k),y:r-S*Math.sin(k)}),h=(k,S,_)=>{let H=u(k,i),M=u(S,i),y=u(k,l),L=u(S,l);return`<path d="M ${y.x.toFixed(2)} ${y.y.toFixed(2)} L ${H.x.toFixed(2)} ${H.y.toFixed(2)} A ${i} ${i} 0 0 1 ${M.x.toFixed(2)} ${M.y.toFixed(2)} L ${L.x.toFixed(2)} ${L.y.toFixed(2)} A ${l} ${l} 0 0 0 ${y.x.toFixed(2)} ${y.y.toFixed(2)} Z" fill="${_}"/>`},w=k=>{let S=p(k),_=u(S,i+1),H=u(S,i-5);return`<line x1="${_.x.toFixed(2)}" y1="${_.y.toFixed(2)}" x2="${H.x.toFixed(2)}" y2="${H.y.toFixed(2)}" stroke="#2a3a40" stroke-width="1" stroke-linecap="round"/>`},v=u(m,i-2),$=`<line x1="${c}" y1="${r}" x2="${v.x.toFixed(2)}" y2="${v.y.toFixed(2)}" stroke="#c8d6dc" stroke-width="2" stroke-linecap="round"/>`,x=`<circle cx="${c}" cy="${r}" r="3.5" fill="#3a4c52" stroke="#1e2c30" stroke-width="1"/>`,f=h(p(0),p(2),"#3d8f62")+h(p(2),p(4),"#b8982a")+h(p(4),p(5),"#b04048"),b=[0,1,2,3,4,5].map(w).join("");return`<div class="hw-storm-risk-gauge" role="img" aria-label="${O(o)} G${s}">
  ...
  </div>`}function yo(e,o){let t=st(e),s=bo(e),n=t.forecast_24h,c=Math.max(0,Math.min(5,Math.round(n.max_expected))),r=`<div class="hw-storm-risk-now-gauge">${Ue(t.now.g_level,"Current observed geomagnetic storm level",{showDialCode:!0})}</div>`,i=`<div class="hw-storm-risk-fc-gauge">${Ue(c,"Max expected geomagnetic level in next 24 hours",{showDialCode:!1})}</div>`,a=`
  ...
  </div>`}var fe={cycle_name:"Solar Cycle 25",phase:"declining",progress_0_1:.57,cycle_start_year:2019,expected_peak_year:2025,expected_end_year:2030,subtitle:"Activity remains elevated"},nt={minimum:"#607880",rising:"#d4cc5c",maximum:"#e0a84a",declining:"#96a8c8"};function ko(e){var M;let o=fe,t=(M=nt[o.phase])!=null?M:"#96a8b8",s=o.phase.charAt(0).toUpperCase()+o.phase.slice(1),n=280,c=52,r=10,i=c-6,a=c-18,l=.5,d=.19,p=y=>Math.exp(-Math.pow((y-l)/d,2)/2),m=y=>r+y*(n-2*r),u=y=>i-p(y)*a,h=80,w=[];for(let y=0;y<=h;y++){let L=y/h;w.push(`${y===0?"M":"L"}${m(L).toFixed(1)},${u(L).toFixed(1)}`)}let v=Math.round(o.progress_0_1*h),$=[];for(let y=0;y<=v;y++){let L=y/h;$.push(`${y===0?"M":"L"}${m(L).toFixed(1)},${u(L).toFixed(1)}`)}let x=m(o.progress_0_1),f=[`M${r},${i}`,...$.slice(1),`L${x.toFixed(1)},${i} Z`],b=u(o.progress_0_1),k=5,S=`M${x.toFixed(1)},${b.toFixed(1)} L${(x-k).toFixed(1)},${(b-k*1.8).toFixed(1)} L${(x+k).toFixed(1)},${(b-k*1.8).toFixed(1)} Z`,_=i+11;return`<div class="hw-impact-tip${e?" hw-impact-tip-open":""}" style="padding:8px 6px 6px">
  ...
  </div>`}function rt(e){var a,l,d,p,m;let o=(l=(a=e.coronal_hole)==null?void 0:a.estimated_speed_kms)!=null?l:e.metrics.solar_wind_kms,t=(d=e.coronal_hole)==null?void 0:d.status,s=o!=null?o:0,n=t!=null?t:s>=600?"strong":s>=500?"active":s>=420?"watch":"quiet",c={strong:"#e05c5c",active:"#e0a84a",watch:"#d4cc5c",quiet:"#5cce8c"},r={strong:"Strong",active:"Active",watch:"Watch",quiet:"None"},i={strong:"Strong high-speed stream",active:"High-speed stream active",watch:"Elevated solar wind",quiet:"Background solar wind"};return{status:n,color:c[n],label:r[n],desc:(m=(p=e.coronal_hole)==null?void 0:p.note)!=null?m:i[n],speed:o}}function _o(e,o){var l;let t=rt(e),s=(l=t.speed)!=null?l:0,n=t.speed!=null?`${Math.round(t.speed)} km/s`:"\u2014",c=o?" hw-impact-tip-open":"",r=s>=420,i=ke("coronal_hole",{hssState:t,uid:"hss"}),a=r?'<div class="hw-hss-meta" style="font-size:.72em">Elevated speed may indicate Earth-facing coronal hole stream</div>':'<div class="hw-hss-meta" style="font-size:.72em">Background solar wind \xB7 no HSS detected</div>';return`<div class="hw-impact-tip${c}">
    ${i}
    <div class="hw-hss-meta">Solar wind: <b style="color:${t.color}">${g(n)}</b> \xB7 ${g(t.desc)}</div>
    ${a}
  </div>`}function it(e){var n,c;let o=(n=e.scales.g_scale)!=null?n:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let r=(c=e.metrics.kp_forecast_3h)!=null?c:[],i=Date.now(),a=r.filter(l=>new Date(l.t_utc).getTime()<=i+3*60*60*1e3).sort((l,d)=>new Date(d.t_utc).getTime()-new Date(l.t_utc).getTime());a.length>0&&(s=a[0].kp)}return t>=2||s!=null&&s>=6?{level:2,color:"#e05c5c",label:"High",kp:s,gScale:o}:t>=1||s!=null&&s>=4?{level:1,color:"#d4cc5c",label:"Moderate",kp:s,gScale:o}:{level:0,color:"#5cce8c",label:"Low",kp:s,gScale:o}}function So(e,o){let t=it(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(a=>{let l=a.l===t.level,d=l?`${a.color}2e`:"#1b2a2e",p=l?a.color:"#3d5058",m=l?`1px solid ${a.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${d};color:${p};border:${m}">${a.label}</div>`}).join(""),r=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Near-normal thermospheric density",1:"Elevated drag \u2014 minor orbit correction may be needed",2:"Strong thermospheric expansion \u2014 significant drag increase"};return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-satdrag-meta">${r} \xB7 ${g(t.gScale)} \xB7 ${i[t.level]}</div>
  </div>`}function at(e){var l,d,p;let o=(l=e.scales.g_scale)!=null?l:"G0",t=parseInt(o.slice(1),10),s=e.metrics.kp_latest;if(s==null){let m=(d=e.metrics.kp_forecast_3h)!=null?d:[],u=Date.now(),h=m.filter(w=>new Date(w.t_utc).getTime()<=u+3*60*60*1e3).sort((w,v)=>new Date(v.t_utc).getTime()-new Date(w.t_utc).getTime());h.length>0&&(s=h[0].kp)}let n=0;t>=2||s!=null&&s>=6?n=2:(t>=1||s!=null&&s>=4)&&(n=1);let c=parseInt(((p=e.scales.r_scale)!=null?p:"R0").slice(1),10),r=c>=2&&n<2;c>=2&&(n=Math.min(2,n+1));let i={0:"#5cce8c",1:"#d4cc5c",2:"#e05c5c"},a={0:"Low",1:"Moderate",2:"High"};return{level:n,color:i[n],label:a[n],kp:s,gScale:o,boostedByFlare:r}}function Mo(e,o){var l;let t=at(e),s=o?" hw-impact-tip-open":"",c=[{l:0,label:"Low",color:"#5cce8c"},{l:1,label:"Moderate",color:"#d4cc5c"},{l:2,label:"High",color:"#e05c5c"}].map(d=>{let p=d.l===t.level,m=p?`${d.color}2e`:"#1b2a2e",u=p?d.color:"#3d5058",h=p?`1px solid ${d.color}66`:"1px solid #253035";return`<div class="hw-level-cell" style="background:${m};color:${u};border:${h}">${d.label}</div>`}).join(""),r=t.kp!=null?`Kp ${t.kp.toFixed(1)}`:"Kp \u2014",i={0:"Stable ionosphere \xB7 normal positioning accuracy",1:"Possible signal delay or scintillation",2:"Significant positioning errors \xB7 possible signal loss"},a=t.boostedByFlare?`<div class="hw-gnss-meta" style="font-size:.72em">Risk elevated by solar flare activity (R${parseInt(((l=e.scales.r_scale)!=null?l:"R0").slice(1),10)})</div>`:"";return`<div class="hw-impact-tip${s}">
    <div class="hw-level-strip">${c}</div>
    <div class="hw-gnss-meta">${r} \xB7 ${g(t.gScale)} \xB7 ${i[t.level]}</div>
    ${a}
  </div>`}function ct(e){var n;let o=e.metrics.pressure_npa,t=o!=null?o:null,s=(n=e.metrics.density)!=null?n:null;return t==null?{pressure:null,color:"#607880",label:"\u2014",density:s}:t>=6?{pressure:t,color:"#e05c5c",label:"Extreme",density:s}:t>=4?{pressure:t,color:"#e0a84a",label:"Strong",density:s}:t>=2?{pressure:t,color:"#d4cc5c",label:"Elevated",density:s}:t>=1?{pressure:t,color:"#5cce8c",label:"Typical",density:s}:{pressure:t,color:"#7a9298",label:"Weak",density:s}}function Co(e,o){let t=ct(e),s=o?" hw-impact-tip-open":"",n=t.pressure,c=200,r=6,i=10,a=r+i,l=a+4,d=l+11,p=a+9,m=d+4,h=[{x:0,w:50,color:"#5cce8c"},{x:50,w:50,color:"#d4cc5c"},{x:100,w:50,color:"#e0a84a"},{x:150,w:50,color:"#e05c5c"}].map(M=>`<rect x="${M.x}" y="${r}" width="${M.w}" height="${i}" fill="${M.color}" opacity="0.55" rx="0"/>`).join(""),w=[{x:0,label:"0",anchor:"start"},{x:50,label:"2",anchor:"middle"},{x:100,label:"4",anchor:"middle"},{x:150,label:"6",anchor:"middle"},{x:200,label:"8+",anchor:"end"}],v=w.map(M=>`<line x1="${M.x}" y1="${a}" x2="${M.x}" y2="${l}" stroke="#3a5058" stroke-width="1"/>`).join(""),$=w.map(M=>`<text x="${M.x}" y="${d}" class="hw-swdp-axlabel" text-anchor="${M.anchor}">${M.label}</text>`).join(""),x="";if(n!=null){let y=Math.min(Math.max(n,0),8)/8*c;x=`<polygon points="${`${y-5},${p} ${y+5},${p} ${y},${a}`}" fill="${t.color}" opacity="0.95"/>
    <line x1="${y}" y1="${r}" x2="${y}" y2="${a}" stroke="${t.color}" stroke-width="1.5" opacity="0.7"/>`}let f=`<rect x="0" y="${r}" width="${c}" height="${i}" fill="none" stroke="#2a3c42" stroke-width="0.8" rx="0"/>`,b=`<svg class="hw-swdp-gauge" viewBox="0 0 ${c} ${m}" preserveAspectRatio="none" aria-hidden="true">
    ${h}${f}${x}${v}${$}
  </svg>`,k=n!=null?`${n.toFixed(2)} nPa`:"\u2014",S=t.density!=null?`${t.density.toFixed(2)} cm\u207B\xB3`:"\u2014",_=e.metrics.solar_wind_kms!=null?`${Math.round(e.metrics.solar_wind_kms)} km/s`:"\u2014",H=n==null?"":n>=4?" \xB7 Magnetosphere compressed":n>=2?" \xB7 Moderate compression":"";return`<div class="hw-impact-tip${s}">
    ${b}
    ...
    <div class="hw-cme-footer">${r}</div>
      ...
      <div class="hw-impact-tip${p}">${Dt(r,e,i,a)}</div>
    </div>`}function Lo(e,o){let t=e.find(c=>c.kind==="aurora");if(t)return t;let s=o.aurora_hint;return{kind:"aurora",level:s.aurora_label==="good"?"moderate":s.aurora_label==="possible"?"low":"none",label:"Aurora",summary:s.summary}}function Fo(e,o,t,s){var x,f;let n=(x=Qe[e.level])!=null?x:"#666",c=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),r=(f=Ee[e.kind])!=null?f:ot,i=e.level==="none"?"#606870":n,a=o.has("aurora"),l=a?" hw-impact-open":"",d=a?" hw-aurora-tip-open":"",p=`https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg?_=${Date.now()}`,m=null;t&&s.lat!=null&&s.lon!=null&&(m=Ze(t.entries,s.lat,s.lon));let u=s.lat!=null&&s.lon!=null,h=m!=null?m>=30?"#5cce8c":m>=10?"#d4cc5c":"#9ab4bc":"#607880",w=m!=null?`${m}%`:t?"n/a":"\u2026",v=u?`
    <div class="hw-aurora-obs-panel">
      <span>\u{1F4CD}</span>
    ...
    ${$}
  </div>`}function Xe(e,o,t,s,n,c){var w,v;let r=(w=Qe[e.level])!=null?w:"#666",i=e.level==="none"?"None":e.level.charAt(0).toUpperCase()+e.level.slice(1),a=(v=Ee[e.kind])!=null?v:ot,l=e.level==="none"?"#606870":r,d=e.kind==="solar_activity"?t:c,p=d?" hw-impact-open":"",m;if(e.kind==="solar_activity"){let $=t?" hw-solar-open":"",x=tt.map(f=>{let b=s.has(f.id),k=b?f.color+"22":"transparent",S=b?"1":"0.32";return`<button class="hw-sl-btn" data-solar-layer="${f.id}" style="color:${f.color};border-color:${f.color};background:${k};opacity:${S}">${f.label}</button>`}).join("");m=`<div class="hw-solar-tip${$}">
        <div class="hw-solar-disk-wrap" id="solar">
          <img class="hw-solar-disk-img" src="${po}" alt="Solar disk" loading="lazy" />
          ${o?so(o,mo,s):""}
        </div>
        <div class="hw-solar-layers">${x}</div>
        <span class="hw-solar-tip-text">${g(e.summary)}</span>
      </div>`}else m=uo(n,d);let u=e.kind==="solar_activity"?" data-solar-toggle":` data-impact-row="${O(e.kind)}"`,h=e.kind==="radio"?' id="radio"':"";return`<div class="hw-impact-row${p}"${h}${u}>
    <span class="hw-impact-caret">\u25B6</span>
    ...
    ${m}
  </div>`}function Eo(e,o,t,s,n,c,r,i,a){var Ie,Oe,Ae,Te;let l=(Oe=(Ie=o==null?void 0:o.impacts)!=null?Ie:e.observer_impacts)!=null?Oe:[],d=Lo(l,e),p=Fo(d,r,i,a),m=l.find(Me=>Me.kind==="radio"),u=l.find(Me=>Me.kind==="solar_activity"),h=m?Xe(m,t,n,c,e,r.has("radio")):"",w=u?Xe(u,t,n,c,e,!1):"",x=`
    <div class="hw-section-row" data-impacts-toggle>
      <span class="hw-section-caret">${s?"\u25BC":"\u25B6"}</span>
      <span class="hw-section-label" style="margin-bottom:0">Indicators (${ao})${o?'<span style="font-size:.65em;color:#7a9870;font-weight:normal;text-transform:none;letter-spacing:0"> \xB7 simulated</span>':""}</span>
    </div>`,{metrics:f}=e,b=f.xray_class,k=b?(Ae=ve[b])!=null?Ae:"#a0b4b8":"#607880",S=b?`${b}-class`:"\u2014",_=f.imf_bz_nt,H=_!=null?_<=-10?"#e05c5c":_<=-5?"#e0a84a":_>=5?"#5cce8c":"#a0b4b8":"#607880",M=_!=null?(_>=0?"+":"")+_.toFixed(1)+" nT":"\u2014",y=f.solar_wind_kms,L=y!=null?`${Math.round(y)} km/s`:"\u2014",z=y!=null?y>700?"#e05c5c":y>500?"#e0a84a":y>400?"#d4cc5c":"#5cce8c":"#607880",Y=Le("xray","X-Ray",no,S,k,r,e,a,i),j=Le("imf_bz","IMF Bz",ro,M,H,r,e,a,i),X=Le("solar_wind","Solar Wind",io,L,z,r,e,a,i),N='<div class="hw-indicators-sep" role="separator" aria-hidden="true"></div>',P=r.has("geomag_storm"),W=st(e),C=$o(W.now.g_level),R=`G${W.now.g_level}`,A=`<div class="hw-impact-row${P?" hw-impact-open":""}" id="storm_risk" data-impact-row="geomag_storm">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${yo(e,P)}
    </div>`,E=r.has("solar_cycle"),J=(Te=nt[fe.phase])!=null?Te:"#96a8b8",T=fe.phase.charAt(0).toUpperCase()+fe.phase.slice(1),B=`<div class="hw-impact-row${E?" hw-impact-open":""}" data-impact-row="solar_cycle">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${_o(e,K)}
    </div>`,I=it(e),G=r.has("sat_drag"),oe=`<div class="hw-impact-row${G?" hw-impact-open":""}" id="satellite_drag" data-impact-row="sat_drag">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Mo(e,ie)}
    </div>`,q=ct(e),le=r.has("sw_pressure"),ne=q.pressure!=null?`${q.pressure.toFixed(2)} nPa`:"\u2014",se=`<div class="hw-impact-row${le?" hw-impact-open":""}" data-impact-row="sw_pressure">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Co(e,le)}
    </div>`,re=lt(e),pe=r.has("cme_cone"),Z=`<div class="hw-impact-row${pe?" hw-impact-open":""}" data-impact-row="cme_cone">
      <span class="hw-impact-caret">\u25B6</span>
      ...
      ${Ho(e,pe)}
    </div>`,me=ye(e),Re=r.has("magnetosphere"),pt=`<div class="hw-impact-row${Re?" hw-impact-open":""}" data-impact-row="magnetosphere">
      <span class="hw-impact-caret">\u25B6</span>
    ...
    <div class="hw-impacts">
      ${x}
      ${s?[p,A,h,oe,Se,Y,w,N,X,se,j,pt,ee,Z,B].join(""):""}
    ...
    ${r}
  </div>`}var Io={info:"#445c64",watch:"#e0a84a",warning:"#e05c5c"},Oo="#4ae0a4";function Ao(e){let o=(t,s="")=>`<svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" ${s}>${t}</svg>`;switch(e){case"solar_flare":return o(`<circle cx="6.5" cy="6.5" r="2.5"/>
        ...
        <circle cx="6.5" cy="3.8" r=".6" fill="currentColor" stroke="none"/>`)}}function To(e){var s;let o=(s=e.metadata)!=null?s:{},t=[];return o.source_code&&t.push(`Code: ${o.source_code}`),o.model&&t.push(`Model: ${String(o.model).toUpperCase()}`),t.length===0?"":`
${t.join(" \xB7 ")}`}function zo(e,o,t){var a;let s=e.is_active?Oo:(a=Io[e.level])!=null?a:"#445c64",n=e.event_time===t,c=e.event_time.slice(11,16)+" UTC",r=e.source==="NASA_DONKI"?"DONKI":"SWPC",i=n?`<div class="hw-tl-detail">${g(e.description)}${g(To(e))}</div>`:"";return`
    <div class="hw-tl-item" data-timeline-key="${O(e.event_time)}">
      ...
      <div class="hw-tl-body">
        ...
        <div class="hw-tl-title${e.is_active?" hw-tl-active":""}">
          ${Ao(e.event_type)} ${g(e.event_title)}
        </div>
        ${i}
      </div>
    </div>`}function No(e,o,t,s){var $,x;let n=($=e.timeline)!=null?$:[],c=Date.now(),r=new Date(c).toISOString().slice(0,10),i=new Date(c-864e5).toISOString().slice(0,10),a=new Date(c-1728e5).toISOString().slice(0,10),l=new Set([r,i,a]),d=n.filter(f=>{var b;return l.has(((b=f.event_time)!=null?b:"").slice(0,10))}).slice().reverse(),p=d.length,m=t?"\u25BC":"\u25B6",u=p>0?`Solar Activity Timeline (${p})`:"Solar Activity Timeline",h=`
    ...
    </div>`;if(!t||p===0)return`<div class="hw-timeline">${h}</div>`;let w=new Map;for(let f of d){let b=((x=f.event_time)!=null?x:"").slice(0,10);w.has(b)||w.set(b,[]),w.get(b).push(f)}let v=[...w.entries()].map(([f,b])=>{let S=new Date(f+"T12:00:00Z").toLocaleDateString("en-US",{month:"short",day:"numeric",timeZone:"UTC"}),_=s.has(f),H=_?"\u25B6":"\u25BC",M=_?`<span class="hw-tl-day-count">${b.length} events</span>`:"",y=`
      <div class="hw-tl-day-row" data-tl-day="${O(f)}">
        <span class="hw-section-caret">${H}</span>
        <span class="hw-tl-date">${S}</span>
        ${M}
      </div>`,L=_?"":b.map((z,Y)=>zo(z,Y<b.length-1,o)).join("");return`<div class="hw-tl-group">${y}${L}</div>`}).join("");return`
    <div class="hw-timeline">
      ${h}
      ${v}
    </div>`}function Bo(e,o,t){var l;let s=(l=e.alerts_all)!=null?l:[],n=s.length,c=o?"\u25BC":"\u25B6",r=n>0?`SWPC Alerts (${n})`:"SWPC Alerts",i=`
    ...
    </div>`;if(!o||n===0)return`<div class="hw-alerts">${i}${o&&n===0?'<div class="hw-empty-alerts">No significant recent SWPC alerts</div>':""}</div>`;let a=s.map(d=>Ro(d,d.dedupe_key===t)).join("");return`
    <div class="hw-alerts">
      ${i}
      ${a}
    </div>`}function Po(e,o){var j,X,N;let t=e.cme_tracker;if(!t)return"";let s=(j=vt[t.impact_level])!=null?j:"#96a8b8",n=(X=yt[t.status])!=null?X:t.status,c=300,r=44,i=18,a=r/2,l=10,d=c-18,p=7,m=`<line x1="${i+l}" y1="${a}" x2="${d-p}" y2="${a}" stroke="#2a3c42" stroke-width="1.5" stroke-dasharray="5,4"/>`,u=`<circle cx="${i}" cy="${a}" r="${l}" fill="#f0c040" opacity="0.92"/>`,h=`
    <circle cx="${d}" cy="${a}" r="${p}" fill="#4a90c4" opacity="0.88"/>
    <circle cx="${d}" cy="${a}" r="2.5" fill="#fff" opacity="0.7"/>`,w=`<text x="${i}" y="${a+l+9}" text-anchor="middle" font-size="9" fill="#c8aa60">Sun</text>`,v=`<text x="${d}" y="${a+p+9}" text-anchor="middle" font-size="9" fill="#7ab0d4">Earth</text>`,$="";if(t.progress!=null){let P=i+l+4,W=d-p-4,C=P+t.progress*(W-P),R=5;t.status==="arrival_window"?$=`
        ...
        </g>`:$=`<circle cx="${C.toFixed(1)}" cy="${a}" r="${R}" fill="${s}" opacity="0.85"/>`}let x=`<svg class="hw-cme-svg" viewBox="0 0 ${c} ${r}" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
    ${m}
    ${u}${w}
    ${h}${v}
    ${$}
    ...
    <div class="hw-cme-detail">
      <div class="hw-cme-stat-grid">
        ...
        <div class="hw-cme-stat">
          ...
          <span class="hw-cme-stat-value" style="color:${s}">${g(k)}</span>
        </div>
        <div class="hw-cme-stat">
    ...
    </div>`,L=o?"\u25BC":"\u25B6",z=t.impact_level==="unknown"?"Unrated":t.impact_level.charAt(0).toUpperCase()+t.impact_level.slice(1),Y=o?`${x}${y}`:"";return`
    <div class="hw-cme">
      ...
      ${Y}
    </div>`}function Do(e,o,t,s,n,c,r,i,a,l,d,p,m,u,h,w,v,$){var H;let x=Jt(e,s),f=(H=e.metrics.kp_history_1h)!=null?H:[],b=f.length?xe(f[f.length-1].t_utc):null,k=b?`Recent history \xB7 Last step ${b}`:"Recent history",S=`<div style="padding:10px 14px;border-bottom:1px solid #1e2c30"><div class="hw-section-row" data-hero-toggle style="margin-bottom:0">
    ...
    <div class="hw-root">
      ...
      ${No(e,r,i,a)}
      ${Bo(e,n,c)}
    </div>`}function Go(e){return`<div class="hw-root">
