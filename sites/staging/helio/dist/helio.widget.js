...
C: ${a.c_flare_probability}%  M: ${a.m_flare_probability}%  X: ${a.x_flare_probability}%`;return`<g style="pointer-events:all">
  ...
  </div>`}function At(t){var a,i,d,p,g;let s=(i=(a=t.coronal_hole)==null?void 0:a.estimated_speed_kms)!=null?i:t.metrics.solar_wind_kms,e=(d=t.coronal_hole)==null?void 0:d.status,o=s!=null?s:0,n=e!=null?e:o>=600?"strong":o>=500?"active":o>=420?"watch":"quiet",c={strong:"#e05c5c",active:"#e0a84a",watch:"#d4cc5c",quiet:"#5cce8c"},r={strong:"Strong",active:"Active",watch:"Watch",quiet:"None"},l={strong:"Strong high-speed stream",active:"High-speed stream active",watch:"Elevated solar wind",quiet:"Background solar wind"};return{status:n,color:c[n],label:r[n],desc:(g=(p=t.coronal_hole)==null?void 0:p.note)!=null?g:l[n],speed:s}}function Oe(t,s){var S;let e=At(t),o=(S=e.speed)!=null?S:0,n=e.speed!=null?`${Math.round(e.speed)} km/s`:"\u2014",c=s?" hw-impact-tip-open":"",r=320,l=72,a=36,i=36,d=284,p=36,g=11,m=14,w=19,u=9,k=o>=500,x=o>=420,f=k?"#f5c540":x?"#c8a020":"#7a6010",b=k?"#f5c540":x?"#c8a020":"#3a3808",$=e.color,L=x?"0.9":"0.25",H=k?"0.18":x?"0.10":"0.04",M=[0,45,90,135,180,225,270,315].map(z=>{let _=z*Math.PI/180,E=(a+m*Math.cos(_)).toFixed(1),A=(i+m*Math.sin(_)).toFixed(1),O=(a+w*Math.cos(_)).toFixed(1),B=(i+w*Math.sin(_)).toFixed(1),X=z>300||z<60?"0.9":"0.5";return`<line x1="${E}" y1="${A}" x2="${O}" y2="${B}"
